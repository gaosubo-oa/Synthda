...
<body id="add" style="width:100%;height:100%; position: fixed;
            overflow: scroll;">
...
<div class="mui-content" id="aaa">
    <div class="mui-table">
        <ul class="mui-table-view">
            <li class="mui-table-view-cell mui-input-row"><label class="mui-left">收件人：</label><input type="text" disabled="disabled" placeholder="选择收件人"  readonly="readonly" value="" class="mui-input-clear" id="tname"/><input value="" type="hidden" id="reciever"/><span id="Popover_0" class='mui-icon mui-icon-plus'></span></li>
...
<script type="text/javascript">
    ...
    var app='<div><p>发件人：<span id="fnames"></span></p><p>收件人：<span id="toName"></span></p><p>抄送人：<span id="copyName"></span></p><p>发件时间：<span id="sendtime"></span></p><p>附件：<span id="strs"></span></p><p>主题：<span id="subject"></span></p><p>内容：</p><p id="objs"></p></div>'
    ...
    $.ajax({
        ...
        success:function(res){
            ...
            document.getElementById("tname").setAttribute('value',res.object.users.userName);
            document.getElementById("tname").setAttribute('ids',res.object.fromId);
