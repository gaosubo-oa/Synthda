...
<div class="mui-content" id="aaa" style="overflow: auto;">
    <ul>
        ...
        <li class="ulli">
            ...
            <input type="text" placeholder="选择分享人" style="width: 72%;border:none"  value="" id="tname"/>
            <span id="Popover_0" class='mui-icon mui-icon-plus'  style="margin-top: 8px;" ></span>
        </li>
    </ul>
    <textarea name="" id="cont"   placeholder="输入日程内容" style="padding: 6px 0 0 6px;width: 90%;height: 45%;margin-left: 5%;margin-top: 10px;"></textarea>
</div>
...
//
    ...
    $('#tname,#Popover_0').on('tap', function() {
        ...
        mui("#headerApply").on('tap', '#re_mailApply', function () {
            ...
            document.getElementById("tname").setAttribute('userId',checkVals);
        });
    });
    ...
    $("#tname,#Popover_0").on('focus', function(){
        document.activeElement.blur();
    });
