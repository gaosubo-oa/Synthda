            ...
            success:function(res){
                if(res.flag){
                    ...
                    for(var i=0;i<res.obj.length;i++){
                        var str = res.obj[i].newsDateTime;
                        var a = " ";
                        var b = str.substring(0,str.indexOf(a));
                        var str1=repalceHtml(res.obj[i].content)
                        str1=str1.replace(/&nbsp;/ig, "");
                        app+=
                            '<div class="nav-sub" style="box-shadow: 1px 1px 7px rgba(206, 194, 194, 0.85);border-radius: .1rem;background-color: #fff;margin: .24rem .1rem;padding: .1rem 0;">' +
                                '<a class="list" href="/ewx/newsDetail?newsId=' + res.obj[i].newsId + '&dataType='+$.GetRequest().dataType+'" style="color: #333" newsId="' + res.obj[i].newsId + '">' +
                                    '<div class="nav1">' +
                                        '<span class="nav2">' + res.obj[i].subject + '</span>' +
                                    '</div>' +
                                    '<div style="position: relative;">' +
                                        '<div class="nav1" style="width: 90%;display:inline-block;margin-right: 1.7rem;height: 0.4rem;line-height: .4rem;">'+str1+'</div>' +
                                        function () {
                                ...
                                '<p class="nav3">'+
                                    ...
                                    '</a>'+
                                    '<span class="ac2">' + res.obj[i].providerName + '</span>' +
