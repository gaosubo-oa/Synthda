...
<script src="/lib/weLink/hwh5-cloudonline.js"></script>
<script>
    var accessiontoken = '';

    // 初始化
    HWH5.getAuthCode().then(function (code) {
        getUserInfo(code).then(function (userid) {
            login(userid,code,function (res) {
                var sUserAgent = navigator.userAgent.toLowerCase();
                if (/ipad|iphone|midp|rv:1.2.3.4|ucweb|android|windows ce|windows mobile/.test(sUserAgent)) {
                    //跳转移动端页面
                    location.href = '/ewx/index?JSESSIONID1='+res.token+'&dataType=1&openType='+openType;
                } else {
                    //跳转pc端页面
