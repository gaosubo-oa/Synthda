...
<div>
    <fieldset>
        <legend><h5>基础功能 - 企业微信组织架构管理</h5></legend>
    </fieldset>

    <div class="func-item">
        <button class="btn btn-small btn-primary"  data-module="list"><i class="icon-home icon-white"></i>企业微信部门管理</button>
    </div>

    <div id="mod-list" class="mod-func well" style="display:block;">
        <iframe class="iframes" src="/enterpriseWeChatManage/getWechatOrganizationalStructure" frameborder="0"></iframe>
    </div>
