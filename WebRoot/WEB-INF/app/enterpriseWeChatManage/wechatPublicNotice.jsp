...
//                    $('#url').val("http://www.baidu.com/pda/enterpriseWeChat.php?cid=123&url=%252Fpda%252Fnotify%252Findex.php&aid=%7Bappid%7D".replace(/{appid}$/ig, appid));
//                }, 100);
//            }
//        })());
            ...
            $.ajax({
                url:'/enterpriseWeChatManage/getEnterpriseWeChatApp',
                type:'post',
                data:{'appName':appName},
                success:function(res){
                    if(res.flag){
                        inputcheck('appId',res.data.enterpriseWeChatAppId)
                        inputcheck('appUrl',res.data.enterpriseWeChatAppUrl)
                    }
                }
            })
        ...
        $('.btn-primary').click(function(){
            var appId=$('#appId').val();
            $.ajax({
                url:'/enterpriseWeChatManage/enterpriseWeChatAppSetting',
                type:'get',
    ...
    <form class="form-horizontal" >
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <span class="help-block">应用ID确认后再将此地址请复制到企业微信对应的应用 <strong>首页地址</strong> 的URL输入框</span>
            </div>
        </div>
