...
//                        content = data2.content;
                        ...
                        $('.divImg img').attr('src', function () {
                            if (data2.users.sex == 0) {
                                return '../img/user/boy.png';
                            }
                            else if (data2.users.sex == 1) {
...
//            回复
            $('#replay').on('click',function () {
                $.popWindow('writeMailDetail?sId=' + id + '&type=0', '<fmt:message code="global.lang.reply" />', '0', '0', '1300px', '600px');
            })
//            回复全部
            $('#replayAll').on('click',function () {
                $.popWindow('writeMailDetail?sId=' + id + '&type=1', '<fmt:message code="global.lang.reply" />', '0', '0', '1300px', '600px');
            })
//            转发
            $('#forward').on('click',function () {
                $.popWindow('writeMailDetail?sId=' + id + '&nId='+nId+'&type=2&boxType=inbox&flag=1', '<fmt:message code="email.th.transmit" />', '0', '0', '1300px', '600px');
            })
...
<body>
    <div class="detailsContent">
        <div class="divBtn">
            <div id="replay"><img style="width: 16px;height: 16px;" src="../img/commonTheme/theme6/Replay1.png" class="im"><fmt:message code="email.th.reply" /></div>
            <div id="replayAll"><img style="width: 16px;height: 16px;" src="../img/commonTheme/theme6/ReplayAll1.png" class="im"><fmt:message code="email.th.replyall" /></div>
            <div id="forward"><img style="width: 16px;height: 16px;" src="../img/commonTheme/theme6/Forward1.png" class="im"><fmt:message code="email.th.transmit" /></div>
            <div style="float: right;" onclick="closePage()"><img style="width: 12px;
    height: 12px;
    margin-top: 1px;" src="/img/commonTheme/theme6/delete1.png" class="im"><fmt:message code="global.lang.close" /></div>
        </div>
        ...
        <div class="mainRight">
            <div class="divImg">
                <img src="../img/crm.png" alt="<fmt:message code="chat.th.photo" />">
            </div>
            <div class="userInfo">
                <p class="userName"></p>
                <p class="userDept"></p>
