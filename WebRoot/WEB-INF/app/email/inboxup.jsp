...
<head>
	...
	<style>
		...
		.UP_INBOX .tab table .theme_a a{text-decoration: none;text-align: center;display: block;color:black;}
		...
		<div class="tab" style="margin-top: 15px;">
			<table cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
				<tr class='tr_befor'>
					...
					<th width="7%"><fmt:message code="notice.th.state" /></th>
					<%--						<th width="6%"><fmt:message code="email.th.sign" /></th>--%>
					<th width="17%"><fmt:message code="email.th.sender" /></th>
					<th width="41%" class="theme"><fmt:message code="email.th.main" /></th>
					<th width="17%"><fmt:message code="email.th.time" /></th>
					<th width="11%"><fmt:message code="email.th.file" /></th>
				</tr>
			</table>
		</div>
		<div>
...
<script type="text/javascript">
	...
	var boxStyle = param.boxStyle
	var otherBoxId = param.otherBoxId;
	$(function(){
		if (boxStyle == 'inbox') {
			data1={
				"flag":"inbox",
...
//				点击全选
	...
	function hengEmailList(data) {
		...
		function HVersion(cb) {
			if (boxStyle == 'inbox'||boxStyle == 'drafts'||boxStyle == 'outbox'||boxStyle == 'recycle') {
				$.ajax({
					type: 'get',
					url:'/email/showEmail' ,
					dataType: 'json',
...
//                                    if(data1[i].subject == '【无主题 】' && data1[i].attachmentName != ''){
								if (data1[i].subject.indexOf('【<fmt:message code="email.th.noSubject" /> 】') != -1 && data1[i].attachmentName != '') {
									var qianzhui = data1[i].subject.replace('【<fmt:message code="email.th.noSubject" /> 】', '');
...
//                                    emailSubject= data1[i].subject ;
							...
							if (data1[i].emailList[0].readFlag == 1) {
								if (data1[i].attachmentId != '') {
									str += '<tr class="Hover" Attr="' + data1[i].emailList[0].emailId + '" uId="' + data1[i].emailList[0].deleteFlag + '"bodyId="' + data1[i].emailList[0].bodyId + '"><td><input type="checkbox" name="checkbox" class="checkboxChild" style="width:13px;height:13px;" value="" /></td><td><img src="../img/icon_read_2_03.png"/></td><td width="7%">' + returnUserName(data1[i].users) + '</td><td class="theme_a" style="text-align:left;"><a href="javascript:;">' + emailSubject + '</a></td><td>' + sendTime + '</td><td><img src="../img/huixingzhen.png"/></td></tr>';
								} else {
									str += '<tr class="Hover" Attr="' + data1[i].emailList[0].emailId + '" uId="' + data1[i].emailList[0].deleteFlag + '"bodyId="' + data1[i].emailList[0].bodyId + '"><td><input type="checkbox" name="checkbox" class="checkboxChild" style="width:13px;height:13px;" value="" /></td><td><img src="../img/icon_read_2_03.png"/></td><td width="7%">' + returnUserName(data1[i].users) + '</td><td class="theme_a" style="text-align:left;"><a href="javascript:;">' + emailSubject + '</a></td><td>' + sendTime + '</td><td>&nbsp</td></tr>';
								}
								...
								if (data1[i].attachmentId != '') {
									str += '<tr class="Hover" Attr="' + data1[i].emailList[0].emailId + '" uId="' + data1[i].emailList[0].deleteFlag + '"bodyId="' + data1[i].emailList[0].bodyId + '"><td><input type="checkbox" name="checkbox" class="checkboxChild" style="width:13px;height:13px;" value="" /></td><td><img src="../img/icon_notread_1_03.png"/></td><td width="7%">' + returnUserName(data1[i].users) + '</td><td class="theme_a" style="text-align:left;"><a href="javascript:;">' + emailSubject + '</a></td><td>' + sendTime + '</td><td><img src="../img/huixingzhen.png"/></td></tr>';
								} else {
									str += '<tr class="Hover" Attr="' + data1[i].emailList[0].emailId + '" uId="' + data1[i].emailList[0].deleteFlag + '"bodyId="' + data1[i].emailList[0].bodyId + '"><td><input type="checkbox" name="checkbox" class="checkboxChild" style="width:13px;height:13px;" value="" /></td><td><img src="../img/icon_notread_1_03.png"/></td><td width="7%">' + returnUserName(data1[i].users) + '</td><td class="theme_a" style="text-align:left;"><a href="javascript:;">' + emailSubject + '</a></td><td>' + sendTime + '</td><td>&nbsp</td></tr>';
								}
							}
...
//                                    emailSubject= data1[i].subject ;
							...
							if (data1[i].emailList[0].readFlag == 1) {
								...
								if (data1[i].attachmentId != '') {
									str += '<tr class="Hover" Attr="' + data1[i].emailList[0].emailId + '" uId="' + data1[i].emailList[0].deleteFlag + '"bodyId="' + data1[i].emailList[0].bodyId + '"><td><input type="checkbox" name="checkbox" class="checkboxChild" style="width:13px;height:13px;" value="" /></td><td><img src="../img/icon_notread_1_03.png"/></td><td width="6%"></td><td width="6%">' + returnUserName(data1[i].users) + '</td><td class="theme_a" style="text-align:left;"><a href="javascript:;">' + emailSubject + '</a></td><td>' + sendTime + '</td><td><img src="../img/huixingzhen.png"/></td></tr>';
								} else {
									str += '<tr class="Hover" Attr="' + data1[i].emailList[0].emailId + '" uId="' + data1[i].emailList[0].deleteFlag + '"bodyId="' + data1[i].emailList[0].bodyId + '"><td><input type="checkbox" name="checkbox" class="checkboxChild" style="width:13px;height:13px;" value="" /></td><td><img src="../img/icon_notread_1_03.png"/></td><td width="6%"></td><td width="6%">' + returnUserName(data1[i].users) + '</td><td class="theme_a" style="text-align:left;"><a href="javascript:;">' + emailSubject + '</a></td><td>' + sendTime + '</td><td>&nbsp</td></tr>';
								}
							}
