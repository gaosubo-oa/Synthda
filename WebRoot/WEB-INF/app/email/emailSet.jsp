...
<head lang="en">
    ...
    <title><fmt:message code="email.th.mailManagement" /></title>
...
<div class="head-top">
    <ul class="clearfix">
        <li class="fl head-top-li active" data-type=""><fmt:message code="email.th.emailReviewSetting" /></li>
...
<div class="main">
    <iframe name="notices" src="/approveEmail/addEmailSet1" frameborder="0"></iframe>
</div>
<script>
