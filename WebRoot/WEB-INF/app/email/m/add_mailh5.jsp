...
<header class="mui-bar mui-bar-nav" id="header">
    ...
    <h1 class="mui-title"><fmt:message code="email.title.waitmail" /></h1>
...
<div class="mui-content" id="aaa">
    <div class="mui-table">
        <ul class="mui-table-view">
            ...
            <li class="mui-table-view-cell mui-input-row"><label class="mui-left"><fmt:message code="notice.th.title" />：</label><input type="text" placeholder="<fmt:message code="mailMonitoring.enterSubject" />" class="mui-input-clear" value="" id="mtitle"/></li>
            <li class="mui-table-view-cell">
                <div class="new_type"><fmt:message code="email.th.attachmentSpace" />：
