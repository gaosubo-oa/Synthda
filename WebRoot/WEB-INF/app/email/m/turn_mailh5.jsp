...
<header class="mui-bar mui-bar-nav" id="header">
    ...
    <h1 class="mui-title"><fmt:message code="email.th.transmit" /></h1>
...
<div class="mui-content" id="aaa">
    <div class="mui-table">
        <ul class="mui-table-view">
            <li class="mui-table-view-cell mui-input-row"><label class="mui-left"><fmt:message code="email.th.recipients" />：</label><input type="text" placeholder="<fmt:message code="email.th.selectTheRecipient" />" value="" class="mui-input-clear" id="tname"/><input value="" type="hidden" id="reciever"/><span id="Popover_0" class='mui-icon mui-icon-plus'  ></span></li>
            ...
            <li class="mui-table-view-cell mui-input-row"><label class="mui-left"><fmt:message code="notice.th.title" />：</label><input disabled="disabled" type="text" placeholder="<fmt:message code="mailMonitoring.enterSubject" />" class="mui-input-clear" value="" id="mtitle"/></li>
...
<div class="mui-content" style="display: none" id="ccc">
    <div class="mui-bar mui-bar-nav" id="header2">
        ...
        <a class="mui-btn-link mui-pull-right" id="re_mail"><fmt:message code="main.th.confirm" /></a>
    </div>
...
<script type="text/javascript">
    ...
    var app='<div><p><fmt:message code="email.th.sender" />：<span id="fnames"></span></p><p><fmt:message code="email.th.recipients" />：<span id="toName"></span></p><p><fmt:message code="email.th.carbonCopyRecipients" />：<span id="copyName"></span></p><p><fmt:message code="email.th.sendingTime" />：<span id="sendtime"></span></p><p><fmt:message code="email.th.main" />：<span id="subject"></span></p><p><fmt:message code="email.th.file" />：<span id="strs"></span></p><p><fmt:message code="notice.th.content" />：</p><p id="objs"></p></div>'
