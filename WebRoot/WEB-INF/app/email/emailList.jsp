...
<%--    <script type="text/javascript" src="/js/jquery/jquery-migrate-3.4.0.js"></script>--%>
    ...
    <style>
        ...
        .searchTxt{width:60%;height:30px;padding-left:5px;margin-bottom:5px;}
        ...
        .main_right #TAB tr td>span>span{
            float: left;
        }
...
<body>
<div class="page">
    <div class="main" style="display: block;position: relative;width:100%;">
        <div class="main_left" style="position: relative;border-right: none;left: 0px;height: 100%;">
            <div class="opeartion">
                <div class="sort" style="margin-left: 25px">
                    ...
                    <img class="selectReaders" title='<fmt:message code="notice.th.allSelect" />' src="../img/commonTheme/theme6/selectReaders1.png"/><%--标记已读--%>
                ...
                <div style="display:none;" class="search_div">
                    <input type="text" name="text" class="searchTxt" placeholder="<fmt:message code="main.th.ContentSearch" />"> <span class="searchBtn"><fmt:message code="workflow.th.sousuo" /></span> <span class="cancleSpan"><fmt:message code="depatement.th.quxiao" /></span>
                </div>
        ...
        <div class="main_middle" style="height: 100%;"></div>
        <div class="main_div_right" id="main_div_right" style="width: 72%;float: left;">
            <%--没有邮件显示--%>
            ...
            <div class="main_right detailes" style="display: block;height: 100%;">
                ...
                <div class="imformation" style="position: absolute;margin-top: 45%;height: 30%;width: 98%;display: none">
            ...
            <div class="main_right drafts" style="display: none;height: 100%;overflow-y: auto;">
                <table border="1" cellspacing="0" cellpadding="0" style="margin-bottom: 10px;">
                    ...
                    <tr class="InText" style="display: none">
                        ...
                        <td><input type="text" id="outEmail" style="width: 70%;padding: 5px;border: 1px solid #cccccc" class="input_txt"></td>
                    </tr>
                    <tr class="InText" style="display: none">
                    ...
                    <tr class="Attachment" style="width:100%;">
                        ...
                        <td width="89%"   class="files" id="files_txt">
...
<script src="../js/email/emailList.js?20230523.1" type="text/javascript" charset="utf-8"></script>
...
<script type="text/javascript">
    ...
    function autodivheight(){
        ...
        document.getElementById("main_div_right").style.height= winHeight - 7 +"px";
...
//        清除
        ...
        $('.main_left').on('click','.BTN',function(){
            // 同步未读计数
            if ($(this).find('.shang').children().length >2){
                $(this).find('.shang').children('.noReadF').remove();
                var temp = $("#unreadNum", window.parent.document).html();
                temp = temp - 1;
                $("#unreadNum",  window.parent.document).html(temp);
            }
