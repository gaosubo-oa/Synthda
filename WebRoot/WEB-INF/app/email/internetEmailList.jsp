...
<%--    <script type="text/javascript" src="/js/jquery/jquery-migrate-3.4.0.js"></script>--%>
    ...
    <script src="../js/email/manageMail.js?20230412.1" type="text/javascript" charset="utf-8"></script>
    <style type="text/css">
        body{
            overflow-x: hidden;
            color: #383838;
...
<div class="content">
    <%--<div class="DIV_LIST" id="DIV_LIST" style="display: block;">
        <div class="title title_box">
            <div class="div_title">Internet 邮箱</div>
            <a href="##" class="newClassTitle" id="newEmailBtn">新建邮箱</a>
        </div>
        <div class="TABLE">
            <form action="" method="get">
                <table cellspacing="0" cellpadding="0" width="40%" style=" border-collapse:collapse;background-color: #fff;margin-left: 17px;">
                    <thead>
                        <tr>
                            <th width="80%">电子邮箱地址</th>
                            <th collspan="2">操作</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td style="text-align: center">1223519172@qq.com</td>
                            <td collspan="2">
                                <a href="javascript:;" style="margin-left: 25px;">配置</a>
...
<script>
    ...
    $('#newEmailBtn').on('click',function () {
        ...
        var Ifrmae = '<div class="div_iframeOne" style="width: 100%; overflow-y: hidden; overflow-x: hidden; float: left; height: 100%;">' +
            '<iframe name="iframe1" width="100%" height="100%" src="/email/internetEmailInfo" onload="this.height=iframe1.document.body.scrollHeight+100" frameborder="0" noresize="noresize"></iframe>' +
            '</div>';
        $('.content').append(Ifrmae);
