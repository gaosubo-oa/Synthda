...
<div>
    <section class="usernav">
        <a href="/MeetingCommon/myMeetingh5">
            <img src="../img/meeting/m/Apply.png"/>
            <div>会议申请</div>
        </a>
        <a href="#">
            <img src="../img/meeting/m/metting.png"/>
            <div>我的会议</div>
        </a>
        <a href="#">
            <img src="../img/meeting/m/manage.png"/>
            <div>会议管理</div>
        </a>
        <a href="#">
            <img src="../img/meeting/m/query.png"/>
            <div>会议查询</div>
        </a>
    </section>
    <section class="usernav">
        <a href="#">
            <img src="../img/meeting/m/summary.png"/>
            <div>会议纪要</div>
        </a>
        <a href="#">
            <img src="../img/meeting/m/conferenceManage.png"/>
            <div>会议室管理</div>
        </a>
        <a href="#">
            <img src="../img/meeting/m/deviceManagement.png"/>
            <div>会议室设备管理</div>
        </a>
        <a href="#">
            <img src="../img/meeting/m/admin.png"/>
            <div>管理员设置</div>
        </a>
    </section>
</div>
