...
<div class="head-top">
    <ul class="clearfix">
        ...
        <li class="fl head-top-li" data-type="0"><fmt:message code="notice.th.createANewNotification" /></li> <%--新建--%>
        <li class="fl head-top-img"><img src="/img/twoth.png" alt=""></li>
...
<div class="main" style="min-width: 1150px;">
    <iframe name="notices" src="../../notice/management_PuTuo" frameborder="0"></iframe>
</div>
<script>
    ...
    $('.head-top li').click(function () {
        ...
        if($(this).attr('data-type')==''){
            $('.main').find('iframe').prop('src','../../notice/management_PuTuo')
            ...
            $.ajax({
                ...
                success:function(res){
                    if(res.flag){
                        $('.main').find('iframe').prop('src','../../notice/newAndEdit_PuTuo?type=new')
                    }else{
            ...
            $('.main').find('iframe').prop('src','../../notice/theQuery_PuTuo')
        }
        else if($(this).attr('data-type')=='2'){
            $('.main').find('iframe').prop('src','../../notice/statistical_PuTuo')
        }
    })
</script>
</body>
