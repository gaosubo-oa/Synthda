...
<div class="head-top">
    <ul class="clearfix">
        <li class="fl head-top-li" data-type=""><fmt:message code="notice.th.unreadNotifications" /></li>
        <li class="fl head-top-img"><img src="/img/twoth.png" alt=""></li>
        <li class="fl head-top-li" data-type="0"><fmt:message code="notice.th.allNotifications" /></li>
        <li class="fl head-top-img"><img src="/img/twoth.png" alt=""></li>
...
<script>
    ...
    $('.head-top li').click(function () {
        ...
        if($(this).attr('data-type')==''){
            $('.main').find('iframe').prop('src','../../notice/unread_PuTuo')
        }else if($(this).attr('data-type')=='0'){
            $('.main').find('iframe').prop('src','../../notice/InformTheView_PuTuo')
        }else if($(this).attr('data-type')=='1'){
            $('.main').find('iframe').prop('src','../../notice/queryAll_PuTuo')
        }
