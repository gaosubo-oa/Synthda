...
border-radius: 3px;"><fmt:message code="notice.th.top" /></span>'+
        ...
        objs=$.tablePage('#pagediv',sumwidth,arr,function (me) {
            me.init('/sys/getPendingNotifyList',[{name:'<fmt:message code="global.lang.edit" />',fn:function(){
                if(isOpenSanyuan) {
                    return 2
                }else {
                    return 1
                }
                }},{name:'<fmt:message code="meet.th.Approval" />'},{name:'<fmt:message code="meet.th.unratified" />'}])
        })
    }
    function yishen() {
