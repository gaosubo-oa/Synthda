...
<%--    <script type="text/javascript" src="/js/jquery/jquery-migrate-3.4.0.js"></script>--%>
    ...
    <script src="/js/notice/theQuery.js?20230525.1"></script>
</head>
<body>
    ...
    border-top: none;">
        <tbody>
            ...
            <tr class="borderNone">
                ...
                <td width="70%">
                    <select name="publishs"  id="click1">
                        <option value=""><fmt:message code="notice.th.all"/></option>
                        <option value="0," onclick="alert(111)"><fmt:message code="notice.th.unposted"/></option>
                        <option value="4,1,5,"><fmt:message code="notice.th.posted"/></option>
                    </select>
                </td>
            </tr>
           <%-- <tr class="borderNone">
...
<script>
    $("#click1").on('change',function(){
        ...
        if($(this).children('option:selected').val()=='4,1,5,'){
            $("#click2").removeAttr('disabled','true');
        }
    })
</script>
</html>