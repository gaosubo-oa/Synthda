...
<body>
<header>
    <i><a href="/notice/noticeh5" style="color: #fff"><fmt:message code="notice.th.return" /></a></i>
    <span><fmt:message code="notice.th.queryDetail" /></span>
            ...
            success:function(res){
                ...
                if(res.flag){
                    var app='<div>'+
                                ...
                                '<div class="cont">'+
                                    '<span class="fs14" style="margin-right:34px ;"><fmt:message code="notice.th.publisher" />：'+res.object.name+'</span>'+
                                    '<span class="fs14"><fmt:message code="notice.th.type" />：<a href="javascript:;" style="color: #5087d0">'+function(){if(res.object.typeName==''){return '<fmt:message code="notice.type.alltype" />'}else{return  res.object.typeName}}()+'</a></span>'+
                                '</div>'+
                                '<div class="cons">'+res.object.auditDate+'</div>'+
                             '</div>'+
                             '<div class="conts" style="line-height: .6rem">'+res.object.content+'</div>'+

                                '<p class="enclosure"><fmt:message code="notice.th.fileUpload" /></p>'+
                                '<div class="conts">'+
                                    function(){
