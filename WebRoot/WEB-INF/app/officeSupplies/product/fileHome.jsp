...
<div style="height: 100%">
    ...
    <div  class="cabinet_left">
        <div id="fileTransTop" style="width:100%;">
            <span class='span_2 tree-icon tree-folder'></span>
    ...
    <div class="cabinet_info">
        <iframe class="iframe_1" src="/officetransHistory/OfficeProductApply?editFlag=0&transId=0" style="width: 100%;height: 100%;" frameborder="0">
                    ...
                    $.ajax({
                        ...
                        success:function(res){
                            ...
                            if(res.flag==true){
                                if(data!=undefined){
                                    for(var i=0;i<data.length;i++){
                                        str+="<li class='proId' url='/officetransHistory/ProductInfo?editFlag=1&transId=0&proid="+data[i].proId+"&depositoryid="+that.parents('.depositoryId').attr('depositoryid')+"&protypeid="+that.attr('protypeid')+"' proId='"+data[i].proId+"'>" +
