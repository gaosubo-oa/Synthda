...
<div class="head-top">
    <ul class="clearfix">
        <li class="fl head-top-li active" data-type="">微讯审核权限</li>
...
<div class="main">
    <iframe name="notices" src="/wxCheck/addWxCheck1" frameborder="0"></iframe>
</div>
<script>
    ...
    $('.head-top li').click(function () {
        ...
        if($(this).attr('data-type')==''){
            $('.main').find('iframe').prop('src','/wxCheck/addWxCheck')
