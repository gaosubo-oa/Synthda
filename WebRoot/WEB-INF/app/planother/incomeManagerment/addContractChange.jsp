...
<div class="layui-collapse">
    <div class="layui-colla-item">
        <h2 class="layui-colla-title">总包合同变更主表</h2>
        <div class="layui-colla-content layui-show plan_base_info">
            <form class="layui-form" id="baseForm" lay-filter="baseForm">
                <div class="layui-row">
                    <div class="layui-col-xs4" style="padding: 0 5px;">
                        <div class="layui-form-item">
                            <label class="layui-form-label form_label">合同编号<span field="planNo" class="field_required">*</span><a title="刷新编号" class="refresh_no_btn"><i class="layui-icon layui-icon-refresh"></i></a></label>
                    ...
                    <div class="layui-col-xs4" style="padding: 0 5px;">
                        <div class="layui-form-item">
                            <label class="layui-form-label form_label">合同类型<span field="planName" class="field_required">*</span></label>
                            <div class="layui-input-block form_block">
                                <input type="text" name="planName" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                ...
                <div class="layui-row">
                    <div class="layui-col-xs4" style="padding: 0 5px;">
                        <div class="layui-form-item">
                            <label class="layui-form-label form_label">甲方<span field="planName" class="field_required">*</span></label>
                            <div class="layui-input-block form_block">
                                <input type="text" name="planName" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    ...
                    <div class="layui-col-xs4" style="padding: 0 5px;">
                        <div class="layui-form-item">
                            <label class="layui-form-label form_label">乙方<span field="planName" class="field_required">*</span></label>
                            <div class="layui-input-block form_block">
                                <input type="text" name="planName" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                ...
                <div class="layui-row">
                    <div class="layui-col-xs4" style="padding: 0 5px;">
                        <div class="layui-form-item">
                            <label class="layui-form-label form_label">预付款<span field="planName" class="field_required">*</span></label>
                            <div class="layui-input-block form_block">
                                <input type="text" name="planName" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    ...
                    <div class="layui-col-xs4" style="padding: 0 5px;">
                        <div class="layui-form-item">
                            <label class="layui-form-label form_label">税率<span field="planName" class="field_required">*</span></label>
                            <div class="layui-input-block form_block">
                                <input type="text" name="planName" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    ...
                    <div class="layui-col-xs4" style="padding: 0 5px;">
                        <div class="layui-form-item">
                            <label class="layui-form-label form_label">不含税合同价<span field="planName" class="field_required">*</span></label>
                            <div class="layui-input-block form_block">
                                <input type="text" name="planName" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                ...
                <div class="layui-row">
                    <div class="layui-col-xs4" style="padding: 0 5px;">
                        <div class="layui-form-item">
                            <label class="layui-form-label form_label">合同签订日期<span field="useDate" class="field_required">*</span></label>
                            <div class="layui-input-block form_block">
                                <input type="text" name="planName" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    ...
                    <div class="layui-col-xs4" style="padding: 0 5px;">
                        <div class="layui-form-item">
                            <label class="layui-form-label form_label">合同工期<span field="planName" class="field_required">*</span></label>
                            <div class="layui-input-block form_block">
                                <input type="text" name="planName" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    ...
                    <div class="layui-col-xs4" style="padding: 0 5px;">
                        <div class="layui-form-item">
                            <label class="layui-form-label form_label">质保期<span field="planName" class="field_required">*</span></label>
                            <div class="layui-input-block form_block">
                                <input type="text" name="planName" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                ...
                <div class="layui-row">
                    <div class="layui-col-xs4" style="padding: 0 5px;">
                        <div class="layui-form-item">
                            <label class="layui-form-label form_label">质保金<span field="useDate" class="field_required">*</span></label>
                            <div class="layui-input-block form_block">
                                <input type="text" name="planName" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    ...
                    <div class="layui-col-xs4" style="padding: 0 5px;">
                        <div class="layui-form-item">
                            <label class="layui-form-label form_label">发票类型<span field="planName" class="field_required">*</span></label>
                            <div class="layui-input-block form_block">
                                <input type="text" name="planName" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    ...
                    <div class="layui-col-xs4" style="padding: 0 5px;">
                        <div class="layui-form-item">
                            <label class="layui-form-label form_label">本次变更总额<span field="planName" class="field_required">*</span></label>
                            <div class="layui-input-block form_block">
                                <input type="text" name="planName" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                ...
                <div class="layui-row">
                    <div class="layui-col-xs4" style="padding: 0 5px;">
                        <div class="layui-form-item">
                            <label class="layui-form-label form_label">合同内容<span field="planName" class="field_required">*</span></label>
                            <div class="layui-input-block form_block">
                                <input type="text" name="planName" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    ...
                    <div class="layui-col-xs4" style="padding: 0 5px;">
                        <div class="layui-form-item">
                            <label class="layui-form-label form_label">合同范围<span field="planName" class="field_required">*</span></label>
                            <div class="layui-input-block form_block">
                                <input type="text" name="planName" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    ...
                    <div class="layui-col-xs4" style="padding: 0 5px;">
                        <div class="layui-form-item">
                            <label class="layui-form-label form_label">付款方式<span field="planName" class="field_required">*</span></label>
                            <div class="layui-input-block form_block">
                                <input type="text" name="planName" autocomplete="off" class="layui-input">
                            </div>
                        </div>
        ...
        layui.use(['form', 'table', 'element','laydate'], function () {
            ...
            if (settleupData) {
                ...
                var cols=[
                    ...
                    {
                        field: 'planMtlName', title: '合同明细', width: 200, templet: function (d) {
                    ...
                    {
                        field: 'directUnitPrice', title: '综合单价',
                    },
                    {
                        field: 'estiUnitPrice', title: '合价', templet: function (d) {
