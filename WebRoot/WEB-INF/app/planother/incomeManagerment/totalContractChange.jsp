...
<div class="container">
    ...
    <div class="wrapper">
        <div class="wrap_left">
            <h2 style="text-align: center;line-height: 35px;">总包合同变更</h2>
            <div class="left_form">
...
<script>
    ...
    var dictionaryStr = 'CONTRACT_TYPE,PAYMENT_METHOD,CONTROL_TYPE,CBS_UNIT,INVOICE_TYPE,COMPARE_TYPE';
    ...
    layui.use(['form', 'laydate', 'table', 'element', 'soulTable', 'eleTree', 'xmSelect'], function () {
        ...
        //表格显示顺序
        var colShowObj = {
            subcontractNo: {field: 'subcontractNo',minWidth:100, title: '合同变更编号', sort: true, hide: false},
            ...
            contractPeriod: {field: 'contractPeriod',minWidth:100, title: '本次变更总额', sort: true, hide: false},
            approvalStatus: {
        ...
        function newOrEdit(type, data) {
            ...
            layer.open({
                ...
                content: ['<div class="layui-collapse">\n',
                    /* region 材料计划 */
                    '  <div class="layui-colla-item">\n' +
                    '    <h2 class="layui-colla-title">总包合同变更</h2>\n' +
                    ...
                    '                   <div class="layui-form-item">\n' +
                    '                       <label class="layui-form-label form_label">合同变更编号<span class="field_required">*</span><a title="刷新编号" class="refresh_no_btn"><i class="layui-icon layui-icon-refresh"></i></a></label>\n' +
                    '                       <div class="layui-input-block form_block">\n' +
                    '                       <input type="text" name="documentNo" readonly autocomplete="off" class="layui-input testNull" style="background: #e7e7e7" title="合同变更编号">\n' +
                    '                       </div>\n' +
                    '                   </div>' +
                    '               </div>' +
                    '               <div class="layui-col-xs2 layui_col" style="padding: 0 5px;">' +
                    ...
                    '               <div class="layui-col-xs2 layui_col" style="padding: 0 5px;">' +
                    '                   <div class="layui-form-item">\n' +
                    '                       <label class="layui-form-label form_label">合同金额(元)<span class="field_required">*</span></label>\n' +
                    '                       <div class="layui-input-block form_block">\n' +
                    ...
                    '               <div class="layui-col-xs2 layui_col" style="padding: 0 5px;">' +
                    '                   <div class="layui-form-item">\n' +
                    '                       <label class="layui-form-label form_label">本次变更总额</label>\n' +
                    '                       <div class="layui-input-block form_block">\n' +
                    '                       <input type="number" name="warrantyCash2" autocomplete="off" class="layui-input chinese" title="本次变更总额">\n' +
                    '                       </div>\n' +
                    '                   </div>' +
                    '               </div>' +
                    '               <div class="layui-col-xs2 layui_col" style="padding: 0 5px;">' +
                ...
                success: function () {
                    ...
                    var cols=[
                        ...
                        },
                        {
                            ...
                            templet: function (d) {
                                return '<input type="number" '+(type==4 ? 'readonly' : '')+'  name="contractPrice" subcontractId="'+(d.subcontractId||'')+'" subcontractOutId="'+(d.subcontractOutId||'')+'" projBudgetId="'+(d.projBudgetId||'')+'" cbsId="'+(d.cbsId || '')+'" wbsId="'+(d.wbsId || '')+'" rbsId="' + (d.rbsId || '') + '" class="layui-input contractPriceItem" style="height: 100%;" value="' + (d.contractPrice || '')+ '">'
                            }
                        },
                        {
