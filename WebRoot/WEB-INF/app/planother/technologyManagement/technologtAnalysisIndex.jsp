...
<div class="container">
	...
	<div class="wrapper">
		<div class="wrap_left">
			<h2 style="text-align: center;line-height: 35px;">技术汇总报表</h2>
			<div class="left_form">
	...
	layui.use(['form', 'laydate', 'table', 'element', 'eleTree', 'layer'], function () {
		...
		function tableShow(projId) {
			tableIns = table.render({
				elem: '#tableDemo',
				url: '/technologtAnalysis/analysisScheme',
				cols:  [[ //表头
					{title: '序号',type: 'numbers'}
					, {field: 'technicalName', title: '技术方案名称', minWidth: 120,sort: true, hide: false}
					, {field: 'createTime', title: '日期',minWidth: 120, sort: true, hide: false}
					, {
						field: 'auditerStatus',
						title: '审核状态',
						minWidth: 120,
			...
			tableIns2 = table.render({
				elem: '#tableDemo2',
				url: '/technologtAnalysis/analysisDisclosure',
				cols:  [[ //表头
					{title: '序号',type: 'numbers'}
					, {field: 'disclosureName', title: '技术交底名称', minWidth: 120,sort: true, hide: false}
					, {field: 'createTime', title: '日期',minWidth: 120, sort: true, hide: false}
					, {
						field: 'auditerStatus',
						title: '审核状态',
