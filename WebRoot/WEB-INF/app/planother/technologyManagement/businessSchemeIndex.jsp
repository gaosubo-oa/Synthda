...
<div class="container">
	...
	<div class="wrapper">
		<div class="wrap_left">
			<h2 style="text-align: center;line-height: 35px;">经营计划</h2>
			<div class="left_form">
		...
		<div class="wrap_right">
			<div class="query_module layui-form layui-row" style="position: relative">
				...
				<div class="layui-col-xs2" style="margin-left: 15px;">
					<input type="text" name="businessName" placeholder="经营名称" autocomplete="off" class="layui-input">
				</div>
				<div class="layui-col-xs2" style="margin-left: 15px;">
	...
	layui.use(['form', 'laydate', 'table', 'element', 'eleTree', 'layer','soulTable'], function () {
		...
		var colShowObj = {
			documnetNo: {field: 'documnetNo', title: '单据号', minWidth: 90,sort: true, hide: false,templet: function (d) {
					return '<span businessId="'+d.businessId+'">'+(d.documnetNo||'')+'</span>'
				}},
			projectName:{field:'projectName',title:'项目名称',minWidth: 120,sort:true,hide:false},
			businessName: {field: 'businessName', title: '经营名称', minWidth: 120,sort: true, hide: false},
			schemeDesc: {field: 'schemeDesc', title: '经营描述', minWidth: 120,sort: true, hide: false},
			// mainSchemeContent: {field: 'mainSchemeContent', title: '主要内容', minWidth: 120,sort: true, hide: false},
			schemeCategory:{field:'schemeCategory',title:'经营类别',minWidth: 120,sort:true,hide:false,templet: function (d) {
					if(d.schemeCategory) {
			...
			schemeType:{field:'schemeType',title:'经营类型',minWidth: 120,sort:true,hide:false,templet: function (d) {
					if(d.schemeType) {
			...
			chargeUserName: {field: 'chargeUserName', title: '责任人', minWidth: 120,sort: true, hide: false},
			superviseUserName: {field: 'superviseUserName', title: '监督人', minWidth: 120,sort: true, hide: false},
		...
		var dictionaryStr = 'BUSINESS_CATEGORY,BUSINESS_TYPE';
		...
		var TableUIObj = new TableUI('plb_other_business_scheme');
		...
		table.on('toolbar(tableDemo)', function (obj) {
			...
			switch (obj.event) {
				...
				case 'edit':
					...
					if($('#leftId').attr('projId')){
						var businessId = $('.table_box .layui-table-body .layui-form-checked').parents('tr').find('[data-field="documnetNo"] span').attr('businessId')
						var loadIndex = layer.load();
						$.get('/businessScheme/getById', {kayId:businessId}, function (res) {
				...
				case 'del':
					...
					layer.confirm('确定删除该条数据吗？', function (index) {
						$.post('/businessScheme/del', {ids: businessId}, function (res) {
							if (res.code=='0') {
				...
				case 'submit':
					...
					layer.open({
						...
						success: function () {
							$.get('/plbFlowSetting/getOwnFlowData', {plbDictNo: '69'}, function (res) {
								var flowData = []
		...
		table.on('tool(tableDemo)', function (obj) {
			...
			var businessId = $(obj.tr.selector).find('[data-field="documnetNo"] span').attr('businessId')
			if(layEvent === 'detail'){
				var loadIndex = layer.load();
				$.get('/businessScheme/getById', {kayId:businessId}, function (res) {
					layer.close(loadIndex);
		...
		function newOrEdit(type, data) {
			...
			layer.open({
				...
				'               <div class="layui-col-xs3 layui-col" style="padding: 0 5px;">' +
				'                   <div class="layui-form-item">\n' +
				'                       <label class="layui-form-label form_label">经营名称<span field="businessName" class="field_required">*</span></label>\n' +
				'                       <div class="layui-input-block form_block">\n' +
				...
				'    			<div class="layui-col-xs3 layui-col" style="padding: 0 5px;">' +
				'    			    <div class="layui-form-item">\n' +
				'    			        <label class="layui-form-label form_label">经营描述<!--<span field="schemeDesc" class="field_required">*</span>--></label>\n' +
				'    			        <div class="layui-input-block form_block">\n' +
				...
				'               <div class="layui-col-xs3 layui-col" style="padding: 0 5px;">' +
				'                   <div class="layui-form-item">\n' +
				'                       <label class="layui-form-label form_label">经营类别<span field="schemeCategory" class="field_required">*</span></label>\n' +
				'                       <div class="layui-input-block form_block">\n' +
				...
				'           </div>' ,
					...
					'               <div class="layui-col-xs3 layui-col" style="padding: 0 5px;">' +
					'                   <div class="layui-form-item">\n' +
					'                       <label class="layui-form-label form_label">经营类型<span field="schemeType" class="field_required">*</span></label>\n' +
					'                       <div class="layui-input-block form_block">\n' +
					...
					'<input type="file" multiple id="fileupload" data-url="/upload?module=businessScheme" name="file">' +
					'</a>' +
				...
				success: function () {
					...
					//经营类别
					var $select = '<option value="">请选择经营类别</option>'
					$select += dictionaryObj&&dictionaryObj['BUSINESS_CATEGORY']&&dictionaryObj['BUSINESS_CATEGORY']['str']
					$('[name="schemeCategory"]').append($select)

					//经营类型
					var $select2 = '<option value="">请选择经营类型</option>'
					$select2 += dictionaryObj&&dictionaryObj['BUSINESS_TYPE']&&dictionaryObj['BUSINESS_TYPE']['str']
					...
					if (type == 1 || type == 4) {
						...
						// 获取自动编号
						getAutoNumber({autoNumberType: 'businessScheme'}, function(res) {
