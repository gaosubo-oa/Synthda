...
<div class="container">
	...
	<div class="wrapper">
		<div class="wrap_left">
			<h2 style="text-align: center;line-height: 35px;">计划报表</h2>
			<div class="left_form">
		...
		function tableShow(projId) {
			tableIns = table.render({
				...
				cols:  [[ //表头
					...
					, {field: 'optimizationName', title: '优化方案名称', minWidth: 120,sort: true, hide: false}
			...
			tableIns2 = table.render({
				...
				cols:  [[ //表头
					{title: '序号',type: 'numbers'}
					, {field: 'businessName', title: '经营方案名称', minWidth: 120,sort: true, hide: false}
					, {field: 'createTime', title: '日期',minWidth: 120, sort: true, hide: false}
					, {
						field: 'auditerStatus',
						title: '审核状态',
