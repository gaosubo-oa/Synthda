    ...
    layui.use(['table','layer','form','element','eleTree','laydate','upload'], function(){
        ...
        // 初始化渲染 树形菜单
            el = eleTree.render({
                elem: '.ele1',
                showLine:true,
                url:'/workflow/qualityManager/getQualityTemplteByType?parent=0',
                lazy: true,
                // checked: true,
                load: function(data,callback) {
                    $.post('/workflow/qualityManager/getQualityTemplteByType?parent='+data.id,function (res) {
                        callback(res.data);//点击节点回调
                    })
                },
                done:function (data) { //渲染完成回调
            ...
            if (events == 'addTest') {
                layer.open({
                        ...
                        $("[name='ttitle3']").on("click",function (e) {
                            ...
                            if(standTypeId==undefined||standTypeId==""){
                                ...
                                layer.open({
                                    ...
                                    maxmin: true,
                                    btn: ['提交', '取消'],
                                    content: '/workflow/qualityManager/toQualityStandard?type=checkTemplte&knowTypeIds='+standTypeId,
                                    success: function () {
                    ...
                    yes: function (index, layero) {
                       ...
                       if(securityDangerIds==undefined||securityDangerIds==""){
                            ...
                            // });
                            $.ajax({
                                url:'/workflow/qualityManager/insertQualityTemplteDetails',
                                dataType:'json',
                                type:'post',
                                data:details,
                                success:function(res){
                ...
                if(datas.length<1){
                    ...
                    layer.confirm('确定要删除选中的检查项吗？', {icon: 3, title:'提示'}, function(index){
                        ...
                        $.ajax({
                            url:'/workflow/qualityManager/delQualityTemplteDetails',
                            type: 'post',
                            dataType: 'json',
                            data:{details:ids},
                            success:function(res){
                    ...
                    layer.open({
                        ...
                        yes: function (index, layero) {
                            ...
                            if(securityDangerIds==undefined||securityDangerIds==""){
                                ...
                                // });
                                $.ajax({
                                    url:'/workflow/qualityManager/updateQualityTemplteDetails',
                                    dataType:'json',
                                    type:'post',
                                    data:details,
                                    success:function(res){
            ...
            layer.open({
                ...
                yes: function (indexx) {
                    ...
                    if($("#templteName").val()==''){ //||$("#columnCode").val()==''
                        ...
                        $.ajax({
                            type: "post",
                            url: '/workflow/qualityManager/insertQualityTemplte',
                            dataType: "json",
        ...
        $('#editPlan').click(function () {
            layer.open({
                ...
                success: function () {
                    $.ajax({
                        url:'/workflow/qualityManager/selectQualityTemplte?secirityId='+columnTrId,
                        dataType:'json',
                        type:'post',
                        success:function(res){
                            if(res.code===0||res.code==="0"){
                ...
                yes: function (indexx) {
                    ...
                    if($("#templteName").val()==''){ //||$("#columnCode").val()==''
                        ...
                        $.ajax({
                            type: "post",
                            url: '/workflow/qualityManager/updateQualityTemplte',
                            dataType: "json",
                            data:plbSecurityKnowledge,
                            success:function (res) {
                                if(res.code == "0" || res.code == 0){
        ...
        $('#delPlan').click(function () {
            if(columnTrId){
                layer.confirm('是否要删除', {icon: 3, title: '删除'}, function (index) {
                    $.ajax({
                        url: '/workflow/qualityManager/delQualityTemplteByType',
