        ...
        <form class="layui-form" id="baseForm" lay-filter="baseForm">
            <div class="layui-form">
              <div class="layui-row">
                  ...
                  <div class="layui-col-xs4">
                      <div class="layui-form-item">
                          <label class="layui-form-label form_label">进度计划名称</label>
                          <div class="layui-form-block form_block">
                              <input type="text" class="layui-input" name="superviseName" id="superviseName"  placeholder="请填写进度计划名称"  autocomplete="off">
                          </div>
                      </div>
                  </div>
                  <div class="layui-col-xs4">
              ...
              <div class="layui-row" >
                  <div class="layui-col-xs6">
                      <div class="layui-form-item">
                          <label class="layui-form-label form_label">主要内容</label>
                          <div class="layui-form-block form_block" style="margin-right:10px ">
                              <textarea class="layui-textarea" name="primaryCoverage" id="primaryCoverage" placeholder="请输入主要内容" ></textarea>
                          </div>
                      </div>
                  </div>
                  <div class="layui-col-xs6">
                      <div class="layui-form-item">
                          ...
                          <div class="layui-form-block form_block">
                              <textarea class="layui-textarea" name="superviseDesc" id="superviseDesc"  placeholder="请输入备注" ></textarea>
                          </div>
                      </div>
                  </div>
              </div>
              <div class="layui-row" style="margin-top: 20px">
                  <div class="layui-col-xs4"style="width: 100%">
                      <div class="layui-form-item">
                          <label class="layui-form-label form_label">进度计划附件</label>
                          <div class="layui-form-block form_block">
                              <div class="layui-input-inline"  style="width: 100%">
                                  ...
                                  <a href="javascript:;" class="openFile" style="position:relative">
                                      ...
                                      <span>添加附件</span>
                                      <input type="file" multiple id="fileupload1" data-url="/upload?module=schedulePlan"  name="file">
                                  </a>
                              </div>
                          </div>
                      </div>
    ...
    layui.use(['table','layer','form','element','eleTree','upload','laydate'], function() {
        ...
        if (urlType === 'addTest') {
            if (projectId != undefined) {
                //单据号
                $.ajax({
                    url: '/planningManage/autoNumber?autoNumberType=jdjh',
                    dataType: 'json',
                    type: 'post',
                    async: true,
            ...
            $.ajax({
                url: '/schedulePlan/getTechnicalReportById?superviseId=' + superviseId,
                async: false,
                success: function (res) {
                    formData = res.obj;
                }
            ...
            $.ajax({
                url:'/schedulePlan/getTechnicalReportByRunId?runId='+runId,
                async:false,
                success:function(res){
                    formData=res.obj;
                }
