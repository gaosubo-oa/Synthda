...
<div class="mbox">
	<div class="layui-tab layui-tab-card" style="margin: 3px 0 10px 0;">
		...
		<%---------------------------------------------安全检查-------------------------------------------------%>
		<div style="margin: 7px 23px;width: 95%;height:36px;line-height:36px;font-weight:bold;padding-left: 6px;background-color: #eeeeee">安全检查</div>
		...
		<div class="layui-input-inline"  style="margin-left: 130px;">
			...
			<%------------------------------------------------安全整改---------------------------------------------------%>
			<div style="margin: 7px 23px;width: 95%;height:36px;line-height:36px;font-weight:bold;padding-left: 6px;background-color: #eeeeee">安全整改</div>
			<div class="layui-form-item" style="width: 98%;margin:10px 0;display: inline-block">
				<div class="layui-inline" style="width: 98%;">
			...
			<div id="acceptance1" style="display: none">
				<div style="margin: 7px 23px;width: 95%;height:36px;line-height:36px;font-weight:bold;padding-left: 6px;background-color: #eeeeee">安全验收</div>
				<div class="layui-form-item" style="width: 98%;margin:10px 0;display: inline-block">
					<div class="layui-inline" style="width: 98%;">
...
<script type="text/javascript">
	var securityInfoDate = parent.securityInfoDate;//安全整改
	//alert(securityInfoDate)
	var securityInfoDate1 = parent.securityInfoDate1;//安全验收
	//console.log(securityInfoDate1)
	var urlType = getUrlParam("urlType");//安全验收
	//console.log(urlType)
	...
	layui.use(['table','layer','form','element','eleTree','upload','laydate'], function() {
		...
		if (urlType === 'acceptance'){
			...
			$('#placeSpan').on("click",function() {
				$.popWindow("/workflow/secirityManager/selectDrawing?layEvent4=examineTest1&securityContentId="+securityInfoDate1.securityContentId);
			})
		}else{
			...
			$('#placeSpan').on("click",function() {
				$.popWindow("/workflow/secirityManager/selectDrawing?layEvent3=initialization1&securityContentId="+securityInfoDate.securityContentId);
			})
		}
