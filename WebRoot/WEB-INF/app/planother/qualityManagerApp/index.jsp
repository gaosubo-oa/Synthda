...
<div style="margin-top: 20px;position: relative;">
    <img src="../../img/log2.png" style="position: absolute;left: 21px;top: 2px;width: 25px; "><span
        style="margin-left: 49px;font-size: 20px;">质量检查</span>
...
<script>
    ...
    function initCheck() {
          $.ajax({
              url:'/workflow/qualityManager/getQualityCheckByOption?checkType=1',
              datatype:'json',
              type:'get',
                  ...
                  if(res.obj==undefined){
                      ...
                      for(var i=0;i<res.obj.otherData.length;i++){
                          ...
                          $(document).on('click','#htm'+i,function(){
                              ...
                              window.location.href="/workflow/qualityManager/securityCheckApp?&testTypeNo="+testTypeNo+"&datatype=1&seciritytype=0";
                          })
                      }
                      ...
                      $("#dvbox1").click(function(){
                          window.location.href="/workflow/qualityManager/securityCheckApp?datatype=0&seciritytype=0"
                      })
                  }
              }
          })
    ...
    function initName() {
        $.ajax({
            url:'/workflow/qualityManager/getQualityCheckByOption?project=1',
            datatype:'json',
            type:'get',
            success:function(res){
                var htm='';
                if(res.obj==undefined){
                    ...
                    for(var i=0;i<res.obj.otherData.length;i++){
                        ...
                        $(document).on('click','#bx'+i,function(){
                            ...
                            window.location.href="/workflow/qualityManager/securityCheckApp?projectId="+projectId+"&datatype=2&seciritytype=0"
                        })
                    }
