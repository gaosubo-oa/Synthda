...
<div style="margin-top: 20px;position: relative;">
    <img src="../../img/log2.png" style="position: absolute;left: 21px;top: 2px;width: 25px; "><span
        style="margin-left: 49px;font-size: 20px;">质量验收</span>
...
<script>
    ...
    function initCheck() {
        $.ajax({
            url:'/workflow/qualityManager/getRecifiOrAcceptByOption?isRecification=false&checkType=1&recificaionStatus=1,3',
            datatype:'json',
            type:'get',
                ...
                if(res.obj==undefined){
                    ...
                    for(var i=0;i<res.obj.otherData.length;i++){
                        ...
                        $(document).on('click','#htm'+i,function(){
                            ...
                            window.location.href="/workflow/qualityManager/securityCheckApp?projectId="+projectId+"&testTypeNo="+testTypeNo+"&datatype=1&seciritytype=2";
                        })
                    }
                    ...
                    $("#dvbox1").click(function(){
                        window.location.href="/workflow/qualityManager/securityCheckApp?datatype=0&seciritytype=2"
                    })
                }
    ...
    function initName() {
        $.ajax({
            url:'/workflow/qualityManager/getRecifiOrAcceptByOption?isRecification=false&project=1&recificaionStatus=1,3',
            datatype:'json',
            type:'get',
            success:function(res){
                var htm='';
                if(res.obj==undefined){
                    ...
                    for(var i=0;i<res.obj.otherData.length;i++){
                        ...
                        $(document).on('click','#bx'+i,function(){
                            var projectId=$(this).attr("projectId");
                            window.location.href="/workflow/qualityManager/securityCheckApp?projectId="+projectId+"&datatype=2&seciritytype=2"
                        })
                    }
