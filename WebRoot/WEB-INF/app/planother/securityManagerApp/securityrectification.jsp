...
<div style="margin-top: 20px;position: relative;">
    <img src="../../img/log2.png" style="position: absolute;left: 21px;top: 2px;width: 25px; "><span
        style="margin-left: 49px;font-size: 20px;">安全整改</span>
            ...
            <div id="dv1" style="border: 1px solid #C0C0C0; border-radius: 10px;  height: 110px; background-color: #FFFFFF; margin-top: 2%; margin-bottom:auto; margin-left:auto; margin-right: auto;width: 90%" >
                ...
                <div id="dvbox1" style="display: flex;height: 70px">
                    ...
                    <div style="width: 30%;position: relative">
                        ...
                        <div style="position: absolute;top: 37%;left: 35.3%;">未整改</div>
                    </div>
                    <div style="width: 30%;position: relative">
                        <div style="position: absolute;top: 7%;left: 50%;font-size: 19px;color:#00FF00" id="yNum1"></div>
                        <div style="position: absolute;top: 37%;left: 35.3%;">已整改</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="layui-tab-item">
            <div id="dv2" style="border: 1px solid #C0C0C0; border-radius: 10px;  height: 110px; background-color: #FFFFFF; margin-top: 2%; margin-bottom:auto; margin-left:auto; margin-right: auto;width: 90%" >
                ...
                <div id="dvbox2" style="display: flex;height: 70px">
                    ...
                    <div style="width: 30%;position: relative">
                        <div style="position: absolute;top: 7%;left: 50%;font-size: 19px;color:#00FF00" id="yNum2">1</div>
                        <div style="position: absolute;top: 37%;left: 35.3%;">已整改</div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function initCheck() {
        $.ajax({
            url:'/workflow/secirityManager/getRecifiOrAcceptByOption?isRecification=true&checkType=1&recificaionStatus=0,1,3',
            datatype:'json',
            type:'get',
                ...
                if(res.obj==undefined){
                    ...
                    for(var i=0;i<res.obj.otherData.length;i++){
                        ...
                        $(document).on('click','#htm'+i,function(){
                            ...
                            window.location.href="/workflow/secirityManager/securityCheckApp?projectId="+projectId+"&testTypeNo="+testTypeNo+"&datatype=1&seciritytype=1";
                        })
                    }
                    ...
                    $("#dvbox1").click(function(){
                        window.location.href="/workflow/secirityManager/securityCheckApp?datatype=0&seciritytype=1"
                    })
                }
    ...
    function initName() {
        $.ajax({
            url:'/workflow/secirityManager/getRecifiOrAcceptByOption?isRecification=true&project=1&recificaionStatus=0,1,3',
            datatype:'json',
            type:'get',
            success:function(res){
                var htm='';
                if(res.obj==undefined){
                    ...
                    for(var i=0;i<res.obj.otherData.length;i++){
                        ...
                        $(document).on('click','#bx'+i,function(){
                            var projectId=$(this).attr("projectId");
                            window.location.href="/workflow/secirityManager/securityCheckApp?projectId="+projectId+"&datatype=2&seciritytype=1"
                        })
                    }
