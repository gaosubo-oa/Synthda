...
<script>
    ...
    function initsecurityContent(securityContentId) {
          $.ajax({
              ...
              success:function (res) {
                 ...
                 // $("#spa").click(function(){
                 //     window.location.href="/workflow/secirityManager/securityDrawing?securityContentId="+securityContentId+"";
                 // })
    ...
    function checkSubmit() {
        ...
        if(checkFlag==1){
            ...
            if (needRecification==1){
                ...
                needAcceptance=1;
                $.ajax({
                    url:'/workflow/secirityManager/updateDetailsInfo?checkFlag=1&recificationStatus=0',
                    ...
                    success:function(res){
                        window.history.go(-1);
                        // window.location.href="/workflow/secirityManager/securityCheckApp?projectId="+projectId+"&testTypeNo="+testTypeNo+"&datatype="+datatype+"&seciritytype="+seciritytype+""
                    }
                })
            }else{
                //是否整改选择是
  ...
  function rectificationPreservation(securityContentId) {
      ...
      if(recificationFlag==1){
          ...
          $.ajax({
              url:'/workflow/secirityManager/rectification?recificationFlag=1',
  ...
  function rectificationSubmit() {
      ...
      if(recificationFlag==1){
          ...
          $.ajax({
              url:'/workflow/secirityManager/commitAcceptance?type=rectification&acceptance=true&recificationFlag=1',
  ...
  function acceptanceAgree() {
      ...
      if(acceptanceFlag==1){
          ...
          $.ajax({
              url:'/workflow/secirityManager/commitAcceptance?type=accptance&flag=true&acceptance=true&acceptanceFlag=1',
   ...
   function acceptanceBack() {
    //安全验收保存并退回
       if(acceptanceFlag==2){
           ...
           $.ajax({
               url:'/workflow/secirityManager/commitAcceptance?type=accptance&flag=false&acceptance=true&acceptanceFlag=2',
               data:{ids:ids,rectificationId:rectificationId,acceptanceDesc:acceptanceDesc,attachmentId:attachmentId,attachmentName:attachmentName,acceptanceTime:acceptanceTime},
               datatype:"json",
               success:function(res){
                   window.history.go(-1);
    ...
    function acceptancePreservation() {
        ...
        if(acceptanceFlag==1){
            ...
            $.ajax({
                url:'/workflow/secirityManager/acceptance?acceptanceFlag=1',
