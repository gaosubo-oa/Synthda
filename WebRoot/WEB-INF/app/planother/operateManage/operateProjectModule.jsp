...
<script>
    ...
    //表格显示顺序
    var colShowObj = {
        manageProjNo: {field: 'manageProjNo', title: '立项编号', sort: true, hide: false},
        projectName:{field:'projectName',title:'项目名称'},
        manageProjName:{field:'manageProjName',title:'经营立项名称'},
        //itemType:{field: 'manageProjTypeName', title: '经营立项类型', sort: false, hide: false},
        projectDate:{field:'projectDate',title:'经营立项日期'},
        // itemContent: {field: 'manageProjContent', title: '立项内容', sort: true, hide: false},
        // itemAmount: {field: 'changeIncome', title: '预计变更收入', sort: true, hide: false},
        createUserName:{field:'createUserName',title:'创建人'},
        createTime: {
        ...
        manageProjStatus: {
            field: 'manageProjStatus', title: '审批状态', sort: true, hide: false, templet: function (d) {
                var str = '';
                switch (d.manageProjStatus) {
                    case '0':
                        str = '未提交';
                        break;
                    case '1':
        ...
        // approvaler: {field: 'approvaler', title: '审批人', sort: true, hide: false},
        // approvalTime: {
    ...
    var TableUIObj = new TableUI('plb_other_manager_project');
        ...
        layui.use(['form', 'table', 'element', 'soulTable', 'eleTree','xmSelect','laydate'], function () {
                ...
                switch (obj.event) {
                    ...
                    case 'del':
                        ...
                        checkStatus.data.forEach(function (v, i) {
                            ids += v.manageProjId + ','
                            if(v.manageProjStatus&&v.manageProjStatus!='0'){
                                isFlay = true
                            }
                        })
                        if(isFlay){
                        ...
                        layer.confirm('确定删除该条数据吗？', function (index) {
                            $.post('/manageProject/del', {ids: ids}, function (res) {
                    ...
                    case 'submit':
                        ...
                        if(checkStatus.data[0].manageProjStatus&&checkStatus.data[0].manageProjStatus != '0'){
                            ...
                            yes: function (index) {
                                ...
                                if (checkStatus.data.length > 0) {
                                    ...
                                    newWorkFlow(flowData.flowId, function (res) {
                                        var submitData = {
                                            manageProjId:approvalData.manageProjId,
                ...
                switch (obj.event) {
                    case 'detail':
                        if($('#leftId').attr('projId')){
                            ...
                            //     btnAlign: 'c',
                            //     maxmin: true,
                            //     content:'/plbOperateManage/addOperateProjectModule?type=4&manageProjId='+checkStatus.manageProjId,
                            //     success: function () {
                            //
                            //     },
            ...
            function newOrEdit(type, data) {
                ...
                if (type == '0') {
                    ...
                    url = '/manageProject/insert';
                } else if (type == '1') {
                    title = '编辑经营立项';
                    //content = '/plbOperateManage/addOperateProjectModule?type=1&manageProjId='+data.manageProjId;
                    url = '/manageProject/updateRegister?manageProjId='+data.manageProjId;
                    if(data.manageProjStatus&&data.manageProjStatus != '0'){
                        layer.msg('该数据已提交！', {icon: 0, time: 2000});
                        return false;
                    }
                    ...
                    title = '查看详情';
                    //content = '/plbOperateManage/addOperateProjectModule?type=4&manageProjId='+data.manageProjId;
                }
                    ...
                    success: function () {
                        ...
                        if (type === 0) {
                            ...
                            $.ajax({
                                ...
                                async: false,
                                success:function(res){
                                    $('input[name="manageProjNo"]').val(res.obj);
           ...
           /* $(document).on('input propertychange','input[name="runTarPrice"]',function(){
            ...
            function getSearchObj() {
                var searchObj = {
                    ...
                    manageProjStatus:$('input[name="manageProjStatus"]',$('.query_module')).val()
                }
