...
<div class="container">
    ...
    <div class="wrapper">
        <div class="wrap_left">
            <h2 style="text-align: center;line-height: 35px;">经营报表汇总</h2>
            <div class="left_form">
            ...
            <div style="position: relative">
                <div class="table_box"  >
                    <table id="tableObj" lay-filter="parse-table-demo" class="layui-table"  style="display: none" >
                        <thead>
                        <tr>
                            <th lay-data="{field:'sum',minWidth:100,align:'center'}" rowspan="2">变更立项单据号</th>
                            <th lay-data="{field:'wbsOne',minWidth:100,align:'center'}" rowspan="2">变更事项</th>
                            <th lay-data="{field:'wbsOne',minWidth:100,align:'center'}" rowspan="2">变更类型</th>
                            <th lay-data="{field:'youhua',minWidth:100,align:'center'}" colspan="3">日期</th>
                            <th lay-data="{field:'guanli',minWidth:100,align:'center'}" rowspan="2">我方进展说明</th>
                            <th lay-data="{field:'guanli',minWidth:100,align:'center'}" rowspan="2">建设单位审核进展</th>
                            <th lay-data="{field:'manageTarAmount4',minWidth:120}" rowspan="2">建设单位进展说明</th>
                        </tr>
                        <tr>
                            <th lay-data="{field:'contract1',minWidth:100,align:'center'}">年</th>
                            <th lay-data="{field:'contract2',minWidth:100,align:'center'}">月</th>
                            <th lay-data="{field:'contract3',minWidth:100,align:'center'}">日</th>
                        </tr>
                        </thead>
                    </table>
                </div>
        ...
        function tableInit(projId) {
            ...
            $.ajax({
                ...
                success:function(res){
                    ...
                    // }
                    // $("#th1").after(wbsHtm,cbsHtm);
                    layTable.init('parse-table-demo', { //转化静态表格
                        url:'/projectCostAnalysis/getCbsWbsByProj?projId='+projId+'',
