...
<div class="container">
	...
	<div class="wrapper">
		<div class="wrap_left">
			<h2 style="text-align: center;line-height: 35px;">经营立项报表</h2>
			<div class="left_form">
	...
	layui.use(['form', 'laydate', 'table', 'element', 'eleTree', 'layer','soulTable'], function () {
		...
		function tableShow(projId) {
			tableIns = table.render({
				...
				cols:  [[ //表头
					{field:'sum',title:'序号',minWidth: 80,sort:true,hide:false}
					...
					, {field: 'registerDate', title: '经营立项日期',minWidth: 120, sort: true, hide: false}
					, {field: 'firstConfirmInf', title: '甲方最终确认金额',minWidth: 120, sort: true, hide: false}
					, {field: 'firstConfirmInfbig2', title: '实际利润率',minWidth: 120, sort: true, hide: false}
					, {
						field: 'auditerStatus',
						title: '审核状态',
						minWidth: 120,
