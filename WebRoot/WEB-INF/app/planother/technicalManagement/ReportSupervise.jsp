...
<div class="container">
    ...
    <div class="wrapper">
        <div class="wrap_left">
            <h2 style="text-align: center;line-height: 35px;">技术方案</h2>
            <div class="left_form">
                ...
                <form class="layui-form" action="" style="height: 40px">
                    <div class="demoTable" style="height: 40px" >
                        <div class="layui-row">
                            ...
                            <div class="layui-col-xs3">
                                <div class="layui-form-item" style="/*width: 25%;*/margin: 10px -30px 10px;">
                                    <label class="layui-form-label" style="width: 25%;">方案类型</label>
...
<script>
    ...
    layui.use(['treeTable','form','laydate','upload', 'element', 'layer','eleTree','table'], function () {
        ...
        $('#searchCust').click(function () {
            //debugger
            var serchObjUrl = "/technicalManager/selectTechnicalReport?";
            //var searchtext = $("#securityRegionName").attr("pid3");
            var searchtext1 = $("#superviseNo").val();
            var searchtext2 = $("#pele").val();
            var searchtext3 = $('#superviseType').next(".layui-form-select").find("dl dd.layui-this").attr("lay-value");
            var searchtext4 = $("#superviseName").val();
            ...
            if(searchtext3!=""&&searchtext3!=undefined){
                serchObjUrl+="&superviseType="+searchtext3;
            }
        ...
        function tableInit(projectId) {
            SettlementTable = layui.table.render({
                elem: '#Settlement'
                // , data: []
                , url: '/technicalManager/selectTechnicalReport?projectId=' + projectId//数据接口
        ...
        table.on('toolbar(SettlementFilter)', function(obj){
            ...
            if(event === 'addTest'){ //新增
                layer.open({
                    ...
                    btn: ['保存','提交','取消'],
                    btnAlign:'c',
                    content: '/technicalManager/addReportContent?urlType=addTest&projectId=' + projectIdd,
                    success: function () {
                    ...
                    yes: function (index, layero) {
                        ...
                        $.ajax({
                            url:'/technicalManager/insertTechnicalReport',
                            dataType:'json',
                            type:'post',
                            data:childData,
                            success:function(res){
                ...
                if(checkStatus.length<1){
                    ...
                    layer.confirm('确定要删除选中的检查项吗？', {icon: 3, title:'提示'}, function(index){
                        ...
                        $.ajax({
                            url:'/technicalManager/delTechnicalReport?ids='+ids,
                            type: 'post',
                            dataType: 'json',
                            success:function(res){
                                layer.msg(res.msg);
                ...
                if(securityInfoDate.auditerStatus != "0"&& securityInfoDate.auditerStatus !=undefined){
                    ...
                    layer.open({
                        ...
                        btn: ['保存','提交','取消'],
                        btnAlign:'c',
                        content: '/technicalManager/addReportContent?urlType=editTest&projectId=' + projectIdd+'&superviseId='+securityInfoDate.superviseId,
                        yes: function (index, layero) {
                            var childData  = $(layero).find("iframe")[0].contentWindow.getData();
                            if(!childData){
                                return
                            ...
                            $.ajax({
                                url:'/technicalManager/updateTechnicalReport?superviseId='+securityInfoDate.superviseId,
                                dataType:'json',
                                type:'post',
                                data:childData,
                                success:function(res){
                ...
                window.location = '/technicalManager/export'
        ...
        table.on('tool(SettlementFilter)',function(obj){
            ...
            if(layEvent=="details"){
                layer.open({
                    ...
                    btnAlign:'c',
                    btn: ['确定'],
                    content: '/technicalManager/addReportContent?urlType=details&projectId=' + projectIdd+'&superviseId='+data.superviseId,
                    yes: function (index, layero) {
                        layer.close(index);
                    }
                });
