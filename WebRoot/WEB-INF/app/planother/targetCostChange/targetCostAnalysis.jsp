...
<div class="container">
	...
	<div class="wrapper">
		<div class="wrap_left">
			<h2 style="text-align: center;line-height: 35px;">目标费用变更报表</h2>
			<div class="left_form">
		...
		<div class="wrap_right">
			<div class="query_module layui-form layui-row" style="position: relative">
				...
				<div class="layui-col-xs2" style="margin-left: 15px;">
					<select name="optTarType" id="optTarType">

					</select>
				</div>
				<div class="layui-col-xs2" style="margin-left: 15px;">
					<input type="text" name="costChaName"   placeholder="成本目标调整名称"  autocomplete="off" class="layui-input">
				</div>
				<div class="layui-col-xs2" style="margin-left: 15px;">
	...
	layui.use(['form', 'laydate', 'table', 'element', 'eleTree', 'layer','soulTable'], function () {
		...
		$.get('/plbDictonary/selectDictionaryByDictNos', {plbDictNos: dictionaryStr}, function (res) {
			if (res.flag) {
				...
				var str = '<option value="">请选择优化类型</option>'
				str += (dictionaryObj&&dictionaryObj['OPT_TAR_TYPE']&&dictionaryObj['OPT_TAR_TYPE']['str'])||''
				$('#optTarType').html(str)
				form.render();
			}
		});
		...
		function tableShow(projId) {
			tableIns = table.render({
				elem: '#tableDemo',
				url: '/targetCostAnalysis/analysis',
				cols:  [[ //表头
					{field: 'documnetNum', title: '单据号',minWidth:150, sort: false, hide: false},
					{field: 'costChaName', title: '成本目标调整名称',minWidth:120, sort: false, hide: false},
					{field: 'projectName', title: '项目名称',minWidth:120, sort: false, hide: false},
					...
					{field: 'incChaTotal', title: '收入变更总额',minWidth:100, sort: false, hide: false},
