...
<script>
    ...
    layui.use(['form', 'laydate', 'table', 'element', 'eleTree', 'layer','soulTable'], function () {
        ...
        var TableUIObj = new TableUI('plb_quality_plant');
            ...
            switch (obj.event) {
                        ...
                        layer.open({
                            ...
                            success: function () {
                                var tableDemoIn=table.render({
                                    elem: '#tableDemoIn',
                                    url: '/qualityTerm/selectQualityTerm?delFlag=0&projectId='+$('#leftId').attr('projId'),
                                    cols: [[
                                        {checkbox: true},
                ...
                case 'del':
                    ...
                    layer.confirm('确定删除该条数据吗？', function (index) {
                        $.post('/quality2Plan/del', {ids: securityPlanId}, function (res) {
                            if (res.code=='0') {
        ...
        var dom = '.layui-table-body [data-field="documentNo"] span,' +
            '.layui-table-body [data-field="solutions"] div,' +
            '.layui-table-body [data-field="securityDanger"] div,' +
