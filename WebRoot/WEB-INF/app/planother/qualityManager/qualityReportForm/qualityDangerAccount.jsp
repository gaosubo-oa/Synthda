...
<div class="container">
	...
	<div class="wrapper">
		<div class="wrap_left">
			<h2 style="text-align: center;line-height: 35px;">质量隐患台账</h2>
			<div class="left_form">
	...
	layui.use(['form', 'laydate', 'table', 'element', 'eleTree', 'layer','soulTable'], function () {
		...
		var colShowObj = {
			...
			securityGrade: {field: 'securityGrade', title: '重大问题',minWidth: 120, sort: true, hide: false, templet: function (d) {
					if(d.detailsInfo){
						if(d.detailsInfo.securityGrade==0){
							return '<span class="securityGrade" securityGrade="'+d.detailsInfo.securityGrade+'" style="color: red" >是</span>'
			...
			rectificationPeriod: {field: 'rectificationPeriod', title: '整改期限',minWidth: 120, sort: true, hide: false,templet: function (d) {
					return '<span>'+(d.detailsInfo?d.detailsInfo.rectificationPeriod:'')+'</span>'
				}},
		...
		function newOrEdit(data) {
			...
			layer.open({
				...
				btn: '确定',
				btnAlign: 'c',
				content: '/workflow/qualityManager/addRectification?urlType=dangerAccount',
				success: function () {
