...
<div class="container">
	...
	<div class="wrapper">
		<div class="wrap_left">
			<h2 style="text-align: center;line-height: 35px;">工序交接报表</h2>
			<div class="left_form">
		...
		<div class="wrap_right">
			<div class="query_module layui-form layui-row" style="position: relative">
				...
				<div class="layui-col-xs2" style="margin-left: 15px;">
					<input type="text" name="acceptanceProcedure"  placeholder="验收工序"  autocomplete="off" class="layui-input">
				</div>
		...
		function tableShow(projId) {
			tableIns = table.render({
				...
				cols:  [[ //表头
					...
					, {field: 'processHandoverPosition', title: '部位', minWidth: 120,sort: true, hide: false}
					, {field: 'acceptanceProcedure', title: '验收工序',minWidth: 120, sort: true, hide: false}
					, {field: 'acceptanceProcedureTeam', title: '验收工序班组',minWidth: 120, sort: true, hide: false}
					, {field: 'nextProcedureName', title: '下道工序名称',minWidth: 120, sort: true, hide: false}
					, {field: 'projectAcceptanceUserName', title: '项目部验收人员',minWidth: 120, sort: true, hide: false}
					, {field: 'acceptanceDate', title: '验收日期',minWidth: 120, sort: true, hide: false}
				]],
