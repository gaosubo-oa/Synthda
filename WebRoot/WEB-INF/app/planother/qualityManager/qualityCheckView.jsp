...
<script>
    ...
    function initPage() {
        layui.use(['form', 'laydate', 'table', 'element', 'soulTable', 'eleTree','treeTable'], function () {
            ...
            if(fla){
                $.ajax({
                    url:"/workflow/qualityManager/selectByRunId",
                    data:param,
                    dataType:"json",
                ...
                layer.open({
                    ...
                    success: function () {
                        ...
                        insTb=treeTable.render({
                            elem: '#demoTreeTb',
                            url: '/workflow/securityManager/getRegionByProject',
                            where:searchObj,
                            tree: {
    ...
    function drawingImg(_this){
        ...
        $.popWindow("/workflow/securityManager/selectDrawing?type=manage&"+url);
    }
