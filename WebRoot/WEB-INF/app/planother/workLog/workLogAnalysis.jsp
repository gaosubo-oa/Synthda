      ...
      /*  .yester_Table, .yester_Table .layui-table-cell,.yester_Table .layui-table-box,.yester_Table .layui-table-body {
       ...
       /* .openFile input[type=file]{
        ...
        /* endregion */
         ...
         [data-field="scheduleBeginDate"] div,
         [data-field="scheduleEndDate"] div,
         [data-field="scheduleUserName"] div,
         [data-field="recordBeginDate"] div,
         [data-field="recordDate"] div,
         [data-field="currentComplete"] div,
         [data-field="percentComplete"] div,
         [data-field="isComplet"] div
         {
             min-width: 90px;
            /*width: 90px;*/
            padding: 0;
...
<div class="mbox" <%--style="padding-bottom: 100px;"--%>>
    <form class="layui-form" lay-filter="formTest">
        <div class="layui-collapse" lay-filter="test">
            ...
            <div class="layui-colla-item">
                <h2 class="yl_1" style="font-size: 14px;padding: 10px 10px;">
                    今日总结
                </h2>
                    ...
                    <div class="layui-card-body" style="padding-left: 6px;">
                        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief"  style="width: 100%">
                            <ul class="layui-tab-title"  style="width: 100%">
                                <li class="layui-this">进度报告</li>
                                <li class="yl_2">昨日计划今日完成</li>
                                <li class="yl_3">今日其他工作</li>
                                <li class="yl_4">明日工作安排</li>
                            </ul>
...
<%--                                    <table class="layui-table" lay-skin="line" id="speedProgress" style="width:500px" lay-filter="speedProgress"></table>--%>
                                    <table class="layui-table" id="speedProgress" lay-filter="speedProgress" cellspacing="0" cellpadding="0">
                                        <thead>
...
<script type="text/javascript">
    ...
    layui.use(['laydate','table','layer','form','eleTree','element','treeTable'], function () {
            ...
            $.ajax({
                ...
                success:function(res){
                    if(res.code===0||res.code==="0"){
                        ...
                        initScheduleTable(workPlan.fillingDate,workPlan.createUser);
        ...
        if(type == "detail"){ //查看工作日志
            ...
            //         // {type: 'radio'},
            //         {type: 'numbers'},
            //         {field: 'documentNo', title: '编号', minWidth: 150,sort: true, hide: false},
            //         // {field:'companySort',title:'排序号',minWidth: 100,sort:true,hide:false},
            //         {field: 'scheduleName', title: '任务名称', minWidth: 100,sort: true, hide: false},
            //         {field:'scheduleBeginDate',title:'计划开始时间',minWidth: 130,sort:true,hide:false},
            ...
            //         {field:'beforeSchedule',title:'紧前工序',minWidth: 110,sort:false,hide:false,templet: function (d) {
            ...
            //         //     }
            //         // }},
            //         {field: 'scheduleUserName', title: '责任人',minWidth: 120, sort: true, hide: false},
            //         {field: 'recordDate', title: '进度开始时间*',minWidth: 120,templet: function (d) {
            ...
            //         }},
            //         {field: 'recordDate', title: '进度日期*',minWidth: 120,templet: function (d) {
            ...
            //         }},
            //         {field: 'recordProgress', title: '进展情况',minWidth: 120,templet: function (d) {
            //             var _disabled = (d.dataForm&&d.dataForm==2)||(d.record&&d.record.isComplete&&d.record.isComplete==1)
            ...
            //         }},
            //         {field: 'percentComplete', title: '完成百分比*',minWidth: 120,templet: function (d) {
            ...
            //                     '<option value="25" '+(percentComplete=='25'?'selected':'')+'>25</option>' +
            //                     '<option value="50" '+(percentComplete=='50'?'selected':'')+'>50</option>' +
            //                     '<option value="75" '+(percentComplete=='75'?'selected':'')+'>75</option>' +
            ...
            //
            //         }},
            //         {field: 'isComplete', title: '实际进度状态',minWidth: 140, sort: true, hide: false,templet: function (d) {
            ...
            //             }
            //         }},
            //         {field: 'createUserName', title: '填报人',minWidth: 130, sort: false, hide: false}
            //     ]],
            //     // request: {
            ...
            //         //     }},
            //         {field: 'scheduleUserName', title: '责任人',minWidth: 120, sort: true, hide: false},
            //         {field: 'recordBeginDate', title: '进度开始时间*',minWidth: 120,templet: function (d) {
            //             return '<input type="text" name="recordBeginDate" onfocus="clickdata(this)" class="layui-input" '+(d.record&&((d.record.isComplete&&d.record.isComplete==1)||d.record.recordBeginDate)?'disabled':'')+' style="height: 100%;'+(d.record&&((d.record.isComplete&&d.record.isComplete==1)||d.record.recordBeginDate)?"background: #e7e7e7":"")+'" value="' + (d.record&&d.record.recordBeginDate||'') + '">'
            //         }},
            //         {field: 'recordDate', title: '进度日期*',minWidth: 120,templet: function (d) {
            //                 var _disabled = (d.dataForm&&d.dataForm==2)||(d.record&&d.record.isComplete&&d.record.isComplete==1)
        ...
        function initScheduleTable(serchData,serchUserId){
            var loadIndex = layer.load();

            var params = {
                serchDate: serchData,
                createUser: serchUserId
            }
            $.ajax({
                url:'/procedureSchedule/recordAnalysis',
                type: 'post',
                data:params,
                dataType: 'json',
                // async:false,
                success:function(res){
                   ...
                   var tarbarObj = res.obj
                    if(!tarbarObj){
                        table.init('speedProgress', { //转化静态表格
                            url:'',
                            data:[],
                            height: 'full-350',
                            limit:10000000,
                        ...
                        var speedProgressData = res.data

                        $('#speedProgress thead').empty()
                        ...
                        var trOne = '<tr>' + _str +
                            '<th lay-data="{field:\'scheduleBeginDate\',align:\'center\',minWidth:90}">计划开始时间</th>' +
                            '<th lay-data="{field:\'scheduleEndDate\',align:\'center\',minWidth:90}">计划完成时间</th>' +
                            '<th lay-data="{field:\'scheduleUserName\',align:\'center\',minWidth:90}">责任人</th>' +
                            '<th lay-data="{field:\'recordBeginDate\',align:\'center\',minWidth:90}">进度开始时间</th>' +
                            '<th lay-data="{field:\'recordDate\',align:\'center\',minWidth:90}">进展日期</th>' +
                            '<th lay-data="{field:\'recordProgress\',align:\'center\',minWidth:160}">进展情况</th>' +
                            '<th lay-data="{field:\'currentComplete\',align:\'center\',minWidth:90}">当期百分比</th>' +
                            '<th lay-data="{field:\'percentComplete\',align:\'center\',minWidth:90}">完成百分比</th>' +
                            '<th lay-data="{field:\'isComplete\',align:\'center\',minWidth:90}">当前进展状态</th>' +
                            '</tr>'

                        $('#speedProgress thead').append(trOne)

                        table.init('speedProgress', { //转化静态表格
                            //url:'/PtyMemberEvaluation/selectPmedByCPId?evaluationPartyId='+1+'&evaluationId='+2,
                            data:speedProgressData,
        ...
        // function initScheduleTable(serchData,serchUserId){
        //     speedProgressTable = layui.table.render({
        //         elem: '#speedProgress',
        //         url: '/procedureSchedule/recordAnalysis',//数据接口
        //         page:false,
        //         limit:100000000,
        //         where: {
        //             serchDate: serchData,
        ...
        //             // {type: 'radio'},
        //             {type: 'numbers'},
        //             {field: 'documentNo', title: '编号', minWidth: 50,sort: false, hide: false, templet: function (d) {
        //                     return '<input type="text" name="documentNo" readonly class="layui-input tips required" names="编号" style="height: 100%;background: #e7e7e7" value="' + (d.documentNo || '') + '">'
        //                 }},
        //             // {field:'companySort',title:'排序号',minWidth: 100,sort:true,hide:false},
        //             {field: 'longName', title: '任务名称', minWidth: 200,sort: false, hide: false, templet: function (d) {
        //                     return '<input type="text" name="longName" readonly class="layui-input tips required" names="任务名称" style="height: 100%;background: #e7e7e7" value="' + (d.longName || '') + '">'
        //                 }},
        //             {field:'scheduleBeginDate',title:'计划开始时间',minWidth: 130,sort:false,hide:false},
        //             {field: 'scheduleEndDate', title: '计划完成时间', minWidth: 130,sort: false, hide: false},
        //             {field: 'scheduleDuration', title: '持续时间',minWidth: 110, sort: false, hide: false},
        //             {field:'beforeSchedule',title:'紧前工序',minWidth: 110,sort:false,hide:false,templet: function (d) {
        //                     return '<span>'+(d.beforeSchedule&&d.beforeSchedule.scheduleName||'')+'</span>'
        //                 }},
        //             {field: 'scheduleUserName', title: '责任人',minWidth: 120, sort: false, hide: false},
        //             {field: 'recordBeginDate', title: '进度开始时间',minWidth: 120,templet: function (d) {
        //                     return '<input type="text" name="recordBeginDate" onfocus="clickdata(this)" class="layui-input" '+(true?'disabled':'')+' style="height: 100%;'+(d.record&&((d.record.isComplete&&d.record.isComplete==1)||d.record.recordBeginDate)?"background: #e7e7e7":"")+'" value="' + (d.record&&d.record.recordBeginDate||'') + '">'
        //                 }},
        //             {field: 'recordDate', title: '进度日期',minWidth: 120,templet: function (d) {
        //                     return '<input type="text" scheduleId="'+(d.scheduleId||'')+'" name="recordDate" onfocus="clickdata(this)" class="layui-input" '+(true?'disabled':'')+' style="height: 100%;'+(true?"background: #e7e7e7":"")+'" value="' + (d.record&&d.record.recordDate||'') + '">'
        //                 }},
        //             {field: 'recordProgress', title: '进展情况',minWidth: 120, templet: function (d) {
        //                     return '<input type="text" name="recordProgress" readonly class="layui-input tips required" names="编号" style="height: 100%;background: #e7e7e7" value="' + (d.record.recordProgress || '') + '">'
        //                 }},
        //             {field: 'currentComplete', title: '当期百分比',minWidth: 120,templet: function (d) {
        //                     return d&&d.record&&d.record.currentComplete||""
        //                 }},
        //             {field: 'percentComplete', title: '完成百分比',minWidth: 120,templet: function (d) {
        //                     return d.record.percentComplete
        //                 }},
        //             {field: 'isComplete', title: '实际进度状态',minWidth: 140, sort: false, hide: false,templet: function (d) {
        //                     if(d.record&&d.record.isComplete){
        //                         if(d.record.isComplete==0){
        //                             return '<span>未完成</span>'
        //                         }else if(d.record.isComplete==1){
        ...
        //                     }
        //                 }},
        //             {field: 'createUserName', title: '填报人',minWidth: 130, sort: false, hide: false,templet: function (d) {
        //                     return d.record.createUserName
        //                 }}
        //         ]],
        //         done: function (res, curr, count) {
