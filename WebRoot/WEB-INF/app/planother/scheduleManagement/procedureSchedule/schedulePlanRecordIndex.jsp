...
<div class="container">
	...
	<div class="wrapper">
		<div class="wrap_left">
			<h2 style="text-align: center;line-height: 35px;">进度分解实际填报</h2>
			<div class="left_form">
					...
					$trs.parents('tr').each(function (index) {
						...
						if(flay){
							layer.confirm('是否确认完成？', function (index) {
								...
								$.ajax({
									url: '/procedureSchedule/insert?isclose=true&&isDecompose=isDecompose',
								...
								var loadIndex = layer.load();
								$.ajax({
									url: '/procedureSchedule/insert?isDecompose=isDecompose',
									data: JSON.stringify(dataArr),
									dataType: 'json',
									contentType: "application/json;charset=UTF-8",
									type: 'post',
		...
		function newOrEdit(type, data) {
			...
			layer.open({
				...
				'           </div>' ,
                    ...
                    '               <div class="layui-col-xs3" style="padding: 0 5px;">' +
                    '                   <div class="layui-form-item">\n' +
                    '                       <label class="layui-form-label form_label">进展情况</label>\n' +
                    '                       <div class="layui-input-block form_block">\n' +
                    ...
                    '                       <div class="layui-input-block form_block">\n' +
					'							<select name="percentComplete" id="percentComplete">' +
					'                               <option value="">请选择</option>' +
					...
					'							</select>\n' +
                    // '                       <input type="number" name="percentComplete" id="percentComplete"  autocomplete="off" class="layui-input">\n' +
                    '                       </div>\n' +
                    '                   </div>' +
                    '               </div>' +
                    '       </div>',
