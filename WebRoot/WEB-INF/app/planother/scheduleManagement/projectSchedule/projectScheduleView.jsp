...
<script>
	...
	'               <div class="layui-col-xs4" style="padding: 0 5px;">' +
	'                   <div class="layui-form-item">\n' +
	'                       <label class="layui-form-label form_label">公司级节点名称</label>\n' +
	'                       <div class="layui-input-block form_block">\n' +
	...
	'           </div>' ,
		...
		'               <div class="layui-col-xs4" style="padding: 0 5px;">' +
		'                   <div class="layui-form-item">\n' +
		'                       <label class="layui-form-label form_label">公司级节点计划完成时间<!--<span field="punishmentDate" class="field_required">*</span>--></label>\n' +
		'                       <div class="layui-input-block form_block">\n' +
		...
		'               <div class="layui-col-xs4" style="padding: 0 5px;">' +
		'                   <div class="layui-form-item">\n' +
		'                       <label class="layui-form-label form_label">项目级节点名称<!--<span field="punishmentDate" class="field_required">*</span>--></label>\n' +
		'                       <div class="layui-input-block form_block">\n' +
		'                       <input type="text" name="punishmentDate" id="punishmentDate" autocomplete="off" class="layui-input" >\n' +
		'                       </div>\n' +
		'                   </div>' +
		...
		'               <div class="layui-col-xs4" style="padding: 0 5px;">' +
		'                   <div class="layui-form-item">\n' +
		'                       <label class="layui-form-label form_label">计划开始时间<!--<span field="punishmentDate" class="field_required">*</span>--></label>\n' +
		'                       <div class="layui-input-block form_block">\n' +
		'                       <input type="text" name="punishmentDate" id="punishmentDate" autocomplete="off" class="layui-input" >\n' +
		'                       </div>\n' +
		'                   </div>' +
