...
<div class="container">
	...
	<div class="wrapper">
		<div class="wrap_left">
			<h2 style="text-align: center;line-height: 35px;">技术分析</h2>
			<div class="left_form">
				...
				<div class="table_box layui-form" style="display: none">
					<div class="layui-row">
						<div class="layui-col-xs12" style="padding: 0 5px;">
							<h3 style="line-height: 50px;">技术方案编制总计划</h3>
...
<script>
	...
	layui.use(['form', 'laydate', 'table', 'element', 'eleTree', 'layer','soulTable'], function () {
		...
		var dictionaryStr = 'IMPORTANCE_LEVEL,SCHEME_TYPE';
		...
		if(showProj){
			...
			$.get('/technologyReport/technologySchemeAnalysis', para_ms, function (res) {
		...
		eleTree.on("nodeClick(leftTree)", function (d) {
			...
			if (currentData.projId) {
				...
				$('#h2_title').text(currentData.projName+'项目技术方案编制情况综合分析')
				$('.no_data').hide();
				$('.table_box').show();
		...
		function tableShow(data) {
			...
			if(showProj){
				$('#h2_title').text(((data&&data.projectName)||'')+'项目技术方案编制情况综合分析')
			}
			...
			var cols2 = [
				{type: 'numbers', title: '序号'},
				{field: 'technicalName', title: '方案名称', minWidth: 150},
				{field: 'schemeSummary', title: '方案描述', minWidth: 160},
			...
			if(data&&data.serchBeginDate&&data&&data.serchEndDate){
				var params = {
				...
				//本月编制报监技术方案
				// params.schemeType = '01'
				$.get('/technologyScheme/select', params, function (res) {
					table.render({
						elem: '#tableDemo2',
						data: res&&res.data||[],
						defaultToolbar: ['filter'],
