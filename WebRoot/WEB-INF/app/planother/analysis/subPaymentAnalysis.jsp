...
<div class="container">
	...
	<div class="wrapper">
		<div class="wrap_left">
			<h2 style="text-align: center;line-height: 35px;">分包付款台账</h2>
			<div class="left_form">
		...
		function tableShow(projId) {
			tableIns = table.render({
				...
				cols:  [[ //表头
					...
					, {field: 'participatePersion', title: '申请付款日期',minWidth: 120, sort: true, hide: false}
					, {field: 'activityDate', title: '付款节点',minWidth: 120, sort: true, hide: false}
					, {field: 'activityPlace', title: '本次付款金额',minWidth: 120, sort: true, hide: false}
				]],
