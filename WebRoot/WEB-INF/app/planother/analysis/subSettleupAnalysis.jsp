...
<div class="container">
	...
	<div class="wrapper">
		<div class="wrap_left">
			<h2 style="text-align: center;line-height: 35px;">分包结算台账</h2>
			<div class="left_form">
	...
	layui.use(['form', 'laydate', 'table', 'element', 'eleTree', 'layer','soulTable'], function () {
		...
		function tableShow(projId) {
			tableIns = table.render({
				...
				cols:  [[ //表头
					{field: 'activityPlace', title: '行号',minWidth: 120, sort: true, hide: false}
					, {field:'projectName',title:'项目名称',minWidth: 120,sort:true,hide:false}
					, {field: 'activityName', title: '合同名称', minWidth: 120,sort: true, hide: false}
					, {field: 'participatePersion', title: '合同编号',minWidth: 120, sort: true, hide: false}
					, {field: 'activityPlace', title: '分包商名称',minWidth: 120, sort: true, hide: false}
					, {field: 'participatePersion', title: '结算日期',minWidth: 120, sort: true, hide: false}
					, {field: 'activityDate', title: '合同金额（元）',minWidth: 120, sort: true, hide: false}
					, {field: 'activityDate', title: '累计已结算金额',minWidth: 120, sort: true, hide: false}
					, {field: 'activityPlace', title: '本次结算金额',minWidth: 120, sort: true, hide: false}
				]],
