...
<div class="container">
	...
	<div class="wrapper">
		<div class="wrap_left">
			<h3 style="text-align: center;line-height: 35px;">材料资源使用明细分析汇总</h3>
			<div class="left_form">
	...
	layui.use(['form', 'laydate', 'table', 'element', 'eleTree', 'layer','soulTable'], function () {
		...
		function tableShow(projId) {
			tableIns = table.render({
				elem: '#tableDemo',
				url: '/mtlAnalysis/mtlUseDetailData',
				cols:  [[ //表头
					...
					, {field: 'itemUnit', title: '单位',minWidth: 100, sort: true, hide: false}
					, {field: 'controlType', title: '控制方式',minWidth: 120, sort: true, hide: false}
					...
					, {field: 'budgetPlanSum', title: '已提需用计划量',minWidth: 120, sort: true, hide: false}
					, {field: 'mtlName', title: '物料名称',minWidth: 120, sort: true, hide: false}
					, {field: 'mtlStand', title: '规格',minWidth: 120, sort: true, hide: false}
					, {field: 'thisAmount', title: '已提需用计划量',minWidth: 120, sort: true, hide: false}
					, {field: 'purchaseQuantity', title: '已提采购订单量',minWidth: 120, sort: true, hide: false}
					, {field: 'mtlInQuantity', title: '累计入库量',minWidth: 120, sort: true, hide: false}
					, {field: 'mtlInMoney', title: '累计入库金额',minWidth: 120, sort: true, hide: false}
					, {field: 'stockOutNum', title: '累计出库量',minWidth: 120, sort: true, hide: false}
					, {field: 'stockOutAnount', title: '累计出库金额',minWidth: 120, sort: true, hide: false}
					, {field: 'stockInQuantity', title: '库存量',minWidth: 120, sort: true, hide: false}
				]],
