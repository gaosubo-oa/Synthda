...
<div class="container">
	...
	<div class="wrapper">
		<div class="wrap_left">
			<h2 style="text-align: center;line-height: 35px;">安全隐患分析报表</h2>
			<div class="left_form">
		...
		<div class="wrap_right">
			<div class="query_module layui-form layui-row" style="position: relative">
				<div class="layui-col-xs2">
					<input type="text" name="securityKnowledgeName" placeholder="隐患项" autocomplete="off" class="layui-input">
				</div>
		...
		function tableShow(projId) {
			tableIns = table.render({
				...
				cols: [[ //表头
					...
					, {field: 'securityDanger', title: '检查次数'}
					, {field: 'securityDangerMeasures', title: '隐患次数'}
					, {field: 'securityDanger', title: '隐患占比'}
					, {field: 'securityDangerMeasures', title: '一般隐患次数'}
					, {field: 'securityDanger', title: '重大隐患次数'}
					, {field: 'securityDangerMeasures', title: '重大隐患占比'}
				]],
