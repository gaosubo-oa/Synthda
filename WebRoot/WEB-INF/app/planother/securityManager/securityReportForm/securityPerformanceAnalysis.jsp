...
<div class="container">
	...
	<div class="wrapper">
		<div class="wrap_left">
			<h3 style="text-align: center;line-height: 35px;">安全检查、整改分析报表</h3>
			<div class="left_form">
		...
		table.on('toolbar(docDemoTabBrief)', function (obj) {
			switch (obj.event) {
				case 'export'://导出
					...
					window.location.href='/securityAnalysis/performanceAnalysis?export=export'+str
					break;
			}
		});
		table.on('toolbar(docDemoTabBrief2', function (obj) {
			switch (obj.event) {
				case 'export'://导出
					...
					window.location.href='/securityAnalysis/rectificationAnalysis?export=export'+str
					break;
			}
		});
