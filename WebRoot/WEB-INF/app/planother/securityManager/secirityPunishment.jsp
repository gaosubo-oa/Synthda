...
<div class="container">
	...
	<div class="wrapper">
		<div class="wrap_left">
			<h2 style="text-align: center;line-height: 35px;">安全罚款</h2>
			<div class="left_form">
...
<script type="text/html" id="toolbarDemo">
	<div class="layui-btn-container" style="height: 30px;">
		...
		<button class="layui-btn layui-btn-sm" lay-event="dayin">安全处罚单</button>
	</div>
...
<script>
	...
	layui.use(['form', 'laydate', 'table', 'element', 'eleTree', 'layer','soulTable'], function () {
			...
			switch (obj.event) {
				...
				case 'del':
					...
					layer.confirm('确定删除该条数据吗？', function (index) {
						$.post('/workflow/punishment/del', {ids: securityPunishmentId}, function (res) {
							if (res.code=='0') {
				...
				case 'submit':
					...
					layer.open({
						...
						success: function () {
							$.get('/plbFlowSetting/getOwnFlowData', {plbDictNo: '60'}, function (res) {
								var flowData = []
		...
		function newOrEdit(type, data) {
			...
			if (type == '0') {
				title = '新建';
				url = '/workflow/punishment/insert';
			} else if (type == '1') {
				title = '编辑';
				url = '/workflow/punishment/updateById';
			}else if(type == '4'){
