                                    ...
                                    <form class="layui-form" action="" style="height: 40px">
                                        <div class="query_module layui-form layui-row" style="position: relative">
                                            <div class="layui-col-xs2">
                                                <input type="text" name="securityDanger" placeholder="隐患标准" autocomplete="off" class="layui-input">
                                            </div>
                                            <div class="layui-col-xs2" style="margin-left: 15px;">
                                                <input type="text" name="securityDangerMeasures" placeholder="整改措施" autocomplete="off" class="layui-input">
                                            </div>
...
<script type="text/javascript">
    ...
    console.log(urlType);
    var toolbar;
    if(urlType=='addImplementationPlanning'||urlType=='securityCheck'){
        toolbar = ''
    }else {
        toolbar = '#toolbar'
    }
            ...
            if(tableType!=undefined&&tableType=="radio"){
                ...
                SettlementTable = layui.table.render({
                    ...
                    , cols: [[ //表头
                        ...
                        , {field: 'securityDanger',title: '隐患标准', templet: function (d) {
                ...
                case 'upfile': //上传附件
                    ...
                    var index = layer.open({
                        ...
                        content: '<div class="layui-form" id="boxfo">' +
                            ...
                            '<div class="inbox"><label class="layui-form-label" style="width: 100px;">整改措施</label><div class="layui-input-block" style="margin-left: 130px;">' +
