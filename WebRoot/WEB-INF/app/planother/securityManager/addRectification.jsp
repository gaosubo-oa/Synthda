...
<script type="text/javascript">
	...
	var _url = '/workflow/rectification/getById?runId='
	var _url2 = '/workflow/rectification/getById?kayId='
	if(urlType == 'acceptance'){
		_url = '/workflow/acceptanceManager/getById?runId='
		_url2 = '/workflow/acceptanceManager/getById?kayId='
	}
	...
	var transposition = /* region 安全整改 */
			'<div class="layui-colla-item"><h2 class="layui-colla-title">安全整改</h2>' +
	...
	var _htm = '<div class="layer_wrap _disabled"><div class="layui-collapse">' +
		...
		'<div class="layui-col-xs2 layui-col-20" style="padding: 0 10px">' +
		'<div class="layui-form-item">' +
		'<label class="layui-form-label form_label">隐患级别</label>' +
		'<div class="layui-input-block form_block">' +
		...
		/* endregion */
		/* region 安全验收 */
		'<div class="layui-colla-item" id="acceptance1" style="display: none"><h2 class="layui-colla-title">安全验收</h2>' +
	...
	function childFunc(state) {
		var obj={}
		var url = '/workflow/rectification/updateById'
