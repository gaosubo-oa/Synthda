...
<div class="container">
    ...
    <div class="wrapper">
        <div class="wrap_left">
            <h2 style="text-align: center;line-height: 35px;">安全检查项</h2>
            <div class="left_form">
            ...
            switch (obj.event) {
                ...
                case 'edit':
                    ...
                    if($('#leftId').attr('projId')){
                        ...
                        $.post('/securityTerm/getById', {kayId: securityTermId}, function (res) {
                            newOrEdit(1,res.obj)
                ...
                case 'del':
                    ...
                    layer.confirm('确定删除该条数据吗？', function (index) {
                        $.post('/securityTerm/del', {ids: securityTermId}, function (res) {
                            if (res.code=='0') {
            ...
            layer.open({
                ...
                success: function () {
                    ...
                    if (type == 1 || type == 4) {
                        ...
                        //$("[name='checkFrequency']").val(data.checkFrequency||"");
                        //附件
                        ...
                        // 获取自动编号
                        getAutoNumber({autoNumberType: 'securityTerm'}, function(res) {
                ...
                yes: function (index) {
                    if(type!='4'){
                        ...
                        obj.detailList = planningDetailsData().scheduleData;
        ...
        table.on('tool(detailedTable)', function (obj) {
            ...
            if (layEvent === 'del') {
                if (data.securityTermDetailId) {
                    $.get('/securityTerm/delDetails', {ids: data.securityTermDetailId}, function (res) {
                        if (res.flag) {
