    ...
    layui.use(['table','layer','form','element','eleTree','laydate','upload'], function(){
        ...
        function newOrEdit(type, data) {
            ...
            layer.open({
                ...
                area: ['90%', '80%'],
                maxmin: true,
                content: '/workflow/secirityManager/toStandard?type=checkbox',
                success: function () {
                        ...
                        $("[name='ttitle3']").on("click",function (e) {
                            ...
                            if(standTypeId==undefined||standTypeId==""){
                                ...
                                layer.open({
                                    ...
                                    maxmin: true,
                                    btn: ['提交', '取消'],
                                    content: '/workflow/secirityManager/toStandard?type=checkTemplte&knowTypeIds='+standTypeId,
                                    success: function () {
                ...
                if(datas.length!=1){
                    ...
                    layer.open({
                        ...
                        content: '<div class="layui-form">' +
                            ...
                            '</div>' +
                            '<div class="inbox" style="margin: 27px 31px 10px -2px;">' +
                            '<label class="layui-form-label"><span style="color: red">*</span>隐患级别</label>' +
                            '<div class="layui-input-block">' +
                        ...
                        success: function () {
                            ...
                            $("#securityDangerGrade").val(checkDate.securityDangerGrade)//隐患级别
                            //渲染项目名称
                            // var $select2 = $("#aqProjName");
                            // var optionStr2 = '<option value="">请选择</option>';
                            // $.ajax({ //查询文档等级
...
*/
                        ...
                        yes: function (index, layero) {
                            ...
                            var securityDangerGrade =  $("#securityDangerGrade").val()//隐患级别
