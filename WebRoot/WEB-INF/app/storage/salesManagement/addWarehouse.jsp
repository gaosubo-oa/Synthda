...
<div class="head_title">
    <div class="title">
        <img src="/img/commonTheme/${sessionScope.InterfaceModel}/flow_run_title.png"><span >仓库管理</span>
    </div>
</div>
<div>
    <div class="container-fluid">
        <div>
            <input  placeholder="请输入仓库名称" type="text" id="keyWords" style="border-radius: 10px;margin-bottom: 10px;"/>
        </div>
            ...
            success:function(json){
                ...
                for(var i=0;i<json.obj.length;i++){
                    str+='<div  class="media-body" style="width: 100%">' +
                        ...
                        '<h4 id="warehouseNo">'+json.obj[i].warehouseNo+'</h4>' +
                        '<h4 id="warehouseId" hidden="true">'+json.obj[i].warehouseId+'</h4>' +
                        '仓库编号:<span>'+json.obj[i].warehouseNo+'</span><br/>' +
                        '仓库负责人:<span>'+json.obj[i].warehousePerson+'</sapn><br/>' +
                        '仓库名称:<span  id="warehouseName">'+json.obj[i].warehouseName+'</span><br/>' +
                        '联系电话:<span>'+json.obj[i].warehousePhone+'</span><br/>' +
                        '仓库地址:<span>'+json.obj[i].warehouseAdress+'</span><br/>' +
                        '</div>' +
                ...
                $('.media-body').on('click',function() {
                    ...
                    $('.saveBtn').on('click',function () {
                        $('#warehouseName',window.opener.document).val(warehouseName);
                        $('#warehouseId',window.opener.document).val(warehouseId);
                        window.close();
                        // window.opener.document.getElementById("warehouseName").setAttribute('value',warehouseName)
                        // window.opener.document.getElementById("warehouseId").setAttribute('value',warehouseId)
                        // window.close();
                    })
                })
