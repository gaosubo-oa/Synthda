...
<div class="mbox">
        ...
        <form class="layui-form" action="" id="ajaxform">
            ...
            <div class="layui-form-item">
                <div class="layui-inline share">
                    ...
                    <button type="button" id="button01" style="position: absolute;" class="layui-btn layui-btn-sm findStock"><i
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline share">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <input type="text" class="layui-input" id="outTime" autocomplete="off" name="shipmentDate">
                    </div>
                </div>
            </div>
            <%--第三个--%>
            <div class="layui-form-item">
                <div class="layui-inline share">
                    <label class="layui-form-label"><span style="color: red;">*</span>出货数量</label>
                    <div class="layui-input-inline">
                        <input type="text" name="shipmentNum" lay-verify="url" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline share">
                    <label class="layui-form-label"><span style="color: red;">*</span>销售单价</label>
                    <div class="layui-input-inline">
                        <input type="text" name="shipmentPrice" lay-verify="url" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline share">
                    <label class="layui-form-label">合计</label>
                    <div class="layui-input-inline">
                        <input type="text" name="shipmentTotal" lay-verify="url" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
            <%--第四个--%>
            <div class="layui-form-item">
                <div class="layui-inline share">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="shipmentPaid" lay-verify="url" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline share">
                    <label class="layui-form-label">欠款金额</label>
                    <div class="layui-input-inline">
                        <input type="text" name="shipmentArrears" lay-verify="url" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline share">
            ...
            <div class="layui-form-item">
                <div class="layui-inline share">
                    ...
                    <a style="display: inline-block;margin-top: 10px" id="del_3">选择</a>
                ...
                <div class="layui-inline share">
                    ...
                    <div class="layui-input-inline" >
                        <input type="text" id="enterNum"class="layui-input" readonly="readonly" placeholder="输入商品编码自动显示库存数" style="font-size: 13px">
                    </div>
                </div>
                <div class="layui-inline share">
                    <label class="layui-form-label">备注</label>
                    <div class="layui-input-inline">
                        <input type="text" name="shipmentRemark" lay-verify="url" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
        </form>
    ...
    <script type="text/html" id="toolbarDemo">
        <div class="layui-btn-container">
            ...
            <div class="dropbox" style="display: inline-block;margin-left: 15px;">
                <div class="dropdown">
                    <button type='button' class="layui-btn layui-btn-sm dropbtn" onclick="selectFn(this)"
                            style="width: 85px ;">客户还款<i class="licon"></i></button>
                    <div class="dropdown-content ">
                        <div>
                            <a style="white-space:nowrap;"  id="customerRepayment">客户还款</a>
                        </div>
                        <div style="margin-bottom: 8px">
                            <a style="white-space:nowrap;" id="statistic">客户欠款还款统计</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    layui.use(['table', 'form', 'laydate'], function () {
        ...
        table.on('toolbar(test)', function(obj) {
            ...
            switch (event) {
                case 'add':
                    ...
                    var shipmentNum = $('input[name="shipmentNum"]').val()
                    var shipmentPrice = $('input[name="shipmentPrice"]').val()
                    if (enterCode == '') {
                        layer.msg('请填写商品编码', {icon: 2});
                        return false
                    }
                    if(shipmentDate==''){ layer.msg('请填写出货日期', {icon: 2}); return false}
                    if(customerName==''){ layer.msg('请填写客户', {icon: 2}); return false}
                    if(warehouseName==''){ layer.msg('请填写仓库', {icon: 2}); return false}
                    if(shipmentNum==''){ layer.msg('请填写出货数量', {icon: 2}); return false}
                    if(shipmentPrice==''){ layer.msg('请填写销售单价', {icon: 2}); return false}
                    ...
                    $.ajax({
                        type: 'get',
                        url: '/salesShipment/insertSales?' + $('#ajaxform').serialize()+'&enterId='+ enterides,
                        dataType: 'json',
                        success: function (res) {
                            ...
                            $('input[name="shipmentNum"]').val('')
                            $('input[name="customerName"]').val('')
                            $('input[name="productType"]').val('')
                            $('input[name="shipmentPrice"]').val('')
                            $('input[name="shipmentDate"]').val('')
                            $('input[name="enterName"]').val('')
                            $('input[name="shipmentTotal"]').val('')
                    ...
                    layer.open({
                        ...
                        yes:function (index) {
                            ...
                            if(timeQuery.eq(0).hasClass("layui-form-radioed")){
                                type=1
                                shipmentDateStr=$('#day input[name="dayQuery"]').val()
                            }else if(timeQuery.eq(1).hasClass("layui-form-radioed")){
                                type=2
                                shipmentDateStr=$('#month input[name="monthQuery1"]').val()
                            }else if(timeQuery.eq(2).hasClass("layui-form-radioed")){
                                type=3
                                shipmentDateStr=$('#year input[name="yearQuery"]').val()
                            }
                            ...
                            var productType = $('.chaXun [name="productType"]').val();
                            var enterSpecs = $('.chaXun [name="enterSpecs"]').val();
                            var enterName = $('.chaXun [name="enterName"]').val();
                            var enterCode = $('.chaXun [name="enterCode"]').val();
        ...
        table.on('row(test)', function (obj) {
            ...
            $('input[name="shipmentId"]').val(data.shipmentId)
            $('input[name="enterCode"]').val(data.enterCode)
            $('input[name="enterId"]').val(data.enterId)
            $('input[name="shipmentNum"]').val(data.shipmentNum)
            ...
            $('input[name="shipmentPrice"]').val(data.shipmentPrice)
            $('input[name="shipmentDate"]').val(data.shipmentDate)
            $('input[name="enterName"]').val(data.enterName)
            $('input[name="shipmentTotal"]').val(data.shipmentTotal)
            ...
            $('input[name="shipmentRemark"]').val(data.shipmentRemark)
            var enterCode = $('input[name="enterCode"]').val()
            if(enterCode!=''){
                $.ajax({
                    type: 'post',
        ...
        $('.addPerson').on('click',function () {
            layer.open({
                ...
                content: '<div class="layui-form">' +
                    ...
                    '    <div class="layui-input-block">\n' +
                    '                    <input type="text" name="linkmanName" id="linkmanName" required lay-verify="required" placeholder="请输入联系人姓名"\n' +
                    '                           autocomplete="off" class="layui-input">\n' +
                    '                </div>\n' +
                    '  </div>' +
                    '   <div class="layui-form-item" style="width: 320px;">\n' +
                    ...
                    '    <div class="layui-input-block">\n' +
                    '      <input type="text" id="email" required  lay-verify="required" placeholder="请输入联系人邮箱" autocomplete="off" class="layui-input">\n' +
                    '    </div>\n' +
                    '  </div> <div class="layui-form-item" style="width: 320px;">\n' +
        ...
        $('.addStock').on('click',function () {
            layer.open({
                ...
                content: '<div class="newpop">' +
                    ...
                    '<textarea name="warehouseRemarks" id="warehouseRemarks" style="width: 412px;height: 45px;vertical-align: middle;border-radius: 3px" cols="30" rows="10"></textarea></div>' +
                    '</div>',
                area: ['600px','470px'],
                btn: ['确认', '返回'],
                yes: function () {
                ...
                ,success:function(res){
                    ...
                    var tableInt=table.render({
                        ...
                        ,cols: [[
                            ...
                            ,{field:'enterSpecs', title:'商品规格'}
                            ,{field:'enterCode', title:'商品编码'}
                            ,{field:'enterIndate', title:'进货日期',templet: function(d){
                                    return (d.enterIndate)
                                }}
        ...
        //客户还款
        $('#customerRepayment').on('click',function () {
            $(".dropdown-content").fadeOut()
            window.open('/salesShipment/hkym')

        })
        //客户欠款还款统计
        $('#statistic').on('click',function () {
            $(".dropdown-content").fadeOut()
            window.open('/salesShipment/repayment')
            ...
            if(type==0){
                ...
                if(shipmentId.length=='0'){
                    ...
                    layer.confirm('真的删除当前数据吗？', function (index) {
                        $.ajax({
                            type: 'get',
                            url: '/salesShipment/delOmShipmentById?shipmentId='+shipmentId,
                            dataType: 'json',
                            success: function (res) {
                                if (res.msg == 'true') {
                ...
                $.ajax({
                    type: 'post',
                    url: '/salesShipment/updateOmShipmentById?' + $('#ajaxform').serialize()+'&enterId='+ enterid,
                    dataType: 'json',
                    success: function (res) {
                        if (res.msg == 'true') {
    ...
    //监听出货数量
    $('input[name="shipmentNum"]').on('keyup',function () {
        var shipmentNum = $('input[name="shipmentNum"]').val()
        var shipmentPrice = $('input[name="shipmentPrice"]').val()
        var shipmentTotal = shipmentNum*shipmentPrice
        $('input[name="shipmentTotal"]').val(shipmentTotal)
        var heji=$('input[name="shipmentTotal"]').val()
        var shipmentPaid=$('input[name="shipmentPaid"]').val()
        var shipmentArrears=shipmentTotal-shipmentPaid
        $('input[name="shipmentArrears"]').val(shipmentArrears)
    })
    //监听销售单价
    $('input[name="shipmentPrice"]').on('keyup',function () {
        var shipmentNum = $('input[name="shipmentNum"]').val()
        var shipmentPrice = $('input[name="shipmentPrice"]').val()
        var shipmentTotal = shipmentNum*shipmentPrice
        $('input[name="shipmentTotal"]').val(shipmentTotal)
    ...
    //监听已付金额
    $('input[name="shipmentPaid"]').on('keyup',function () {
        var shipmentTotal=$('input[name="shipmentTotal"]').val()
        var shipmentPaid=$('input[name="shipmentPaid"]').val()
        // var shipmentArrears=shipmentTotal-shipmentPaid
        if(shipmentTotal!='' || shipmentPai!=''){
            $.ajax({
                url: "/salesShipment/jisuan",
                type: 'get',
                data:{
                    shipmentTotal:shipmentTotal,
                    shipmentPaid:shipmentPaid
                },
                dataType: "JSON",
                success: function (data) {
                    $('input[name="shipmentArrears"]').val(data.object)
                }
            })
        }
    ...
    /*function edit(data) {
          layer.open({
              ...
              , content: '<div class="layui-form">' +
                  ...
                  '<label class="layui-form-label">商品大类</label>\n' +
                  '    <div class="layui-input-block">\n' +
                  '<input id="productType" type="text" name="title" required  lay-verify="required" placeholder=" " autocomplete="off" class="layui-input">' +
                  '    </div>\n' +
                  '  </div>' +
                  '<div class="layui-form-item" style="margin-bottom:8px;width:327px">\n' +
                  '    <label class="layui-form-label">商品名称</label>\n' +
                  '    <div class="layui-input-block">\n' +
                  '<input id="enterName" type="text" name="title" required  lay-verify="required" placeholder=" " autocomplete="off" class="layui-input">' +
                  '    </div>\n' +
                  '  </div>' +
                  '</div>' +
                  '<div style="display: flex;margin-left: 30px;margin-top: 8px;"><div class="layui-form-item" style="margin-bottom:8px">\n' +
                  ...
                  '    <div class="layui-input-block">\n' +
                  '<input id="enterSpecs" type="text" name="title" required  lay-verify="required" placeholder=" " autocomplete="off" class="layui-input">' +
                  '    </div>\n' +
                  '  </div>' +
                  '<div class="layui-form-item" style="margin-bottom:8px;width:327px">\n' +
                  '    <label class="layui-form-label">商品编码</label>\n' +
                  '    <div class="layui-input-block">\n' +
                  '<input id="enterCode" type="text" name="title" required  lay-verify="required" placeholder=" " autocomplete="off" class="layui-input">' +
                  '    </div>\n' +
                  '  </div>' +
                  '</div>' +
                  '<div style="display: flex;margin-left: 30px;margin-top: 8px;"><div class="layui-form-item" style="margin-bottom:8px">\n' +
                  ...
                  '    <div class="layui-input-block">\n' +
                  '<input id="shipmentDateStr" type="text" name="title" required  lay-verify="required" placeholder=" " autocomplete="off" class="layui-input">' +
                  '    </div>\n' +
                  '  </div>' +
                  '<div class="layui-form-item" style="margin-bottom:8px;width:327px">\n' +
                  '    <label class="layui-form-label">出货数量</label>\n' +
                  '    <div class="layui-input-block">\n' +
                  '<input id="shipmentNum" type="text" name="title" required  lay-verify="required" placeholder=" " autocomplete="off" class="layui-input">' +
                  '    </div>\n' +
                  '  </div>' +
                  '</div>' +
                  '<div style="display: flex;margin-left: 30px;margin-top: 8px;"><div class="layui-form-item" style="margin-bottom:8px">\n' +
                  ...
                  '    <div class="layui-input-block">\n' +
                  '<input id="shipmentPrice" type="text" name="title" required  lay-verify="required" placeholder=" " autocomplete="off" class="layui-input">' +
                  '    </div>\n' +
                  '  </div>' +
                  '<div class="layui-form-item" style="margin-bottom:8px;width:327px">\n' +
                  '    <label class="layui-form-label">合计</label>\n' +
                  '    <div class="layui-input-block">\n' +
                  '<input id="shipmentTotal" type="text" name="title" required  lay-verify="required" placeholder=" " autocomplete="off" class="layui-input">' +
                  '    </div>\n' +
                  '  </div>' +
                  '</div>' +
                  '<div style="display: flex;margin-left: 30px;margin-top: 8px;"><div class="layui-form-item" style="margin-bottom:8px">\n' +
                  '<label class="layui-form-label">已付金额</label>\n' +
                  '    <div class="layui-input-block">\n' +
                  '<input id="shipmentPaid" type="text" name="title" required  lay-verify="required" placeholder=" " autocomplete="off" class="layui-input">' +
                  '    </div>\n' +
                  '  </div>' +
                  '<div class="layui-form-item" style="margin-bottom:8px;width:327px">\n' +
                  '    <label class="layui-form-label">欠款金额</label>\n' +
                  '    <div class="layui-input-block">\n' +
                  '<input id="shipmentArrears" type="text" name="title" required  lay-verify="required" placeholder=" " autocomplete="off" class="layui-input">' +
                  '    </div>\n' +
                  '  </div>' +
                  '</div>' +
                  '<div style="display: flex;margin-left: 30px;margin-top: 8px;"><div class="layui-form-item" style="margin-bottom:8px">\n' +
                  '<label class="layui-form-label">客户</label>\n' +
                  '    <div class="layui-input-block">\n' +
                  '<input  id="customerName" type="text" name="title" required  lay-verify="required" placeholder=" " autocomplete="off" class="layui-input">' +
                  '    </div>\n' +
                  '  </div>' +
                  '<div class="layui-form-item" style="margin-bottom:8px;width:327px">\n' +
                  '    <label class="layui-form-label">出货人</label>\n' +
                  '    <div class="layui-input-block">\n' +
                  '<input id="shipper" type="text" name="title" required  lay-verify="required" placeholder=" " autocomplete="off" class="layui-input">' +
                  '    </div>\n' +
                  '  </div>' +
                  '</div>' +
                  '<div style="display: flex;margin-left: 30px;margin-top: 8px;"><div class="layui-form-item" style="margin-bottom:8px">\n' +
                  '<label class="layui-form-label">仓库</label>\n' +
                  '    <div class="layui-input-block">\n' +
                  ' <input type="text" name="warehouseName" id="warehouseName" class="warehouseName" readonly="readonly" lay-verify="url"\n' +
                  '                               autocomplete="off" class="layui-input">\n' +
                  '                        &nbsp;&nbsp; <a href="../salesShipment/wareHouse?i=1" target="_blank">选择</a>&nbsp;&nbsp; <a\n' +
                  '                            id="del_2">清空</a><input type="hidden" name="warehouseId" id="warehouseId">' +
                  '    </div>\n' +
                  '  </div>' +
                  '<div class="layui-form-item" style="margin-bottom:8px;width:327px">\n' +
                  '    <label class="layui-form-label">单据号</label>\n' +
                  '    <div class="layui-input-block">\n' +
                  '<input id="documentNo"  type="text" name="title" required  lay-verify="required" placeholder=" " autocomplete="off" class="layui-input">' +
                  '    </div>\n' +
                  '  </div>' +
                  '</div>' +
                  '<div class="layui-form-item layui-form-text" style="width: 657px;margin-left:27px">\n' +
                  '    <label class="layui-form-label">备注</label>\n' +
                  '    <div class="layui-input-block">\n' +
                  '      <textarea id="shipmentRemark" name="desc" placeholder=" " class="layui-textarea"></textarea>\n' +
                  '    </div>\n' +
                  '  </div>' +
                  '<div class="layui-form-item">\n' +
                  '  </div>' +
              ...
              , success: function (res) {
                  ...
                  $("#enterSpecs").val(result.enterSpecs);
                  $("#enterCode").val(result.enterCode);
                  $("#shipmentDateStr").val(result.shipmentDateStr);
                  $("#shipmentNum").val(result.shipmentNum);
                  $("#shipmentPrice").val(result.shipmentPrice);
                  $("#shipmentTotal").val(result.shipmentTotal);
                  $("#shipmentPaid").val(result.shipmentPaid);
                  $("#shipmentArrears").val(result.shipmentArrears);
                  $("#customerName").val(result.customerName);
                  $("#shipper").val(result.shipper);
                  $(".warehouseName").val(result.warehouseName);
                  $("#documentNo").val(result.documentNo);
                  $("#shipmentRemark").val(result.shipmentRemark);

              }
              , yes: function (index) {
                  var productType = document.getElementById("productType").value
                  var enterName = document.getElementById("enterName").value
                  var enterSpecs = document.getElementById("enterSpecs").value
                  var enterCode = document.getElementById("enterCode").value
                  var shipmentDateStr = document.getElementById("shipmentDateStr").value
                  var shipmentNum = document.getElementById("shipmentNum").value
                  var shipmentPrice = document.getElementById("shipmentPrice").value
                  var shipmentTotal = document.getElementById("shipmentTotal").value
                  var shipmentPaid = document.getElementById("shipmentPaid").value
                  var shipmentArrears = document.getElementById("shipmentArrears").value
                  ...
                  var shipmentRemark = document.getElementById("shipmentRemark").value


                  $.ajax({
                      type: 'post',
                      url: '/salesShipment/updateOmShipmentById',
                      dataType: 'json',
                      data: {
                          productType: productType,
                          enterName: enterName,
                          ...
                          shipmentTotal: shipmentTotal,
                          shipmentPaid: shipmentPaid,
                          shipmentArrears: shipmentArrears,
      ...
      table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
          ...
          if (layEvent === 'del') { //删除
              layer.confirm('真的删除当前数据吗？', function (index) {
                  $.ajax({
                      type: 'get',
                      url: '/salesShipment/delOmShipmentById',
                      dataType: 'json',
