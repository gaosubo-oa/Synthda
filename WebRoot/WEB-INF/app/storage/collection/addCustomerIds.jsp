            ...
            success:function(json){
                ...
                $('.media-body').on('click',function() {
                    ...
                    $('.saveBtn').on('click',function () {
                        window.opener.document.getElementById("customerName").setAttribute('value',customerNo)
                        window.opener.document.getElementById("customerIds").setAttribute('value',customerId)
                        window.close();
                        window.location.href = '/invWarehouse/collReceipt'
                    })
                })
