...
<div class="mbox">
    <div class="item">
        <img src="../img/kucun.png" alt="" style="margin: 0 5px 0 20px;"> <span style="font-size: 22px;display: inline-block;vertical-align: middle;">商品库存</span>
    </div>
    ...
    <div id="ajaxforms" style="margin-top: 10px;">
        <div class="layui-form" style="display: flex">
            ...
            <%--<div style="margin-top: 9px;">当库存数量小于--%>
            <%--<input type="text" name="title" required lay-verify="required"  autocomplete="off" class="layui-input" style="display:inline-block;width: 35px;height: 25px">时，--%>
            <%--商品记录将显示红色报警--%>
            <%--</div>--%>
        </div>
    ...
    layui.use(['form', 'table','laydate'],function(){
        ...
        function set(val,month,data){
            ...
            var table1=table.render({
                ...
                ,page: true //开启分页
                ,cols: [[ //表头
                    {field: 'productTypeName', title: '商品大类',rowspan:2,width:120}
                    ,{field: 'enterName', title: '商品名称',rowspan:2,width:120}
                    ,{field: 'enterSpecs', title: '商品规格',rowspan:2,width:90}
                    ,{field: 'enterCode', title: '商品编码',rowspan:2,width:90 }
                    ,{field: '', title: '进货统计',colspan:2}
                    ,{field: '', title: '销售统计',colspan:2}
                    ,{field: '', title: '库存统计',colspan:2}
                ],
                    [ //表头
                        ...
                        ,{field: 'enterMonthTransfer', title: new Date().getMonth() + 1+'月出货数',templet:function(d){
