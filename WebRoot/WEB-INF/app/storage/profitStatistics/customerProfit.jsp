...
<div class="mbox">
    <div class="item" style="margin-top: 10px">
        <img src="../img/kuhulirun.png" alt="" style="margin: 0 5px 0 20px;width: 32px"> <span style="font-size: 22px;display: inline-block;vertical-align: middle;">客户利润</span>
    </div>
...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container">
        ...
        <button type="button" class="layui-btn layui-btn-sm" lay-event="allsear">全部客户利润</button>
        <button type="button" class="layui-btn layui-btn-sm" lay-event="monthsear">本月客户利润统计</button>
    </div>
</script>
<script>
    ...
    layui.use(['table','form','laydate'], function(){
        ...
        var tableInts=table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'realPrice', title: new Date().getMonth() + 1+'月客户利润',align:'center'}
                ,{field: 'CustomerEmail', title: '邮箱',align:'center'}
