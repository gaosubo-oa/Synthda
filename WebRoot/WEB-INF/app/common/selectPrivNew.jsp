...
<script>
	...
	$(function(){
		initTree = function(){
			$('#priOrg').tree({
				// url: '../userPrivType/queryUserPrivType/'+ deptId +'?moduleId=' + moduleId,
...
//                    buildPrivList(node.id);
				...
				onBeforeExpand: function (node, param) {
					// $('#priOrg').tree('options').url = "../userPrivType/queryUserPrivByPrivTypeId?privTypeId=" + node.id +"&number=" + number + "&deptId=" +deptId;// change the url
					$('#priOrg').tree('options').url = "/userPrivType/queryAllUserPriv?privTypeId=" + node.id;// change the url
				}
		...
		function buildPriitems(){
			...
			// 	//url = "../userPrivType/queryUserPrivByPrivTypeId?privTypeId=" + node.id;
			// }
			$.ajax({
				// url:url,
