...
<html>
<head>
    <title><fmt:message code="adding.th.EducationalBonus" /></title>
...
<div class="headtop">
    <p  class="heads">
        ...
        <fmt:message code="adding.th.EducationalBonus" />
    </p>
    <div class="demand">
...
<div class="pagediv" style="margin-top:21px;width:100%;overflow-y: auto;">
    <table style=" margin:0 16px 0 16px"><thead class="thead"><tr></tr></thead><tbody class="tbody"></tbody></table>
...
<script>
  ...
  //  console.log(iframeHead)
    var ajaxPage={
        ...
        page:function () {
            var me=this;
            $.post('/personBonusmsg/personQuery',this.data,function (json) {
                var str='';
                var str2='';
                var i=0;
                var datas=json.obj;
                if(json.obj.length>0) {
                    $('#dbgz_page').show();
                    $(iframeHead).width('3050px');
                    $(iframeChild).width('3050px');
                                ...
                                for (var t = 1; t <= i - 3; t++) {//列表内容数据展示
                                    ...
                                    if(arr2[k][temp]!=undefined) {
                                        if(temp == 'data50' || temp == 'data51'){
                                            ...
                                            if(t==1){
                                                str += '<td >' + arr2[k].YEARS+'年'+arr2[k].MONTH+ '月</td><td >' + arr2[k].USER_NAME+ '</td><td>'+(arr2[k][temp]?parseFloat(arr2[k][temp]).toFixed(2):"")+'</td>';
                                            }else {
                                                str += '<td >' + function(){
