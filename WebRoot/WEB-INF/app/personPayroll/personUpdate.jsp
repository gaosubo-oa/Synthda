...
<div class="step1" style="display: block;margin-top: -20px">
	...
	<div class="nav_box clearfix">
		...
		<div class="nav_t2" class="news">编辑权限</div>
	</div>
	<table class="newNews">
		<tbody>
		<tr>
...
<script type="text/javascript">
    ...
    $(function () {
        $.ajax({
            url:'/bonusPriv/detailSetUpCrmManager',
            data:{
                id:getRequestObj.id
            },
            type: 'get',
            ...
            success:function (json) {
                if (json.flag) {
                    $('#textUser').val(json.object.managerName);
                    $('#textUser').attr('user_id',json.object.manager);
                    $('#governor').val(json.object.employeeName);
                    $('#governor').attr('user_id',json.object.employee);
                }
            }
        })
    })
    ...
    function save() {
        var data={
            ...
            $.ajax({
                url: '/bonusPriv/upSetUpCrmManager',
                type: 'post',
                dataType: 'json',
                data:data,
