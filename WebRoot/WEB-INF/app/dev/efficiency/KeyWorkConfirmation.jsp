...
<div class="head">
    <div class="title">
        <img src="/img/commonTheme/${sessionScope.InterfaceModel}/flow_run_title.png"><span style="">重点工作确认</span>
    </div>
</div>
...
<script>
    ...
    function jumpOpenType(flowId, runId) {
        window.open('/workflow/work/workformPreView?flowId=' + flowId + '&flowStep=""&prcsId=""&runId=' + runId);
    }
        ...
        var pageObj = $.tablePage('#pagediv', '100%', [ // 1260
            ...
            },
            {
                ...
                selectFun: function (flowName, obj) {
                    return '<a class="wenhao" style="cursor: pointer;" onclick="jumpOpenType(' + obj.flowId + ',' + obj.runId + ')">' + flowName + '</a>';
                }
            },
            {
                width: '20%',
...
//                    return '<a class="wenhao" style="cursor: pointer;" onclick="jumpOpenName('+obj.flowId+','+obj.flowPrcs+','+obj.runId+','+obj.prcsId+')">'+runName+'</a>';
//                }
            },
            {
                width: '20%',
                ...
                selectFun: function (attachmentName, obj) {
                    if (attachmentName === '' || attachmentName === undefined) {
                        return '无';
                    }
                }
//                selectFun:function (attachmentName,obj) {
...
//                        return ''
//                    }else {
//                        return '<a href="javascript:;" style="    width: 20px;display: inherit;">'+attachmentName+'</a>' +
//                            '<a href="javascript:;" style="margin-right: 5px;" class="yulan" data-url="'+obj.list[0].attUrl+'">预览</a>' +
//                            '<a href="/download?'+obj.list[0].attUrl+'" >下载</a>'
//                    }
//                }
            }, {
                width: '15%',
...
//            me.data.flowId=$('[name="flowName"]').attr('dataType');

            me.init('/FlowRunFu/queryFlowRunZhong', [{
                name: workflow, fn: function (obj) {
                    return 1;
                }
            }, {
                name: '恢复执行', fn: function (obj) {
                    if (obj.status == '已结束') {
                        return 1;
                    } else {
                        return 0;
