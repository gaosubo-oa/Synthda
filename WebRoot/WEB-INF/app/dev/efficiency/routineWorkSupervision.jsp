...
<div class="head">
    <div class="title">
        <img src="/img/commonTheme/${sessionScope.InterfaceModel}/flow_run_title.png"><span style="">常规工作监察</span>
...
<div style="margin: 0 auto;width: 97%; ">
    <div style="margin: 0 auto; height:62px;width: 100%;">
        ...
        <div class="fl clearfix" style="margin-left: 10px;">
...
<script>
    ...
    function jumpOpenType2(flowId, runId) {
        console.log('ssssss');
        ...
        var pageObj = $.tablePage('#pagediv', '100%', [ // 1260
            ...
            },
            {
                ...
                selectFun: function (runName, obj) {
                    return '<a class="wenhao" style="cursor: pointer;" onclick="jumpOpenType2(' + obj.flowId + ',' + obj.runId + ')">' + runName + '</a>';
                }
            },
            {
                width: '20%',
                ...
                selectFun: function (prcsName, obj) {
                    return '<a class="wenhao" style="cursor: pointer;" onclick="">第'+obj.prcsId+'步 ' + prcsName + '</a>';
                }
            }, {
                width: '12%',
                title: '当前主办人',
...
//                }
            ...
            me.init('/FlowRunFu/queryFlowRunChang', [{
                ...
                var str = '<tr>' +
                    '<td style="width: 400px;text-align: center"><input type="checkbox" name="all"><span>全选</span></td>' +
