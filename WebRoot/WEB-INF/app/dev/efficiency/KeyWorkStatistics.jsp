...
<div class="head">
    <div class="title">
    <img src="/img/commonTheme/${sessionScope.InterfaceModel}/flow_run_title.png"><span style="">重点工作统计</span>
    </div>
</div>
...
<div id="graph" style="display: none">
    <div id="container" style="min-width:90%;height:400px;float: bottom;"></div>
</div>
...
<script src="/js/efficiency/KeyWorkStatistics.js"></script>
</html>
