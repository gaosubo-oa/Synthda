                    ...
                    if (attachmentList != undefined && attachmentList.length > 0){
                        for (var i = 0; i < attachmentList.length ; i++) {
                            str2 += '<li style="list-style:none; overflow: hidden; white-space: nowrap;text-overflow: ellipsis;width: 350px; margin-top: 10px">' +
                                ...
                                '            <span style="vertical-align:middle; margin-top: 5px; margin-left: 5px; font-size: 15px" onclick="anios($(this))" url="' + location.protocol + '//' + location.host + '/download?' + attachmentList[i].attUrl + '"  name="'+ attachmentList[i].attachName +'">'+ empty(attachmentList[i].attachFile) + '                        ' + empty(attachmentList[i].size) + '</span>\n' +
                            '</li>';
                        }
                    }
                    return str2;
