	...
	<body>
		...
		<div class="container layui-container">
			<div class="layui-row hide_content" style="display: none;">
				<div class="layui-col-xs6 card_box" ordernum="01" orderKey="newsModule">
					<div class="card_item">
						<div class="card_head">
				...
				<div class="layui-col-xs6 card_box" ordernum="02" orderKey="noticeModule">
					<div class="card_item">
						<div class="card_head">
							<div class="card_head_l">
				...
				<div class="layui-col-xs6 card_box" ordernum="03" orderKey="businessApprovalModule">
					<div class="card_item">
						<div class="card_head">
							<div class="card_head_l">
				...
				<div class="layui-col-xs6 card_box" ordernum="04" orderKey="documentManageModule">
					<div class="card_item">
						<div class="card_head">
							<div class="card_head_l">
				...
				<div class="layui-col-xs6 card_box" ordernum="05" orderKey="planCheckModule">
					<div class="card_item">
						<div class="card_head">
							<div class="card_head_l">
				...
				<div class="layui-col-xs6 card_box" ordernum="06" orderKey="executionModule">
					<div class="card_item">
						<div class="card_head">
							<div class="card_head_l">
				...
				<div class="layui-col-xs6 card_box" ordernum="07" orderKey="dataReport_one">
					<div class="card_item">
						<div class="card_head">
							<div class="card_head_l">
				...
				<div class="layui-col-xs6 card_box" ordernum="08" orderKey="dataReport_two">
					<div class="card_item">
						<div class="card_head">
							<div class="card_head_l">
		...
		<script type="text/javascript">
            ...
            if (!!cardOrder) {
                var cardOrderArr = cardOrder.split(',');
            }
            ...
            $('.card_box').arrangeable({
                ...
                afterDragEnd: function (e) { // 拖拽结束调用
                    ...
                    localStorage.setItem("cardOrder", cardOrderArr.join(','));
                }
            });
            ...
            $('.plan_check_type').on('change', function () {
                ...
                if (!!typeId) {
                    $('#planCheckModule').find('.check_link').attr('tid', planCheckObj[typeId]['tId']).attr('url', planCheckObj[typeId]['url']);
                    $('#planCheckModule').find('.check_link .more_t').text(planCheckObj[typeId]['titleStr']);
                } else {
            ...
            $('.task_target_type').on('change', function () {
                ...
                if (!!targetOrItem) {
                    ...
                    $('#executionModule').find('.execution_link').attr('tid', executionModuleObj[type]['tId']).attr('url', executionModuleObj[type]['url']);
                    $('#executionModule').find('.execution_link .more_t').text(executionModuleObj[type]['titleStr']);
                } else {
            ...
            function loadCardModule() {
                ...
                if (cardOrderArr && cardOrderArr.length > 0 && cardOrderArr.length == $cardEle.length) {
                    cardOrderArr.forEach(function (item) {
                        var $cardEle = $('.card_box[orderKey="' + item + '"]');
                            ...
                            res.obj.forEach(function (item) {
                                ...
                                if (item.url != undefined) {
                                    str += '<li class="li_item" read="' + (item.modelType == 1 ? '0' : '1') + '" onclick="jumpPage(this)" title="' + item.subject + '" notifyId="' + function () {
											if(item.subject.substring(0,4)=="[公告]"){
                                    ...
                                    if (assignData && assignData.length > 0) {
                                        assignData.forEach(function (item) {
                                            dataStr += '<li class="li_item" can="' + item.comment + '" runId="' + item.runId + '" flowPrcs="' + item.prcsId + '" prcsId="' + item.flowPrcs + '" removeRed="true"  title="' + function () {
                                                ...
                                                '<span class="li_title" style="width: 57%">' + item.flowRun.runName +
                                    ...
                                    if (commonData && commonData.length > 0) {
                                        commonData.forEach(function (item) {
                                            dataStr += '<li class="li_item" style="' + function () {
                                                ...
                                                + '<span class="circle"></span>' +
                                                '<span class="li_title" style="width: 57%;">' + item.flowRun.runName + '</span>' +
            ...
            var planCheckObj = {
                1: {titleStr: '关键任务审批', tId: '741505', url: '/plcProjectItem/targetApproval?menuId=741505'},
                2: {titleStr: '子任务审批', tId: '741510', url: '/plcProjectItem/taskApproval?menuId=741510'},
                3: {titleStr: '关键任务考核', tId: '742205', url: '/projectTarget/targetAssessment?menuId=742205'},
                4: {titleStr: '子任务考核', tId: '742201', url: '/projectTarget/taskAssessment?menuId=742201'},
                5: {titleStr: '考核审核', tId: '742210', url: '/projectTarget/assessmentCheck?menuId=742210'}
            }
            ...
            function initPlanCheckModule(typeId, checkType) {
                ...
                $.get('/plcPlan/getDataDoor', {type: typeId, flag: checkType}, function (res) {
                    ...
                    if (res.flag && res.obj.length > 0) {
                        var dataStr = '';
                        res.obj.forEach(function (item) {
                            dataStr += '<li class="li_item" onclick="parent.getMenuOpen(this)" title="[' + planCheckObj[item.type]['titleStr'] + ']' + item.name + '" tid="' + planCheckObj[item.type]['tId'] + '" url="' + planCheckObj[item.type]['url'] + '">' +
                                '<span class="circle"></span><span class="li_title">[' + planCheckObj[item.type]['titleStr'] + ']' + item.name + '</span>' +
                                '<span class="li_date">' + format(item.sendTime) + '</span>' +
                                '<h2 class="more_t">' + planCheckObj[item.type]['titleStr'] + '</h2></li>';
                        });
            ...
            var executionModuleObj = {
                6: {titleStr: '关键任务填报', tId: '742001', url: '/ProjectDaily/planExecutionReport?menuId=742001'},
                7: {titleStr: '子任务填报', tId: '742005', url: '/ProjectDaily/taskPlanReport?menuId=742005'}
            }
	                ...
	                if (res.flag && res.obj.length > 0) {
                        ...
                        res.obj.forEach(function (item) {
                            dataStr += '<li '+function () {
									...
									}()+' class="li_item" onclick="parent.getMenuOpen(this)" title="[' + executionModuleObj[item.type]['titleStr'] + ']' + item.name + '" tid="' + executionModuleObj[item.type]['tId'] + '" url="' + executionModuleObj[item.type]['url'] + '">' +
                                '<span class="circle"></span><span class="li_title">[' + executionModuleObj[item.type]['titleStr'] + ']' + item.name + '</span>' +
                                '<span class="li_date">' + format(item.planEndDate) + '</span>' +
                                '<h2 class="more_t">' + executionModuleObj[item.type]['titleStr'] + '</h2></li>';
                        });
