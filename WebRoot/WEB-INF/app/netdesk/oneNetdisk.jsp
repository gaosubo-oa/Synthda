...
<html>
<head>
    <title> QHSE<fmt:message code="main.network" /></title>
...
<%--    <script src="/js/xoajq/xoajq1.js" type="text/javascript" charset="utf-8"></script>--%>
    ...
    <script src="/js/zTree/netqhseworkHard.js?20230113.1" type="text/javascript" ></script>
    ...
    <div class="cabinet_info">
        ...
        <div class="mainContent" id="mainContent" style="display: block"><!--文档-->
            ...
            <div class="bottom w">
                ...
                <div class="boto addBackground" id="singReading" style="display: none;">
                    <a class="ONES dowmloadOne" href="javascript:void (0)"><img src="/img/file/icon_download.png" style="margin-right: 4px;margin-left: -2px;margin-bottom: 3px;" alt=""><fmt:message code="file.th.download" /></a>
                </div>
