...
<div class="box">
    <div class="header">
        <ul class="nav">
            ...
            <li style="margin-top:9px;" url="/vote/manage/unPublishVote">
    ...
    <div class="list" style="width:100%;height:100%">
        <%--列表展示部分--%>
        <iframe vote_id="0" id="iframe" src="/vote/manage/publishVote" frameborder="0" style="width:100%;height:100%"></iframe>
    </div>
</div>
