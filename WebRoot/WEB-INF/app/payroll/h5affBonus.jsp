...
<div class="headtop">
    ...
    <div class="demand">
        <select  name="YYYY"  id="year" style="text-align: center;width: 60px;height: 25px;margin-top: 5px"> </select>
...
<div class="pagediv" id="pagediv2" style="margin-top:21px;width:100%;overflow:auto;"></div>
<div style="color: red;height: 10px;width:100%;font-size: 10px;text-align: center">提示：点击下方月份查看明细</div>
<div class="pagediv" id="pagediv1" style="margin-top:10px;width:100%;overflow-y: auto;">
</div>
            ...
            $.post('/bonusmsg/query2',this.data,function (json) {
                ...
                if(json.obj.length>0) {
                    ...
                    for(var j=0;j<datas.length;j++){
                        ...
                        if(titles.length!=0){
                            $('#pagediv2').html('<table style="margin:0 0 10px 0;">'+thead+'</tr>'+actualTr+'</tr>'+tr+'</tr></table>');
                        }else{
                            $('#pagediv2').html('');
                        }
                    }
...
//                    me.pageTwo(json.totleNum, me.data.pageSize, me.data.page)
                    ...
                    $(iframeHead).width('100%');
                    $(iframeChild).width('100%');
                    var htmlStr='<table style=" margin:0 16px 10px 16px"><thead class="thead"><tr></tr></thead><tbody class="tbody"><tr style="border: none;">' +
                        '<td>' +
                        '<img style="display: block;text-align: center;margin: 0 auto;margin-top: 160px;margin-bottom: 10px;" src="/img/main_img/shouyekong.png" alt="">' +
                        '<h2 style="text-align: center;color: #666;font-size: 11pt;">暂无数据</h2>' +
                        '</td>' +
