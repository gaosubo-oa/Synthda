...
<div class="pagediv" id="pagediv2" style="margin-top:21px;width:100%;overflow-y:auto;"></div>
<div class="pagediv" id="pagediv1" style="margin-top:21px;width:100%;overflow: auto;position: absolute"></div>

</body>
<script>
    function height(heightBox) {
        $('#pagediv1').height('300px');
    }
                ...
                if(json.obj.length>0) {
                    ...
                    for(var j=0;j<datas.length;j++){
                            ...
                            for (var n = 1; n <= i - 3; n++) {//列表头数据展示
                                ...
                                if(arr[temp]!=null &&arr[temp]!=undefined) {
                                    ...
                                    if(temp == 'data50' || temp == 'data51'){
                                        ...
                                        str += '<th  class="th" style="" title="' + arr[temp] + '">' + arr[temp] + '</th>';
                                    }
                                }
                            }
                            str+='</tr>'
                                    ...
                                    if(arr2[k][temp]!=undefined) {
                                        if (t == 1) {
                                            ...
                                            if (arr[temp].indexOf('应发') >= 0 && arr2[k][temp] != undefined && arr2[k][temp] != '') {
                                                if (arr2[k][temp].toString().indexOf(".00") >= 0) {
                                                    // counts[j] = parseFloat(arr2[k][temp]).toFixed(0)
                                                    ...
                                                    // counts[j] = parseFloat(arr2[k][temp]).toFixed(2)
                                                    counts[j] += parseFloat(arr2[k][temp])
                                                }
                                            }
                                            if (arr[temp].indexOf('实发') >= 0 && arr2[k][temp] != undefined && arr2[k][temp] != '') {
                                                if (arr2[k][temp].toString().indexOf(".00") >= 0) {
                                                    // actual[j] = parseFloat(arr2[k][temp]).toFixed(0)
                                                    ...
                                                    // actual[j] = parseFloat(arr2[k][temp]).toFixed(2)
                                                    actual[j] += parseFloat(arr2[k][temp])
                                                }
                                            }
                        ...
                        if (titles.length != 0){
                            ...
                            var heightBox = $('body').height() - $('.headtop').height() - (parseInt($('#pagediv2').height()) + 21);
                            height(heightBox)
                        }else {
                            $('#pagediv2').html('');
                        }
...
//                    me.pageTwo(json.totleNum, me.data.pageSize, me.data.page)
    ...
    $(function () {
        ...
        //     window.location.replace('/bonusmsg/h5affBonus');
        // }
    })
</script>
</html>
