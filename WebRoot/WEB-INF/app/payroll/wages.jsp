...
<div class="pagediv" id="pagediv2" style="margin-top:21px;width:100%;overflow-y:auto;">

</div>

<div class="pagediv" id="pagediv1" style="margin-top:21px;width:100%;overflow-y: auto;position: absolute">

</div>
</body>
<script>
    $('#index_head').width('1560px')

    function height(heightBox) {
        $('#pagediv1').height(heightBox - 40);
    }
        ...
        page: function () {
            ...
            $.post('/bonusmsg/query', this.data, function (json) {
                ...
                if (json.obj.length > 0) {
                                        ...
                                        if (t == 1) {
                                            ...
                                            str += '<td >' + function () {
                                                if (arr2[k][temp].toString() == '0.00') {
                                                    ...
                                                    if (isNaN(parseInt(arr2[k][temp]))) {
                                                        return arr2[k][temp]
                                                    }
                                                    else if (arr2[k][temp].toString().indexOf(".00") >= 0) {
                    ...
                    $('#pagediv1').css('overflow-y','auto')
                    $('#pagediv2').css('overflow-y','auto')
                } else {
                    $('.thead tr').find('th').remove();
                    $('#dbgz_page').hide();
                    $(iframeHead).width($(window).width())
                    ...
                    $('#pagediv2').html(htmlStr).css('overflow','hidden');
                }
    ...
    $(function () {
        ...
        //     window.location.replace('/bonusmsg/h5wages');
        // }
