...
<div class="pagediv" id="pagediv1" style="margin-top:21px;width:100%;overflow:auto;"></div>
<div style="color: red;height: 10px;width:100%;font-size: 10px;text-align: center">提示：点击下方月份查看明细</div>
<div class="pagediv" id="pagediv2" style="margin-top:21px;width:100%;overflow: auto;position: absolute"></div>
</body>
<script>
            ...
            $.post('/bonusmsg/query2',this.data,function (json) {
                ...
                if(json.obj.length>0) {
                    ...
                    for(var j=0;j<datas.length;j++){
                        ...
                        if(arr2!=''){
                            str += '<table style="margin:0px 0 10px 0;">' +
                        ...
                        var thead = '<tr style="width: 100%"><th class="th">类型</th>';
                        var tr = '<tr><td>应发</td>';
                        var countMoney = 0;
                        ...
                        if (titles.length != 0){
                            $('#pagediv1').html('<table style="margin:15px 5px 10px 0px;">' + thead + '</tr>' + actualTr + '</tr>' + tr + '</tr></table>');
                        }else {
                            $('#pagediv1').html('');
                        }
