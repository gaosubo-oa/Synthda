...
//                            if(v.deptId != 1){
                                ...
                                str += '<li><span data-types="1"  data-numtrue="1" ' +
                                    'onclick= "imgDown_s2(' +v.deptId + ',this)"  style="height:35px;line-height:35px;padding-left: 30px" deptid="' + v.deptId + '" class="firsttr childdept">' +
                                    '<span class=""></span>' +
            ...
            success:function(res){
                if(res.flag){
                    ...
                    layer.open({
                        type: 1,
                        title: ['提示','background-color:#2e8ded;color:#fff'],
                        content:'<div style="font-size: 18px;text-align: left;padding: 60px 50px 0 50px;">'+msg+'</div>',
                        area: ['430px', '250px'],
