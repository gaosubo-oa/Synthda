...
<div class="wrap" style="margin-left:0px !important;">
    <div class="head">
        <div class="head_left" style="float: none;">
            <div style="float: left;">
                <img src="/img/commonTheme/${sessionScope.InterfaceModel}/dept1.png" alt="">
                <h1 style="float: left !important; width: 200px;"><fmt:message code="main.deptmanage" /></h1>
                <span class="subText" style="font-family: Microsoft yahei; font-weight: bolder; font-size: 12pt; color:red; display: none;float: left; line-height: 46px;">机密级★</span>
            </div>

            <div style="float: right">
                <button style='cursor:pointer;' class="syn_dept" onclick="synDept()" >同步部门</button>
    ...
    <div class="cont" style="overflow-y: auto ">
        <div class="cont_left" id="cont_left">
            <ul>
                <li class="liDown dept_li" id="dept_lis" style="padding-left: 30px;">
                    <img src="/img/commonTheme/${sessionScope.InterfaceModel}/icon_sectorList.png" style="vertical-align: middle;width: 15px;margin-right: 10px;" alt="<fmt:message code='depatement.th.depa' />"><fmt:message code="depatement.th.depa" />
                    <a href="javascript:void(0)" onclick="location.reload()" style="color: #207BD6;margin-left: 20px;cursor: pointer;"><img src="/img/commonTheme/theme6/icon_shuaxin_03.png" style="margin-right: 8px;margin-bottom: 1px;"><fmt:message code="global.lang.refresh" /></a>
                </li>
                <div style="padding-left: 30px;font-size: 14px;padding-top: 10px;">
                    <label class="" style="display: inline-block;"><fmt:message code="depatement.th.WhetherToDisplayTheFailedDepartment" /></label>
                ...
                <li class="liUp dept_li" onclick="develop(this)" data-url="/department/batchSetDept"><img src="/img/commonTheme/${sessionScope.InterfaceModel}/smallBatchSetDept.png" style="vertical-align: middle;width: 15px;margin-right: 10px;" alt="<fmt:message code="depatement.th.Sectorbatch" />"><fmt:message code="depatement.th.Sectorbatch" /></li>
                <li class="liUp dept_li" onclick="develop(this)" data-url="/department/AuxiliaryDepartment"><img src="/img/commonTheme/theme1/addAndRemove.png" style="vertical-align: middle;width: 15px;margin-right: 10px;" alt="<fmt:message code="depatement.th.Add/RemoveAuxiliaryDepartments" />"><fmt:message code="depatement.th.Add/RemoveAuxiliaryDepartments" /></li>
                <li class="liUp dept_li" onclick="develop(this)" data-url="/usergroup/userGroup"><img src="/img/commonTheme/${sessionScope.InterfaceModel}/smallGroup.png" style="vertical-align: middle;width: 15px;margin-right: 10px;" alt="<fmt:message code="depatement.th.customgroup" />"><fmt:message code="depatement.th.customgroup" /></li>
                <li class="liUp dept_li" onclick="develop(this)" data-url="/department/upDeptRank"><img src="/img/commonTheme/${sessionScope.InterfaceModel}/smallUpDeptRank.png" style="vertical-align: middle;width: 15px;margin-right: 10px;" alt="<fmt:message code="depatement.th.departmentlevel" />"><fmt:message code="depatement.th.departmentlevel" /></li>
                <li class="liUp dept_li" onclick="develop(this)" data-url="/department/exportOrImport"><img src="/img/commonTheme/${sessionScope.InterfaceModel}/icon_userImport.png" style="vertical-align: middle;width: 15px;margin-right: 10px;" alt="<fmt:message code="doc.th.deptImport" />"><fmt:message code="doc.th.deptImport" /></li>
                </div>
            </ul>
        </div>
        ...
        <div class="mainRight" style="float: left; display: none">
        ...
        function saveEXaInfo(fn) {
            layer.open({
                ...
                content: '<div style="width:800px;margin:10px auto;">' +
                        '<div style="color: red;">提示: 修改了部门主管或者部门审批人，需保密员审批后生效</div>'+
                ...
                $.ajax({
                    ...
                    success:function(data){
                        if(data.flag){
                            ...
                            var arr1=r.reverse();
                            window.location.href="/common/deptManagement?arr1="+arr1
                        }else{
