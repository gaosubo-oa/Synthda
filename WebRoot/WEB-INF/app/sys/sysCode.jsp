...
<div id="west" class="west">
    ...
    <ul class="head_line">
        <li style="height: 33px;display: flex">
            <input type="text" style="width: 97%; font-size: 15px;margin-left: 1px;" id="search" placeholder="<fmt:message code="interfaceSetting.th.inputNameSearch" />"   class="search" size="20" maxlength="100" value="">&nbsp;
            <a id="clear" style="color: red;font-size: 20px;position: absolute;margin-top: 5px;
    margin-left: 90%;"><strong>×</strong></a>
        </li>
        <li  onclick="showMain()" class="menuList backgroundcolor" id="menuList">
            <img src="/img/commonTheme/${sessionScope.InterfaceModel}/addcodemain.png" style="margin-left: 35px;height: 25px;margin-top: -5px;">
            <a target="code_edit" style="" title="<fmt:message code="sysCode.th.AddCode" />" id="link_1"><strong><span style="font-size: 15px"><fmt:message code="interfaceSetting.th.createMainCategory" /></span></strong></a>
        </li>
        <div id="module_1" class="moduleContainer" style="">
            <table class="TableBlock" width="100%" id="TableBlock">
            </table>
        </div>
        <li class="hidden menuList_hide" onclick="showbg1();" id="codeerror">
            <img src="../../img/errorcode.png" style="margin-left: 35px;height: 25px;margin-top: -5px;">
            <a  target="code_edit" title="<fmt:message code="sysCode.th.ErrorCode" />" id="link_3"><strong><span style="font-size: 20px"><fmt:message code="sysCode.th.ErrorCode" /></span></strong></a>
        </li>
...
<div id="center">
    ...
    <div  id="bodycolor" style="display:block;">
        <div class="small">
            ...
            <span id="big4" style="float: right;margin-right: 3%;margin-top: -5px"></span>
        </div>
        <br>
    ...
    <%-- <div class="hideDome" style="display: none;height:98%;border: none;">
         <iframe src="/email/development" width="100%" height="100%;" style="border: none;"></iframe>
     </div>--%><%--正在开发中--%>
</div>
<script type="text/javascript">
    ...
    function getLevelData(status,name){
        ...
        $.ajax({
            ...
            //data:datas,
            success:function(data){
                var strs='<input type="button" value="<fmt:message code="global.lang.dmx" />" style="padding-left:15px;color:#404060" class="BigButton addcodebut" onclick="mainMenuedit_add(this)" parentCode="'+status+'" name_next="'+name+'">'
                //console.log(data);
                $("#TableBlock_center").css("display","none");
                $(".big3").text(name);
                <%--$(".big3").text('<fmt:message code="global.lang.classification" />');--%>
                var str_sublevel='<tbody><tr class="TableHeader" align="center" style="background-color:#f2f2f2">'+
                    '<td style="border-right:0px" nowrap="" title="序号"   id="next_name">&nbsp;&nbsp;<b>序号</b>&nbsp;&nbsp;'+
                    '</td>' +
                    '<td style="border-right:0px" nowrap="" title="编码"   id="next_name">&nbsp;&nbsp;<b>编码</b>&nbsp;&nbsp;'+
                    '</td>' +
                    '<td style="border-right:0px" nowrap="" title="名称"   id="next_name">&nbsp;&nbsp;<b>名称</b>&nbsp;&nbsp;'+
                    '</td>' +
                    '<td nowrap="" title="操作"   id="next_name" >&nbsp;&nbsp;<b>操作</b>&nbsp;&nbsp;'+
                    '</td>' +
                    '</tr>'+
                    '<tr>' +
                    <%--'<td class="TableControl" align="center" colspan="2">' +--%>
                    <%--'<input type="button" value="<fmt:message code="global.lang.dmx" />" style="padding-left:15px;color:#404060" class="BigButton addcodebut" onclick="mainMenuedit_add(this)" parentCode="'+status+'" name_next="'+name+'">' +--%>
                    <%--'</td>' +--%>
                    '</tr>';
                if(data.obj != undefined){
                    ...
                    for(var i=0;i<str_length;i++){
                        if(data.obj[i].codeFlag==0){
                            str_sublevel=str_sublevel+'<tr class="TableData">' +
                                '<td style="text-align: -webkit-center;" nowrap="" title="'+data.obj[i].codeOrder+'">'+ data.obj[i].codeOrder+'&nbsp;&nbsp;&nbsp;'+
                                '</td>' +
                                '<td style="text-align: -webkit-center;" nowrap="" title="'+data.obj[i].codeNo+'">'+ data.obj[i].codeNo+'&nbsp;&nbsp;&nbsp;'+
                                '</td>' +
                                '<td style="text-align: -webkit-center;" nowrap="" title="'+data.obj[i].codeName+'">'+data.obj[i].codeName+'&nbsp;'+
                                '</td>' +
                                '<td nowrap="" style="text-align: -webkit-center;">&nbsp;'+
                                '<a onclick="mainMenuedit_sub(this)" codeId="'+data.obj[i].codeId+'" codeorder="'+data.obj[i].codeOrder+'" codeName="'+data.obj[i].codeName+'" codeNo="'+data.obj[i].codeNo+'" parentNo="'+status+'" name="'+name+'" class="ziti">'+
                                '<fmt:message code="global.lang.edit" /></a>&nbsp;&nbsp;</td></tr>';
                        }else if(data.obj[i].codeFlag==1){
                            str_sublevel=str_sublevel+'<tr  class="TableData">' +
                                '<td nowrap="" title="'+data.obj[i].codeOrder+'" style="text-align: -webkit-center;">'+ data.obj[i].codeOrder+'&nbsp;&nbsp;&nbsp;'+
                                '</td>' +
                                '<td nowrap="" title="'+data.obj[i].codeNo+'" style="text-align: -webkit-center;">'+ data.obj[i].codeNo+'&nbsp;&nbsp;&nbsp;'+
                                '</td>' +
                                '<td nowrap="" title="'+data.obj[i].codeName+'" style="text-align: -webkit-center;">'+ data.obj[i].codeName+'&nbsp;&nbsp;&nbsp;'+
                                '</td>' +
                                '<td nowrap="" style="text-align: -webkit-center;">&nbsp;'+
                                '<a onclick="mainMenuedit_sub(this)" codeId="'+data.obj[i].codeId+'" codeorder="'+data.obj[i].codeOrder+'" codeName="'+data.obj[i].codeName+'" codeNo="'+data.obj[i].codeNo+'" parentNo="'+status+'" class="ziti" name="'+name+'">'+
                                '<fmt:message code="global.lang.edit" /></a>&nbsp;&nbsp;'+
                                '<a onclick="delete_next_form(this);" codeId="'+data.obj[i].codeId+'" codeNo="'+data.obj[i].codeNo+'" codeName="'+data.obj[i].codeName+'" parentNo_sub="'+status+'" name="'+name+'" class="scziti"> <fmt:message code="global.lang.delete" /> </a>'+
                                '</td></tr>';
                        }
                    }
                }
            ...
            success: function (res) {
                ...
                for (var i = 0; i < data1.length; i++) {
                    if (data1[i].codeFlag == 0) {
                        str += '<tr class="AllData"><td>' + data1[i].codeId + '</td><td>' + function () {
                                if(data1[i].name==undefined){
                                    return ''
                                }else{
                                    return data1[i].name
                                }
                            }() + '</td><td>' + '<a href="javascript:;" onclick="editErrCode(' + data1[i].codeId + ')"><fmt:message code="depatement.th.modify" /></a>&nbsp;&nbsp;&nbsp;&nbsp;' + '</td></tr>';
...
//        console.log(parentcode);
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                var str_i=str_i+'</select></td></tr><tr><td nowrap="" class="TableData" width="120">编码：</td><td nowrap="" class="TableData"><input type="text" name="CODE_NO" class="BigInput" size="20" id="add_codeNo" value="">&nbsp;</td></tr><tr><td nowrap="" class="TableData">排序号：</td><td nowrap="" class="TableData"><input type="text" name="" class="BigInput" size="20" id="add_codeOrder" value="">&nbsp;</td></tr><tr><td nowrap="" class="TableData">名称：（简体中文）</td><td nowrap="" class="TableData"><input type="text"name="" class="BigInput" size="20" id="add_codeName" value="">&nbsp;</td></tr><tr><td nowrap="" class="TableControl" colspan="2" align="center"><input type="button" value="&nbsp;&nbsp;&nbsp;&nbsp;<fmt:message code="menuSSetting.th.menusetsure" />" class="BigButton backimg" onclick="addSubCode(this)" parentCodeName="'+paerentCodeName+'" parentNo="'+parentcode+'">&nbsp;&nbsp;<input type="button" value="&nbsp;&nbsp;&nbsp;&nbsp;<fmt:message code="notice.th.return" />" class="BigButton reimg" onclick="back(this)" codeId="" codeName="" codeNo="'+parentcode+'" name_next_1="'+name_next_1+'"></td></tr></tbody></table>';
                $('.hideDome').hide();
                $("#bodycolor").show();
...
//        }
    ...
    function mainMenuedit_sub(e){
        ...
        // console.log(names,8888)
        // $(".big3").text(names);
        var str_s='<table><tbody><tr><td class="TableData"><fmt:message code="global.lang.class" /></td><td class="TableData">'+names+'</td></tr>' +
            '<tr><td nowrap="" class="TableData" width="120">编码：</td>'+
                '<td nowrap="" class="TableData">'+
            ...
            '<tr>'+
                ...
                '</td>' +
            '</tr>' +
            '<tr><td nowrap="" class="TableData">名称：</td>'+
                '<td nowrap="" class="TableData">'+
            ...
            '<tr>'+
                '<td nowrap="" class="TableControl" colspan="2" align="center">'+
                    '<input type="button" value="&nbsp;&nbsp;&nbsp;&nbsp;<fmt:message code="menuSSetting.th.menusetsure" />" class="BigButton backimg" onclick="editerrcode(this);" codeId="'+codeId+'" codeNo="'+codeNo+'" parentNo="'+parentNo+'" form_oldname="'+parentNo+'" next_name="'+next_name+'" name="'+names+'">&nbsp;&nbsp;'+
                '</td>'+
            '</tr></tbody></table>'+
            '';
        $('.hideDome').hide();
...
//        console.log($(this).attr("codeno"));
                    ...
                    if(data.flag==true){
                        ...
                        $.ajax({
                            ...
                            success:function(){
                                ...
                                getLevelData(form_oldname,next_names);
                            }
                        })
                    }
                }
    ...
    function editerrcode(me){
        ...
        var oldcodeNo=$(me).attr("codeNo");
        var form_oldname=$(me).attr("form_oldname");
        var form_oldnames=$(me).attr("name");
        var next_name=$(me).attr("next_name");
        var codeNoData={
            codeNo:form_num,
            parentNo:parentNo,
                            ...
                            success:function(){
                                $.layerMsg({content:'<fmt:message code="depatement.th.Modifysuccessfully" />！',icon:1},function(){
                                    $.ajax({
                                        ...
                                        type: "get",
                                        success: function (res) {
                                            getLevelData(parentNo,form_oldnames);
