...
<div class="step1" style="display: block;margin-left: 0px;">
    ...
    <div class="nav_box clearfix">
        <div class="nav_t1" style="margin-left: 30px;"><img src="/img/commonTheme/${sessionScope.InterfaceModel}/batchSetDept.png"></div>
    ...
    <table class="newNews">
        ...
        <tr>
            <td class="td_w blue_text">
                <%--部门简称：--%>
                <fmt:message code="department.th.abbreviation" />：
            </td>
            <td>
        ...
        <tr>
            <td class="td_w blue_text">
                <%--部门编码：--%>
                    <fmt:message code="department.th.code" />：
            </td>
            <td>
                <%--<select name="DEPT_PARENT" class="BigSelect" id="deptParent">
                </select>--%>
                <input class="td_title1" type="text" style="width: 200px;"  id="schoolNum" />
        ...
        <tr>
            <td class="td_w blue_text">
                <%--部门分类：--%>
                    <fmt:message code="department.th.classification" />：
            </td>
            <td>
        ...
        <tr>
            <td class="td_w blue_text">
                <%--部门是否失效：--%>
                    <fmt:message code="department.th.ineffective" />：
            </td>
            <td>
                <label for="">
                    <input type="radio" value="1" class="addDeptPlay" id="addDeptPlay" checked name="deptDisplay2">
                    <%--有效--%>
                    <span><fmt:message code="department.th.effective" /></span>
                </label>
                <label for="">
                    <input type="radio" value="0" class="addDeptPlay" id="addDeptNoplay"name="deptDisplay2">
                    <%--失效--%>
                    <span><fmt:message code="department.th.invalid" /></span>
                </label>
            </td>
        </tr>
        <tr class="deptHead">
            <%--部门负责人--%>
            <td class="blue_text"><fmt:message code="department.th.deptHead" />：</td>
            <td>
        ...
        <tr class="adShow" style="display: none">
            ...
            <td>
                <select id="adDeptMap" class="xm-select-demo" cols="60" rows="5" multiple style="height: 150px;width: 400px"></select>
            </td>
        </tr>
        <tr>
            <td colspan="2" style="height: 30px;position: relative;">
                <button type="button" class="new_but" id="new" style="position: absolute;top: 11px;left: 50%;margin-left: -42px;color: #fff;"><fmt:message code="global.lang.new" /></button>
            </td>
        </tr>
        </tbody>
    </table>
...
<div class="step2" style="display: none;margin-left: 0px;">
    ...
    <div class="nav_box clearfix">
        ...
        <div class="nav_t2" class="news" style="font-size: 20px;"><fmt:message code="depatement.th.edit" /></div>
            ...
            success:function(res) {
                ...
                if(data.paraValue == 1) {
                    ...
                    $('.deptHead').after(' <tr class="deptexamine" style="display: none;">\n' +
                        ...
                        '            <td>\n' +
                        '                <input class="td_title1  release1" id="deptApprover__" dataid="" type="text"/>\n' +
                        '                <%-- <img class="td_title2 release2" id="ip2" src="../img/mg2.png" alt=""/>--%>\n' +
                        '                <div class="release3" id="addDeptApprover__"><fmt:message code="global.lang.add" /></div>\n' +
                        '                <div class="release4 empty" onclick="empty(\'deptApprover\')"><fmt:message code="global.lang.empty" /></div>\n' +
                        '            </td>\n' +
                        '        </tr>')
                    $(".deptexamine").show();
                    //如果开启了三员管理 部门主管和部门审核人变为单选
                    $("#addDeptApprover__").on("click",function() {
                        user_id = "deptApprover__";
...
//            }
            ...
            var data = {
                ...
                "deptApprover": $("#deptApprover__").attr("user_id") || "",//部门审批人
