...
<div class="header">
    <ul class="nav" style="height: 43px;border-bottom: 1px solid #9E9E9E;">
        ...
        <li id="messageSetting" style="margin-top:6px;" url="#">
            <span class="select pad"><a href="/sysTasks/getIMTasks"><fmt:message code="system_config.instant_messaging_setting" /></a></span>
            <img class="space" src="../../img/twoth.png" alt="">
        </li>
    ...
    <h1 style="height: 80px;line-height: 80px;">
        ...
        <fmt:message code="system_config.instant_messaging_setting" />
    </h1>
</div>
...
<div>
    <table>
        ...
        <tbody>
        <tr>
            <td nowrap="" colspan="2" align="left" style="border-bottom:1px solid #c0c0c0;">
                <img src="/img/sys/icon_jichu.png" style="float:left;margin-right: 12px;vertical-align: baseline;">
                <b style="color: #2F5C8F; font-size: 13pt; vertical-align: middle;"><fmt:message code="system_config.instant_messaging_parameter_setting" /></b>
            </td>
        </tr>
        <tr>
            <td><fmt:message code="system_config.communication_scope_setting" /></td>
            <td style="text-align: center;">

                <label for="">
                    <input type="radio" name="ISIMFRIENDS" value="0">
                    <span><fmt:message code="system_config.unlimited" /></span>
                </label>

                <label for="" style="margin-right: 10px;">
                    <input type="radio" name="ISIMFRIENDS" value="1">
                    <span><fmt:message code="system_config.need_to_add_friends_to_communicate" /></span>
                </label>
            </td>
        </tr>
        <tr>
            ...
            $.ajax({
                ...
                success:function (reg) {
                    ...
                    for(var i=0;i<item.length;i++){
                        if(item[i].paraName =='ISIMFRIENDS' ){
                            $(":radio[name='ISIMFRIENDS'][value='" + item[i].paraValue + "']").prop("checked", "checked");
                        }
                    }
                }
            })
