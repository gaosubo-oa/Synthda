...
<html>
<head>
    <title><fmt:message code="doc.th.DoReceipt" /></title>
...
<div class="headTop">
    <div class="headImg">
        <img src="/img/commonTheme/${sessionScope.InterfaceModel}/daibanshouwen.png" alt="">
    </div>
    <div class="divTitle">
        <fmt:message code="doc.th.DoReceipt" />
    </div>
...
<div style="margin: 0 auto;margin-top: 46px;height: 60px;width: 97%;" class="clearfix">
    ...
    <label class="fl clearfix" style="margin-top: 16px;margin-left: 10px;" >
        ...
        <label class="fl"><input name="title" placeholder="<fmt:message code="main.th.ContentSearch" />"  type="text"></label>
    </label>
    <label class="fl clearfix" style="margin-top: 16px;margin-left: 10px;" >
...
<div id="pagediv">
    ...
    <script>
        ...
        window.onresize = function(){
            ...
            pageObj.configuration[3]['width'] = nums * 0.126 + 'px';
            pageObj.configuration[4]['width'] = nums * 0.116 + 'px';
            pageObj.configuration[5]['width'] = nums * 0.085 + 'px';
        ...
        var pageObj=$.tablePage('#pagediv',sumwidth,[
            ...
            },
            {
                ...
                width:width4,
                title:'<fmt:message code="doc.th.DispatchTime2"/>',
                name:'createTime',
                selectFun:function (createTime,obj) {
                    if(createTime!=undefined&&createTime.indexOf('.') > -1){
            ...
            me.init('/document/selWillDocSendOrReceive',[{name:'<fmt:message code="sup.th.handle"/>',fn:function (obj) {
                if('1' == obj.branchCount){
                    return 0;
                }
                return 1;
