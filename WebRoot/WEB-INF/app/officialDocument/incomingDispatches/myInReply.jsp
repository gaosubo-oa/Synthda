...
<html>
<head>
    <title><fmt:message code="doc.th.MyInBox"/></title>
...
<div class="headTop">
    <div class="headImg">
        <img src="/img/commonTheme/${sessionScope.InterfaceModel}/wodeshouwen.png" alt="">
    </div>
    <div class="divTitle">
        <fmt:message code="doc.th.MyInBox"/>
    </div>
</div>
...
<script>
    ...
    var pageObj = $.tablePage('#pagediv', sumwidth, [
        ...
        },
        {
            ...
            selectFun: function (title, obj) {
                ...
                if (title != undefined) {
                    return '<a href="javascript:;" class="title-xiangqing">' + str + title + '</a>'
                } else {
                    return ""
                }
            }
        ...
        me.init('/document/selMyDocSendOrReceive', [{
    ...
    $('.Query').on('click', function () {
        ...
        pageObj.data.curUserID = 2;
        pageObj.data.documentType = 1;
        pageObj.init();
    })
