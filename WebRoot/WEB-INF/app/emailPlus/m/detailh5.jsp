                            ...
                            if (data != null) {
                                if (data.object.length == 0) {
                                    ...
                                    for (var i = 0; i < data_file.length; i++) {
                                        accessory += '<p><span style="width: 75%;display: inline-block;">' + strs[i]+ '</span><a style="display:inline-block;width:20%;color:dodgerblue" href="/download?' + encodeURI(data_file[i].attUrl) + '">下载</a></p>';
                                    }
                        ...
                        success: function (data) {
                            ...
                            if (data != null) {
                                if (data.object.length == 0) {
                                    ...
                                    var accessory = "";
                                    for (var i = 0; i < data_file.length; i++) {
                                        accessory += '<p><span style="width: 75%;display: inline-block;">' + data.object.attachmentName+ '</span><a style="display:inline-block;width:20%;color:dodgerblue" href="/download?' + encodeURI(data_file[i].attUrl) + '">下载</a></p>';
                                    }
                                }
