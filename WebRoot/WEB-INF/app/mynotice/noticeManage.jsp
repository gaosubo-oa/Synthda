...
//                }
        ...
        /*公告统计接口*/
        $.ajax({
            url: '/myNotice/getNotifyGroupFromDept',
            type: 'get',
            data: {
        ...
        $('#cont_totals').on('click','#deptName',function(){
            ...
            /* /myNotice/getNotifyByFromDept*/
            $.ajax({
                url: '/myNotice/getNotifyByFromDept',
                type: 'get',
                data: {
                    fromDept:deptId,
                    beginTime:beginTime,
        ...
        $('#cont_totals').on('click','#name',function(){
            ...
            var endTime=$('#find_end').val();
            $.ajax({
                url: '/myNotice/getNotifyByFromIdAndDept',
                type: 'get',
                data: {
                    fromDept:deptId,
                    fromId:fromId
        ...
        $('.n_daochu').on('click',function(){
            ...
            var endTime=$('#find_end').val();
            if($('.trs').attr('step')=='1'){
                window.location.href= '/myNotice/outputNotify?fromDept='+deptId+'&beginTime='+beginTime+'&endTime='+endTime+'&step=1';

            }else if($('.trs').attr('step')=='2'){
                window.location.href= '/myNotice/outputNotify?fromDept='+deptId+'&beginTime='+beginTime+'&endTime='+endTime+'&step=2';

            }else if($('.trs').attr('step')=='3'){
                var fromId=$('.trs').attr('fromid');
                window.location.href='/myNotice/outputNotify?fromDept='+deptId+'&beginTime='+beginTime+'&endTime='+endTime+'&step=3&fromId='+fromId;
            }
...
//公告查询按钮
        ...
        $('#daochu').on('click',function(){
            ...
            /* $('.step1').show();
             $('.center').hide();*/
            window.location.href='/myNotice/notifyList?read='+read+'&typeId='+typeId+'&useFlag='+useFlag+'&page='+page+'&pageSize='+pageSize+'&newsTime='+newsTime+'&lastEditTime='+lastEditTime+'&content='+content+'&subject='+subject+'&beginTime='+begintime+'&endTime='+endtime+'&changeId=1'+'&exportId=2'+'&format='+format+'&publish='+publish+'&TOP='+top+'&fromId='+fromId;
        })
        //公告删除按钮
