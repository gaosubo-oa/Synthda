...
<head lang="en">
    ...
    <script src="/js/mynotice/theQuery.js"></script>
</head>
<body>
<div class="navigation">
    <img src="/img/commonTheme/${sessionScope.InterfaceModel}/gonggaochaxun.png" alt="">
    <h2>查询</h2>
    <div id="export" class="btn btn-info daochuwork" onclick="clicked1();" style="margin-right: 10pt;"><img src="../../img/mywork/dclist1.png" style="margin: 0 8px 2px 10px">导出公告列表</div>
</div>
<div class="query">
