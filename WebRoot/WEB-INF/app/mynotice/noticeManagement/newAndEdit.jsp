...
<%--    <script type="text/javascript" src="../js/email/fileupload.js"></script>--%>
    ...
    <script src="/js/mynotice/newAndEdit.js?20230105"></script>
    <script src="/js/mynotice/flowNotice.js?20200518.1" type="text/javascript" charset="utf-8"></script>
    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td width="80%" style="text-align: left">
                    <input type="checkbox" id="back" style="margin: -1px 0px 0px 0px" name="isOpin" value="0" ><label style="display: inline-block;margin-left: 5px" for="">需要回执</label>
                </td>
            </tr>
            <tr class="setHide" style="display:none">
                ...
                <td width="80%" style="text-align: left" >
                    <input type="text" name="field" placeholder="填写回执标题（1)" style="width: 200px;"/>
                    <a href="javascript:;" id="add">添加</a>
                    <a href="javascript:;" id="clear" style="display:none">删除</a>
            ...
            <tr>
                <td colspan="2" style="text-align: center" class="btnarr">
                    ...
                    <a href="javascript:;" class="backnotice">返回</a>
                </td>
            </tr>
        </tbody>
    </table>
...
<script>
    ...
    $('#add').click(function(){
        var str = ' <input type="text" name="field" placeholder="填写回执标题（'+($('[name="field"]').length+1)+')"  style="width: 200px;"/>'
        $('#clear').show()
        if($('[name="field"]').length>=10){
            $.layerMsg({content:'最多添加10个',icon:6})
    ...
    $('#clear').click(function(){
        if($('[name="field"]').length<=1){
            $.layerMsg({content:'最少留1个文本框',icon:6});
            $('#clear').hide()
    ...
    $('.backnotice').click(function(){
        window.location.href='/myNotice/myManagement?specifyTable='+specifyTable;
    })
