        ...
        $.ajax({
            ...
            success:function (res) {
                if(res.object.length!=0){
                    ...
                    if (data.paraValue!=0){
                        $('.SmallButton').after('<span style="color: red;font-family: Microsoft YaHei;font-weight: bolder;font-size: 12pt;margin-left: 20px;margin-top: 10px;"> 机密级★ </span>')
                    }
                }
            }
        })
