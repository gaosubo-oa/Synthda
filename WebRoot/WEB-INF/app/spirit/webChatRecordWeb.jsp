...
<%--    <script type="text/javascript" charset="utf-8" src="/js/jquery/jquery-migrate-3.4.0.js"></script>--%>
    ...
    <script src="../js/attachment/attachView.js?20230317.2" type="text/javascript" charset="utf-8"></script>
...
<div class="content" style="display: flex;margin-top: 25px; width: 100%;border-top: 1px solid #999;">
    ...
    <div class="mainRight" style="width:calc(100% - 300px);height: 100%;overflow-y: hidden;">
        <div class="mainCon">
            ...
            <div class="mainbox" id="mainbox" style="overflow-x: hidden;overflow-y: auto;position:fixed;top:150px;width: 100%;;height: 65%;">
                <div class="main"></div>
            </div>
            <div class="mainbox" id="mainbox1" style="overflow-x: hidden;overflow-y: auto;top:150px;width: 100%;display: none;height: 65%;">
                <div class="main" style="padding: 10px 0;margin: 0 auto;width: 100%;">
                </div>
            </div>
            <div class="mainbox" id="mainbox2" style="overflow-x: hidden;overflow-y: auto;top:150px;width: 100%;display: none;height: 65%;">
                <div class="main" style="padding: 10px 0;margin: 0 auto;width: 100%;"></div>
            </div>
            <div class="mainbox" id="mainboxsearch" style="overflow-x: hidden;overflow-y: auto;position:fixed;top:150px;width: 100%;display: none;height: 65%;">
                <div class="main"></div>
            </div>
                <div id="mainPageBox" style="position: fixed;bottom: 0;background-color: #FFFFff;right: 10px;"></div>
        </div>
    </div>
</div>
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (datas.length > 0) {
                            ...
                            layer.closeAll();
                            $('#infoTree').append(str);
                            $('#infoTree li').eq(0).trigger('click')
                        } else {
                            layer.closeAll();
                                ...
                                if(arr[i].content !=''){
                                    ...
                                    if(JSON.stringify(arr[i].file) == "{}"){
                                        ...
                                        if(arr[i].file.thumbnail_url !=undefined){
                                            ...
                                            var size =arr[i].file.file_size;
                                            var deUrl = arr[i].file.file_url+"&FILESIZE="+size;
                                            var fileArr = [];
                                            fileArr.push(arr[i].file)
                                            return '<div style="margin: 10px;position: relative;width: calc(100% - 85px);height: 100%;" ondblclick="doQtPer1($(this))">'+
                                                '<div style="display: inline-block;position: relative;" class="dech" deUrl="' + deUrl + '">' + attachViewChatRecord(fileArr, '', '4', '0', '1', '0') + '</div>'+'<div class="jsonstring">'+ str_json +'</div>'+
                                                '</div>'
                                        }
                                    }
                                }
                                ...
                                if(JSON.stringify(arr[i].file) == "{}"){
                                    ...
                                    if(arr[i].file.thumbnail_url !=undefined){
                                        ...
                                        if(arr[i].file.file_name){
                                            ...
                                            fileArr.push(arr[i].file)
                                            return '<div style="margin: 10px;position: relative;width: calc(100% - 85px);height: 100%;" ondblclick="doQtPer1($(this))">'+
                                                '<div style="display: inline-block;position: relative;" class="dech" deUrl="' + deUrl + '">' + attachViewChatRecord(fileArr, '', '4', '0', '1', '0') + '</div>'+
                    ...
                    for(var i=0;i<json.obj.length;i++){
                        if(data[i].content !=undefined){
                            ...
                            if(data[i].file.file_name){
                                var deUrl = data[i].file.file_url+"&FILESIZE="+size;
                                var fileArr = [];
                                fileArr.push(data[i].file)
