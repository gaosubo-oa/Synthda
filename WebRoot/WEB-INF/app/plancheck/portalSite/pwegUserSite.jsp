...
<head>
    ...
    <style>
        ...
        .layui-tab-brief>.layui-tab-more li.layui-this:after, .layui-tab-brief>.layui-tab-title .layui-this:after{
            border-bottom:2px solid #3393FC
        }
                ...
                <div class="layui-card" style="height: 100%;">
                    <div class="layui-card-header">
                        ...
                        <span style="float: right">
                           <i class="layui-icon layui-icon-right" style="color: #3393FC"></i>
                            </span>
                        ...
                        <div class="layui-row" style="height: 100%;">
                            ...
                            <div class="layui-col-xs6" style="height: 100%; padding-left: 7px;">
                                <a href="javascript:;" class="main_news ">
                                    <h4 style="font-size: 20px" title='龙岗项目三获深圳市"双优工地"称号'>龙岗项目三获深圳市"双优工地"称号</h4>
                                    <p style="font-weight: 100">中国之治，经国序民，正其制度。制度优势是一个国家的最大优势，我国国家治理体系和治理能力是中国特色社会主义制度及其执行能力的集中体现。读懂“中国之治”，坚持和完善中国特色社会主义制度、推进国家治理体系和治理能力现代化，是关系党和国家事业兴旺发达、国家长治久安、人民幸福安康的重大问题。2020年1月2日起，人民网推出《中国之治》栏目，围绕政治、经济、社会、文化等多重维度，学习宣传党的十九届四中全会精神，聚焦“中国之治”，解析发展背后的“中国密码”。</p>
                                </a>
                                <div class="news_module" style="height: calc(90% - 130px);">
                                    <div class="news_box">
                                        <ul class="news_list">
                                            <li class="list_item">
                    ...
                    <div class="layui-card-body" style="height: calc(100% - 43px); box-sizing: border-box;">
                        <div class="news_module">
                            <div class="news_box">
                                <ul class="news_list">
                                    <li class="list_item">
                                        <a href="javascript:;" title="【电建时评】致敬平凡 成就非凡">
                                            <span class="news_title">【电建时评】致敬平凡 成就非凡</span>
                                            <span class="news_date">4-30</span>
                                        </a>
                                    </li>
                                    <li class="list_item">
                                        <a href="javascript:;" title="【电建时评】致敬平凡 成就非凡">
        ...
        <div class="section">
            <div class="section_item" style="width: 48%">
                <div class="layui-card" style="height: 100%;">
                    <div class="layui-card-header">
                        <h4 class="con_item_title" style="font-size: 14px">
                            <i class="icon title_icon layui-icon layui-icon-template-1" style="color: #3393FC"></i>工作子任务 <i class="layui-icon layui-icon-more-vertical" style="color: #3393FC"></i>个人绩效
                        </h4>
                        <span style="float: right">
                           <i class="layui-icon layui-icon-right" style="color: #3393FC"></i>
                            </span>
                    ...
                    <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                        <ul class="layui-tab-title" style="height: 30%">
                            <li class="layui-this">每日完成</li>
                            <li>主责计划</li>
                            <li>协作计划</li>
                            <li>分管领导分配计划</li>
                            <li>运营分配计划</li>
                    ...
                    <div class="layui-card-body" style="height: calc(87% - 43px); box-sizing: border-box;">
                        <div class="news_module">
                            <div class="news_box">
                                <ul class="news_list">
                                    <li class="list_item">
                                ...
                                <ul class="news_list">
                                    <li class="list_item">
                                        <a href="javascript:;" title="关于做好公司人力资源管理系统...">
                                            <span class="news_title"><i class="layui-icon layui-icon-circle-dot" style="color: #3393FC;font-size: 10px;margin-right: 5px"></i>关于做好公司人力资源管理系统...</span>
            ...
            <div class="section_item" style="width: 25%">
                <div class="layui-card" style="height: 100%;">
                    <div class="layui-card-header">
                        <h4 class="con_item_title" style="font-size: 14px">
                            <i class="icon title_icon layui-icon layui-icon-template-1" style="color: #3393FC"></i>公司发文<i class="layui-icon layui-icon-more-vertical" style="color: #3393FC"></i>公司收文
                        </h4>
                        <span style="float: right">
                           <i class="layui-icon layui-icon-right" style="color: #3393FC"></i>
                            </span>
                    ...
                    <div class="layui-card-body" style="height: calc(100% - 43px); box-sizing: border-box;">
                        <div class="news_module">
                            <div class="news_box">
                                <ul class="news_list">
                                    <li class="list_item">
                                        <a href="javascript:;" title="关于启用“中电建生态环境集团...">
                                            <span class="news_title"><i class="layui-icon layui-icon-rate-solid" style="color: #3393FC;font-size: 10px;margin-right: 5px"></i>关于启用“中电建生态环境集团...</span>
                                            <span class="news_date">2019-10-28</span>
                                        </a>
                                    </li>
                                    <li class="list_item">
                                        <a href="javascript:;" title="关于启用“中电建生态环境集团...">
