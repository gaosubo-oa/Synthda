        ...
        <div class="section">
            <div class="section_item" style="width: 48%">
                <div class="layui-card" style="height: 100%;">
                    <div class="layui-card-header">
                        <h4 class="con_item_title" style="font-size: 14px">
                            <i class="icon title_icon layui-icon layui-icon-template-1" style="color: #3393FC"></i>项目进展 <i class="layui-icon layui-icon-more-vertical" style="color: #3393FC"></i>关注指标
                        </h4>
                        <span style="float: right">
                <i class="layui-icon layui-icon-right" style="color: #3393FC"></i>
                </span>
