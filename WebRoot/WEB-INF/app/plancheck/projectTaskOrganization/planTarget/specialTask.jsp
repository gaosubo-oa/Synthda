		...
		<div class="container">
			...
			<%--	<div class="layui-form-item layui-col-xs2">
				...
				<div class="layui-col-xs2 query_button_group" style="display: none;">
					<button type="reset" class="layui-btn layui-btn-sm query_button">重置</button>
...
<%--					{{#  } }}--%>
		...
		<script type="text/javascript">
            ...
            // 初始化页面
            function init() {
                layui.use(['form', 'eleTree', 'laydate', 'table'], function () {
                    var form = layui.form,
                    ...
                    function tableShow(projOrgId) {
                        insTb = table.render({
                            elem: '#demoTreeTb',
                            url: '/projectTarget/targetByDept?planType=04',
                            page: true,
							limit: 50,
                    ...
                    function addOrEdit(type, data) {
                        ...
                        if (type === 1) {
                            title = '新增关键任务';
                            url = '/projectTarget/add?deptOrProject=1&planType=04';
                        } else if (type === 2) {
                            title = '编辑关键任务';
                            url = '/projectTarget/updatePlus?planType=04';
                        }
			                            ...
			                            '<div class="layui-row">' +
			                                ...
			                                '<div class="layui-col-xs6">' +
			                                    '<div class="layui-form-item">' +
					                                ...
					                                '<div class="layui-input-block">' +
					                                    '<input type="text" name="planClass" readonly autocomplete="off" class="layui-input" value="重大专项任务" style="background:#e7e7e7;">' +
					                                '</div>' +
			                                    '</div>' +
		                                    '</div>' +
		                                '</div>' +
