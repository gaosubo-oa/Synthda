    ...
    <div class="header">
        <div class="headImg" style="padding-top: 10px">
					<span style="font-size:22px;margin-left:10px;color:#494d59;margin-top: 2px"><img
                            ...
                            style="margin-left: 10px">计划上报</span></span>
        </div>
    </div>
    <hr>
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content" style="padding: 0px 8px">
            <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                <ul class="layui-tab-title">
                    <li class="layui-this">未上报计划(3)</li>
                    <li>已上报计划(3)</li>
                </ul>
                <div class="layui-tab-content" style="padding: 0px 8px">
                    <div class="layui-tab-item layui-show">
                        <form class="layui-form" action="">
                            <div class="query" style="display: flex">
                                ...
                                <div class="layui-form-item inputs">
                                    <label class="layui-form-label" style="margin-top: -5px; width: 50px;">年度:</label>
                                    <div class="layui-input-block" style=" margin-left: 85px;">
                                        <input type="text" id="year" name="title" required
                                               lay-verify="required" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item inputs">
                                    <label class="layui-form-label" style="margin-top: -5px; width: 50px;">月度:</label>
                                    <div class="layui-input-block" style=" margin-left: 85px;">
                                        <input type="text" id="month" name="title" required
                                               lay-verify="required" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
...
<script type="text/html" id="barDemo">
    <div style="position:absolute;right: 1%">
        <a class="layui-btn layui-btn-sm rep" lay-event="rep">上报</a>
    </div>
</script>
<script type="text/html" id="childDemo">
    <div>
        <span><i class="layui-icon layui-icon-next" style="color: green"></i><span class="titleSp"></span></span>
