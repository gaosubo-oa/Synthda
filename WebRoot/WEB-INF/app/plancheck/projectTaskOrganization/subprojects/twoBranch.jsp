...
<body>
    ...
    <script>
        var dictionaryObj = {WORKAREA_NAME: {}, PBAG_TYPE: {}, CUSTOMER_UNIT: {}}
        var dictionaryStr = 'WORKAREA_NAME,PBAG_TYPE,CUSTOMER_UNIT'
        var CUSTOMER_UNIT=''
        // 获取数据字典数据
        $.ajax({
        ...
        layui.use(['form','laydate','table'], function(){
            ...
            tableIns=table.render({
                elem: '#demo'
                ,url: '/plcProjectBag/seconed?projectId='+$.GetRequest().projectId+'&_='+new Date().getTime() //数据接口
                ,toolbar: '#toolbarDemo'
                ,defaultToolbar:['']
                ,cols: [[ //表头
                    {type: 'numbers',title: '序号', }
                    ,{field: 'bagNumber', title: '子项目编号',width:150 }
                    ,{field: 'pbagName', title: '子项目名称',width:280,event: 'detail', style:'color:blue',templet: function(d){
                           /* if(dictionaryObj['WORKAREA_NAME']['object'][d.pbagName]){
                            ...
                            return '<span  class="pbagName" ids="'+d.ids+'">'+ d.pbagName +'</span>'
                        } }
            ...
            function creat(type,data) {
                ...
                layer.open({
                    ...
                    btn:['保存','保存并新增','取消'],
                    content: '<form class="layui-form" id="form" style="margin-right:30px" lay-filter="formTest">\n' +
                        '        <%--第一行--%>\n' +
                        '        <div class="layui-row" style="margin-top:15px">\n' +
                        '            <div class="layui-col-xs6">\n' +
                        '                <div class="layui-form-item">\n' +
                        '                    <label class="layui-form-label">工区名称<span style="color:red;font-size: 25px;vertical-align: middle;">*</span></label>\n' +
                        '                    <div class="layui-input-block">\n' +
                        '                        <select name="pbagName" class="testNull" title="工区名称" lay-verify="required">\n' +
                        '                        </select>\n' +
                        '                    </div>\n' +
                        '                </div>\n' +
                        '            </div>\n' +
                        '            <div class="layui-col-xs6">\n' +
                        '                <div class="layui-form-item">\n' +
                        '                    <label class="layui-form-label">工区编号<span style="color:red;font-size: 25px;vertical-align: middle;">*</span></label>\n' +
                        '                    <div class="layui-input-block">\n' +
                        '                        <input type="text" name="bagNumber" style="background: #e7e7e7;" readonly title="工区编号"  required  lay-verify="required"  autocomplete="off" class="layui-input testNull">\n' +
                        '                    </div>\n' +
                        '                </div>\n' +
                        '            </div>\n' +
                        '        </div>\n' +
                        ...
                        '            <div class="layui-col-xs6">\n' +
                        '                <div class="layui-form-item">\n' +
                        '                    <label class="layui-form-label">工区项目经理<span style="color:red;font-size: 25px;vertical-align: middle;">*</span></label>\n' +
                        '                    <div class="layui-input-block">\n' +
                        '                        <input type="text" name="dutyUser" required title="工区项目经理"  lay-verify="required"  autocomplete="off" class="layui-input testNull">\n' +
                        '                    </div>\n' +
                        '                </div>\n' +
                        '            </div>\n' +
                        '            <div class="layui-col-xs6">\n' +
                        '                <div class="layui-form-item">\n' +
                        '                    <label class="layui-form-label">工区项目经理电话<span style="color:red;font-size: 25px;vertical-align: middle;">*</span></label>\n' +
                        '                    <div class="layui-input-block">\n' +
                        '                        <input type="number" name="dutyUserTel" title="工区项目经理电话" required  lay-verify="required"  autocomplete="off" class="layui-input testNull">\n' +
                        '                    </div>\n' +
                        '                </div>\n' +
                        '            </div>\n' +
                        '        </div>\n' +
                        ...
                        '            <div class="layui-col-xs6">\n' +
                        '                <div class="layui-form-item">\n' +
                        '                    <label class="layui-form-label">工区类型<span style="color:red;font-size: 25px;vertical-align: middle;">*</span></label>\n' +
                        '                    <div class="layui-input-block">\n' +
                        '                        <select name="pbagType" class="testNull" title="工区类型" lay-verify="required">\n' +
                        '                        </select>\n' +
                        '                    </div>\n' +
                        '                </div>\n' +
                        '            </div>\n' +
                        ...
                        '                    <div class="layui-input-block">\n' +
                        '                        <input type="text" name="planBeginDate" title="计划开始时间" id="planBeginDate" required  lay-verify="required"  autocomplete="off" class="layui-input testNull">\n' +
                        '                    </div>\n' +
                        '                </div>\n' +
                        '            </div>\n' +
                        '        </div>\n' +
                        ...
                        '                    <div class="layui-input-block">\n' +
                        '                        <input type="text" name="planEndDate" title="计划结束时间" id="planEndDate" required  lay-verify="required"  autocomplete="off" class="layui-input testNull">\n' +
                        '                    </div>\n' +
                        '                </div>\n' +
                        '            </div>\n' +
                        '            <div class="layui-col-xs6">\n' +
                        ...
                        '                    <div class="layui-input-block">\n' +
                        '                        <input type="text" name="planPeriod" style="background: #e7e7e7;" title="计划工期" readonly required  lay-verify="required"  autocomplete="off" class="layui-input testNull">\n' +
                        '                    </div>\n' +
                        '                </div>\n' +
                        '            </div>\n' +
                        '        </div>\n' +
                        ...
                        '                    <div class="layui-input-block">\n' +
                        /*'                        <select name="buildUnit" class="testNull" title="设计单位" lay-verify="required">\n' +
                        '                        </select>\n' +*/
                        ...
                        '    <div class="layui-input-block ">\n' +
                        '      <input type="number" name="buildUnitUser"  autocomplete="off" class="layui-input" title="施工单位负责人及电话">\n' +
                        '    </div>\n' +
                        '                </div>\n' +
                        '            </div>\n' +
                        '        </div>\n' +
                        ...
                        '                    <div class="layui-input-block">\n' +
                        /* '                        <select name="designUnit" class="testNull" title="设计单位" lay-verify="required">\n' +
                         '                        </select>\n' +*/
                        ...
                        '    <div class="layui-input-block">\n' +
                        '      <input type="number" name="designUnitUser"  autocomplete="off" class="layui-input" title="设计单位负责人及电话">\n' +
                        '    </div>\n' +
                        '  </div> </div>'+
                        '        </div>\n' +
                        '        <%--第六行--%>\n' +
                        ...
                        '                    <div class="layui-input-block">\n' +
                       /* '                        <select name="purchaseUnitUser" title="采购单位" class="testNull" lay-verify="required">\n' +
                        '                        </select>\n' +*/
                        ...
                        '            <div class="layui-col-xs6">\n' +
                        '                <div class="layui-form-item">\n' +
                        '                    <label class="layui-form-label">是否预算控制<span style="color:red;font-size: 25px;vertical-align: middle;">*</span></label>\n' +
                        '                    <div class="layui-input-block">\n' +
                    ...
                    success:function () {
                        ...
                        if(type==0){
                            //编号
                            $.get('/ProjectInfo/getMaxNo',{model:'plcProjectBag',projectInfoNo:$.GetRequest().projectInfoNo,level:2},function (res) {
                                $('form input[name="bagNumber"]').val(res)
                            })
                        }
                        $('select[name="pbagName"]').append(dictionaryObj['WORKAREA_NAME']['str'])
                        ...
                        var min=window.parent.document.getElementById('plan_time').getAttribute('minTime')
                        var max=window.parent.document.getElementById('plan_time').getAttribute('maxTime')
                        // 初始化计划开始时间
