...
<script>
    ...
    layui.use(['treeTable', 'table', 'layer', 'form', 'element', 'laydate', 'upload',], function () {
        ...
        var projectTable = table.render({
            elem: '#project'
            // ,url:  '/ProjectInfo/selectProjectOrgId?projectStatus='+projectStatus
            , url: '/ProjectInfo/ProjectCloseSearch'
            ...
            , cols: [[ //表头
                ...
                // , {field: 'respectiveRegionName', title: '所属单位', width: 150, align: 'center'}
