...
<div >
   <%-- <div class="headImg" style="padding-top: 10px">
        <span style="font-size:22px;margin-left:10px;color:#494d59;margin-top: 2px"><img style="margin-left:1.5%" src="../img/commonTheme/theme6/icon_summary.png" alt=""><span  class="headTitle" style="margin-left: 10px">组织机构</span></span>
    </div>
    <hr>--%>
       <%-- <div class="query layui-row layui-form" style="margin-top: 12px">
            <div class="layui-col-xs2">
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 112px;">总承包部名称：</label>
                    <div class="layui-input-block">
                        <input style="height: 35px" type="text" id="contractingName" name="title" required  lay-verify="required" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
            <div class="layui-col-xs2">
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 100px;">机构类型：</label>
                    <div class="layui-input-block">
                        <select  name="orgnizeType" id="institutionalType" class="orgnizeType" lay-verify="required" >
            ...
            <div class="layui-col-xs2">
                <div class="layui-form-item inputs">
                    ...
                    <div class="layui-input-block" style="width: 170px;">
                        <select  name="deptId" id="affiliatedUnit" class="deptName" lay-verify="required">
                            <option value="">请选择</option>
                        </select>
                    </div>
                </div>
            ...
            <div class="layui-col-xs2" style="width: 16%">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" style="margin-left: 65px">
                        <input style="height: 35px" type="text" id="site" name="deptId" required  lay-verify="required" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
            <div class="layui-col-xs2" style="text-align: right">
                <button type="button" class="layui-btn layui-btn-sm search" style="margin-left: 20px" id="querys">查询</button>
                <button type="reset" class="layui-btn layui-btn-sm clear" style="margin-left: 20px;" id="resets">重置</button>
                <button button type="button" class="layui-btn layui-btn-sm"  style="margin-left: 20px;margin-right: 25px">
...
<%--                <input type="hidden" id="deptId">--%>
            ...
            <div class="eleTree ele1" style="margin-top: 10px;height: 650px;overflow-x: auto;" lay-filter="organizationLeft"></div>
        </div>
        <div class="con_right">
                ...
                <form class="rightContent layui-form" style="display: none" lay-filter="rightContent">
                    <div class="layui-row" style="margin-top: 5%">
                        <div class="layui-col-xs6">
                            <div class="layui-form-item">
                                <label class="layui-form-label">组织类型<span style="color:red;font-size: 25px;vertical-align: middle;">*</span></label>
                                <div class="layui-input-block">
                        ...
                        <div class="layui-col-xs6">
                            <div class="layui-form-item principalUser_select" style="display: none;">
                                <label class="layui-form-label">组织负责人<span style="color:red;font-size: 25px;vertical-align: middle;">*</span></label>
                                <div class="layui-input-block">
                            ...
                            <div class="layui-form-item principalUser_text" style="display: none;">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" style="background-color: #e7e7e7;" readonly id="principalUser" class="layui-input testNull" title="组织负责人" class="layui-input">
                                </div>
...
<%--                                </div>--%>
                                <div class="layui-input-inline">
                                    <input type="text" style="background-color: #e7e7e7;" readonly id="planUser" class="layui-input testNull" title="上级单位审核" class="layui-input">
                                </div>
...
<%--                                </div>--%>
                                <div class="layui-input-inline">
                                    <input type="text" style="background-color: #e7e7e7;" readonly id="budgetUser" class="layui-input testNull" title="分管领导审核" class="layui-input">
                                </div>
...
<%--                    </div>--%>
                    <div class="layui-row">
                        <div class="layui-col-xs6">
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 140px;padding: 9px 5px">无需参与考核人员</label>
                                <div class="layui-input-block">
                                    <div class="layui-input-inline">
                                        <input type="text" style="background-color: #e7e7e7;" readonly id="noAssessUser" class="layui-input testNull" title="无需参与考核人员" class="layui-input">
                                    </div>
                                    <div style="float: left; margin-top: 20px;" t_id="noAssessUser">
                        ...
                        <div class="layui-col-xs6">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <div class="layui-input-inline">
                                        <input type="text" style="background-color: #e7e7e7;" readonly id="assessmentTeamUsers" class="layui-input testNull" title="考核小组人员" class="layui-input">
                                    </div>
...
<script>
    ...
    layui.use(['form','eleTree'], function(){
        ...
        function leftShow() {
            insTree =eleTree.render({
                elem: '.ele1',
                url:'/plcOrg/selectAll?'+'&_='+new Date().getTime(),
        ...
        eleTree.on("nodeClick(organizationLeft)",function(d) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $.get('/plcOrg/queryId', {projOrgId: data.projOrgId}, function (res) {
                        ...
                        $('#noAssessUser').val(res.object.noAssessUserName || '');
                        $('#noAssessUser').attr('user_id', res.object.noAssessUser || '');
        ...
        $('.save').on("click",function () {
            ...
            var noAssessUser = $('#noAssessUser').attr('user_id') || '';
            if ($('.principalUser_select').is(":hidden")) {
            ...
            var params={
                ...
                noAssessUser:noAssessUser
            }
            $.post('/plcOrg/update',params,function (res) {
                if(res.flag){
        ...
        $('#del').on("click",function () {
            ...
            layer.confirm('确定删除'+'&nbsp;&nbsp;'+$('#isDisable').attr('names')+'&nbsp;&nbsp;'+'吗？', function(index){
                $.post('/plcOrg/delete',{projOrgId:projOrgId},function (res) {
                    if(res.flag){
        ...
        $('#edit').on("click",function () {
            ...
            layer.open({
                ...
                yes:function (index, layero) {
                    $.post('/plcOrg/update',{projOrgId:projOrgId,contractorName:$('input[name="contractorName"]').val()},function (res) {
                        if(res.flag){
    ...
    function importLeft(deptIds) {
        if (importFlag) {
            $.post('/plcOrg/inserts', {deptIds: deptIds}, function (res) {
                if (res.flag) {
