...
<body>
    ...
    <script>
        ...
        //获取父页面的左侧所选部门
        if(parent.$('#leftId').attr('contractorName') && parent.$('#leftId').attr('deptId')){
            $('#mainCenterDept').val(parent.$('#leftId').attr('contractorName'))
            $('#mainCenterDept').attr('deptId',parent.$('#leftId').attr('deptId'))
        }
        // console.log(leftArr)
        layui.use(['eleTree','form','element'], function(){
            ...
            function projectLeft() {
                eleTree.render({
                    ...
                    response: {
                     ...
                     /*   var con_right=$(window).width()-$('.con_left').width()-70
                    ...
                    success: function (res) {
                        if(res.flag){
                            ...
                            for(var i=0;i<data.length;i++){
                                ...
                                str+='<div class="layui-input-block" style="margin-left: 20px"><input lay-filter="leftTarget" type="radio" name="relationTarget" title="'+res.obj[i].tgName+'" value="'+res.obj[i].tgId+'" lay-skin="primary"> </div>'
                            }
                            $('.con_right').html(str)
                            form.render()
                            //选中的回显
            ...
            //主项-查询
            $('.mainLeftQuery .queryTarget').on('click',function () {
            ...
            //职能-查询
            $('.mainRightQuery .queryTarget').on('click',function () {
