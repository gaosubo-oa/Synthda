...
<div class="container">
    <div class="header">
        <div class="headImg" style="padding-top: 10px">
            <span style="font-size:22px;margin-left:10px;color:#494d59;margin-top: 2px"><img style="margin-left:1.5%" src="../img/commonTheme/theme6/icon_summary.png" alt=""><span style="margin-left: 10px">专项分配计划</span></span>
        </div>
    </div>
    <hr>
    <%--筛选查询--%>
            ...
            <div class="layui-card-body clearfix">
                <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                    <ul class="layui-tab-title">
                        <li class="layui-this">专项计划关键任务</li>
                        <li>专项计划子任务</li>
                    </ul>
