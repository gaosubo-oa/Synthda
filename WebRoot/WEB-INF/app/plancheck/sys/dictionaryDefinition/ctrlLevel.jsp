            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div style="line-height: 38px;">
                        ...
                        <span id="title" style="    font-size: 14pt;vertical-align: middle">控制级次</span>
                    </div>
...
<script>
    ...
    layui.use(['table','layer','laydate','form','element','eleTree'], function(){
        ...
        var tableObj=table.render({
            ...
            ,data:[{data1:'顶层关注',data2:'',data3:''},
                {data1:'一级',data2:'',data3:''},
                {data1:'二级',data2:'',data3:''},
                {data1:'三级',data2:'',data3:''}]
            ,toolbar:'#toolbar'
            ,cols: [[ //表头
                {type: 'numbers', title: '序号',width:60}
                ,{field: 'data1', title: '计划阶段名称'}
