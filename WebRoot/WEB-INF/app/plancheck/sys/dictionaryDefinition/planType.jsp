            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div style="line-height: 38px;">
                        ...
                        <span id="title" style="    font-size: 14pt;vertical-align: middle">计划类别</span>
                    </div>
...
<script>
    ...
    layui.use(['table','layer','laydate','form','element','eleTree'], function(){
        ...
        var tableObj=table.render({
            ...
            ,data:[{data1:'工程类',data2:'',data3:''},
                {data1:'设计类',data2:'',data3:''},
                {data1:'经营类',data2:'',data3:''},
                {data1:'资金类',data2:'',data3:''},
                {data1:'招采类',data2:'',data3:''},
                {data1:'商务类',data2:'',data3:''},
                {data1:'财务类',data2:'',data3:''},
                {data1:'信息化类',data2:'',data3:''}]
            ,toolbar:'#toolbar'
            ,cols: [[ //表头
