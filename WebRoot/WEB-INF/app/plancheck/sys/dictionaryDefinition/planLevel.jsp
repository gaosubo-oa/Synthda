            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div style="line-height: 38px;">
                        ...
                        <span id="title" style="    font-size: 14pt;vertical-align: middle">计划级次</span>
                    </div>
...
<script>
    ...
    layui.use(['table','layer','laydate','form','element','eleTree'], function(){
        ...
        var tableObj=table.render({
            ...
            ,data:[{data1:'一级',data2:'',data3:'',data4:'1'},
                {data1:'二级',data2:'',data3:'',data4:'1.1'},
                {data1:'三级',data2:'',data3:'',data4:'1.1.1'},
                {data1:'四级',data2:'',data3:'',data4:'1.1.1.1'}]
            ,toolbar:'#toolbar'
            ,cols: [[ //表头
                {type: 'numbers', title: '序号',width:60}
                ,{field: 'data1', title: '计划级次名称'}
                ,{field: 'data4', title: '计划级次表现形式'}
