				...
				<template v-if="planInfo">
					<div class="con_header">
						<van-row type="flex" justify="space-between" style="height: 100%;">
							<template v-if="!planInfo.taskApproval || planInfo.taskApproval == 1">
                ...
                methods: {
	                ...
	                backClick: function () {
                        ...
                        $.post('/plcPlan/updatePlcPlan', data, function (json) {
                            if (json.flag) {
                                $.post('/plcPlan/updateStatusByIds', {planIds: _this.planId, taskApproval: 3,secondApprovalDate: today}, function (res) {
                                    toastIndex.close()
                                    if (res.flag) {
                                        _this.$notify({
