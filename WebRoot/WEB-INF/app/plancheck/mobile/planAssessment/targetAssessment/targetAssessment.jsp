	...
	<body>
				...
				<div class="con_header">
					<van-row style="height: 100%;">
						<van-col span="24" style="height: 100%;" v-if="targetInfo">
							<span class="plan_head" v-text="targetInfo.tgName"></span>
						</van-col>
					</van-row>
				</div>
				<div class="con_body">
					<van-form ref="sheetForm" v-if="targetInfo">
						...
						<div style="margin: 16px; text-align: center;" v-if="socoreInfo.apprivalStatus == 0">
		...
		<script>
            let app = new Vue({
                ...
                data: {
                    scoreId: '',
                    dictionaryStr: 'TG_TYPE,CGCL_TYPE,UNIT,CONTROL_LEVEL,PLAN_SYCLE',
                    dictionaryObj: {
                        TG_TYPE: {},
                        CGCL_TYPE: {},
                        UNIT: {},
                    ...
                    getListData: function () {
                        ...
                        $.get('/PlcAssessScore/findAssessmentDataByScoreId', {scoreId: _this.scoreId}, function (res) {
                            if (res.flag) {
                                ...
                                _this.formModule.qualityScore = res.data.qualityScore || ''
                                _this.formModule.taskPrecess = res.data.taskPrecess || ''
                                _this.formModule.apprivalComment = res.data.apprivalComment || ''

                                _this.socoreInfo = res.data

                                $.get('/ProjectDaily/selectProjectDailyByItemId', {tgId: res.data.tgId}, function (json) {
                                    if (json.flag) {
