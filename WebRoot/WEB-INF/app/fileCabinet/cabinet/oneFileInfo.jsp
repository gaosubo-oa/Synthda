...
<head>
    ...
    <script src="/js/base/base.js?20220402.1"></script>
    <script src="/lib/laydate/laydate.js"></script>

    <script src="../lib/pagination/js/jquery.pagination.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="../js/jquery/jquery.form.min.js"></script>
    <script src="/js/jquery/jquery.cookie.js"></script>
    <script src="/js/attachment/attachView.js?20221020" type="text/javascript" charset="utf-8"></script>
    <style>
    ...
    <div class="cabinet_info"  style="width:calc(100% - 20%)">
        ...
        <div class="mainContent" style="display:none;">
            ...
            <div class="head w clearfix">
                ...
                <div class="ss selected" id="one_selected" style="display: block;margin-right: 12px;">
...
<script>
    ...
    function reloadTree(id) {
        $('#li_parent').tree({
            url: '/newFilePub/getPubSort?sortId='+id,
            animate:true,
            lines: false,
            loadFilter: function(rows){
                var arr = convert(rows.data || rows.datas);
                return arr;
            },
    ...
    function convert(data){
        ...
        if(typeof data == "object" && !data.length) {
            if(data.sortName){
                var node = new TreeNode(data.sortId,data.sortName,"closed")
                arr.push(node);
            }
...
//    渲染数据
    ...
    $('#contentAdd').click(function(){
        ...
        $.popWindow('/newFilePub/newFiles?sortId='+sortId+'&text='+encodeURI(sortText)+'&idea='+idea,'<fmt:message code="global.lang.new"/>','100','300','960px','700px');
    })
    //全选点击事件
    ...
    $('.fileCabinet').on('click','.TITLE',function(){
        ...
        $.popWindow('/newFilePub/fileDetail?contentId='+idT+'&sortId='+sortId+'&deleteNum='+deleteNum+'&exportNum='+exportNum+'&editNum='+editNum+'&riderNum='+riderNum+'&reviewNum='+reviewNum,'<fmt:message code="file.th.detail"/>','100','150','1000px','500px');
    ...
    $('#file_Tach').on('click','.editBtn',function(){
        ...
        var idea=$('input[name="folderId"]').attr('ireader');
        $.popWindow('/newFilePub/newFiles?contentId='+idT+'&sortId='+sortId+'&contype='+contype+'&idea='+idea,'<fmt:message code="global.lang.edit"/>','0','0','1500px','800px');
    })
    //查询-签阅情况点击事件
