...
<div class="main" style="padding: 20px 20px;background-color: #fff;">
    ...
    <div>
        <%--表格内容--%>
        <table id="subapproOld" lay-filter="subapproOld"></table>
    </div>
</div>
<script type="text/javascript">
    ...
    layui.use(['laydate', 'table', 'layer', 'form', 'eleTree', 'element'], function () {
        ...
        var tabInit = table.render({
            elem: '#subapproOld'
            ,url:'/subscribe/getOldByFildAndCustomer?customerId='+customerId+"&fileId="+fileId
            ...
            ,cols: [[
                ...
                // ,{field:'browseBDate', title:'浏览开始日期'}
                // ,{field:'browseEDate', title:'浏览结束日期'}
                // ,{field:'downloadBDate', title:'下载开始日期'}
                // ,{field:'downloadEDate', title:'下载结束日期'}
