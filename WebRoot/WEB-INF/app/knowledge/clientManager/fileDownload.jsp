...
<%--&lt;%&ndash;                                <option value="docfileNo">文档编号</option>&ndash;%&gt;--%>
<%--                                <option value="docfileName">文档名称</option>--%>
<%--                                &lt;%&ndash;                            <option value="docfileClass">文档等级</option>&ndash;%&gt;--%>
<%--                                <option value="keyWord">关键词</option>--%>
<%--                                &lt;%&ndash;                            <option value="createUserId">上传人</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                            <option value="serchTime">上传时间</option>&ndash;%&gt;--%>
...
<%--                            &lt;%&ndash;                        <a class="layui-btn" data-type="reload" lay-event="adSearch" id="adSearch" style="float:left;height:32px;line-height: 32px;margin-left: 10px" >高级搜索</a>&ndash;%&gt;--%>
<%--                        </div>--%>
<%--                    </div>--%>
<%--                </form>--%>
<%--            </div>--%>
...
<script type="text/javascript">
    ...
    layui.use(['table','layer','form','laydate','element','eleTree','upload'], function() {
        ...
        layui.table.render({
            ...
            ,url:'/knowledge/getFileByKey?fileKey='+fileKey
            ,page:true
            //, data: res.data
            , cols: [[ //表头
