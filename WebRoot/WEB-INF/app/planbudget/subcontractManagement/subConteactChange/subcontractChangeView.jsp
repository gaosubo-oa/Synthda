...
<script>
    ...
    var _html = ['<div class="layui-collapse">\n',
        ...
        '                       <label class="layui-form-label form_label">单据号<span class="field_required">*</span><a title="刷新编号" class="refresh_no_btn"><i class="layui-icon layui-icon-refresh"></i></a></label>\n' +
