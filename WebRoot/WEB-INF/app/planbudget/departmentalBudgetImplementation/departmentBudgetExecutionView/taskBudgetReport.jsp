...
<div class="container">
    ...
    <div class="wrapper">
        <div class="wrap_left">
            <h2 style="text-align: center;line-height: 35px;">职能关键任务预算报表</h2>
            <div class="left_form">
            ...
            <div class="query_module layui-form layui-row" style="position: relative">
                ...
                <div class="layui-col-xs3">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="deptId" id="deptId" placeholder="费用承担部门" readonly style="background: #e7e7e7" autocomplete="off" class="layui-input deptAdd">
                        </div>
                    </div>
                </div>
...
<script>
    ...
    var colShowObj = {
        ...
        settleupMoney: {field: 'settleupMoney', title: '已支付金额', sort: true, hide: false,templet: function (d) {
                return d.settleupMoney || 0
            }},
        approvedPaid: {field: 'approvedPaid', title: '已审批金额', sort: true, hide: false},
        payedMoney: {field: 'payedMoney', title: '剩余预算额度', sort: true, hide: false},
    ...
    layui.use(['form', 'table', 'soulTable', 'eleTree','element','laydate','xmSelect'], function () {
                    ...
                    success: function () {
                        ...
                        function laodTable(deptItemId, deptId) {
                            layTable.render({
                                ...
                                cols: [[
                                    {field: 'manageTarPrice', title: '单据编号',width:120},
                                    {field: 'manageTarNum', title: '经办人',width:120},
                                    {field: 'manageTarAmount', title: '报销人',width:120},
                                    {field: 'addupNeedAmount', title: '编制时间',width:170},
                                    {field: 'addupNeedMoney', title: '付款金额',cellMinWidth:170},
                                ]]
                            });
                        }
                    },
        ...
        $('.searchData').on('click',function () {
            ...
            searchParams.deptId=$('#deptId').attr('deptid') ? $('#deptId').attr('deptid').replace(/,$/, '') : ''
