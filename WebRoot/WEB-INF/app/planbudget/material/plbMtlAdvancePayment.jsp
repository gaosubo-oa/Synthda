...
<div class="container">
    ...
    <div class="wrapper">
        <div class="wrap_left">
            <h2 style="text-align: center;line-height: 35px;">材料预付款</h2>
            <div class="left_form">
        ...
        <div class="wrap_right">
            <div class="query_module layui-form layui-row" style="position: relative">
                <div class="layui-col-xs2">
                    <input type="text" name="mtlPaymentNo" placeholder="预付款编号" autocomplete="off" class="layui-input">
                </div>
...
<script>
    ...
    layui.use(['form', 'laydate', 'table', 'element', 'soulTable', 'eleTree', 'xmSelect', 'layer'], function () {
        ...
        var colShowObj = {
            ...
            //     }
            // },
            contractName:{field:'contractName',title:'合同名称',sort:false,hide:false},
            ...
            demo:{field:'demo',title:'用途',hide:false},
            ...
            switch (obj.event) {
                ...
                case 'del':
                    ...
                    layer.confirm('确定删除该条数据吗？', function (index) {
                        $.post('/plbMtlAdvancePayment/del', {ids: advanceId}, function (res) {
                            if (res.code=='0') {
                ...
                case 'submit':
                    ...
                    layer.open({
                        ...
                        success: function () {
                            $.get('/plbFlowSetting/getOwnFlowData', {plbDictNo: '51'}, function (res) {
                                var flowData = []
                ...
                case 'dayin':
                    ...
                    if(checkStatus.data[0].auditerStatus != 0){
                        ...
                        $.ajax({
                            url:'/generateDocx/generateDocxByType?runId='+runId+'&type=mtlAdvancePayment',
                            success:function(res){
                                if(res.flag){
                                    layer.close(index);
        ...
        function newOrEdit(type, data) {
            ...
            if (type == '0') {
                title = '新建材料预付款';
                url = '/plbMtlAdvancePayment/insert';
            } else if (type == '1') {
                title = '编辑材料预付款';
                url = '/plbMtlAdvancePayment/updateById';
            }else if(type == '4'){
            ...
            layer.open({
                ...
                '                       <input type="text" name="contractName" placeholder="查找合同" readonly autocomplete="off" class="layui-input chooseManagementBudget" style="padding-right: 25px;cursor: pointer;background: #e7e7e7">\n' +
                '                       </div>\n' +
                '                   </div>' +
                '               </div>' +
                '               <div class="layui-col-xs4" style="padding: 0 5px;">' +
                ...
                '               <div class="layui-col-xs4" style="padding: 0 5px;">' +
                '                   <div class="layui-form-item">\n' +
                '                       <label class="layui-form-label form_label">付款类型<span field="mtlPaymentType" class="field_required">*</span></label>\n' +
                '                       <div class="layui-input-block form_block">\n' +
                ...
                success: function () {
                    ...
                    if (type == 1 || type == 4) {
                        ...
                        // 获取自动编号
                        getAutoNumber({autoNumberType: 'mtladvancePayment'}, function(res) {
