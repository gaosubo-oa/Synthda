...
<html>
    ...
    <body>
        ...
        <script>
            ...
            var htmBox = ['<div class="layer_wrap disabledAll" id="leftId"><div class="layui-collapse">',
                /* region 材料计划 */
            ...
            var mtlContractId = $.GetRequest()['mtlContractId'] || '';
            ...
            var dictionaryStr = 'CONTRACT_TYPE,PAYMENT_METHOD,TAX_RATE,INVOICE_TYPE,COMPARE_TYPE,CBS_UNIT,CONTRACT_CATEGORY';
            $.get('/plbDictonary/selectDictionaryByDictNos', {plbDictNos: dictionaryStr}, function (res) {
                ...
                // 获取项目信息
                if (runId) {
                    $.get('/plbMtlContract/queryByRunId', {runId: runId}, function (res) {
                ...
                } else if (mtlContractId) {
                    $.get('/plbMtlContract/queryId', {mtlContractId: mtlContractId}, function (res) {
                        layer.close(loadIndex);
                        if (!res.flag)  {
                            layer.msg('获取信息失败！', {icon: 2});
                        }
            ...
            function initPage(data) {
                layui.use(['form', 'laydate', 'table', 'element', 'soulTable', 'eleTree'], function () {
                    ...
                    if (data) {
                        ...
                        $('#htmBox').attr('mtlContractId',data.mtlContractId)
                        ...
                        layTable.render({
                            ...
                            toolbar: type!=4?'#plbMtlContrastBar':false,
                            defaultToolbar: [''],
                            limit: 1000,
                            cols: [cols3]
                        });
            ...
            function childFunc(){
                ...
                var loadIndex = layer.load();
                var baseData = getSaveData(type, false, loadIndex, $('#htmBox').attr('mtlContractId'), parseInt($('#htmBox').attr('projId'))).dataObj;
