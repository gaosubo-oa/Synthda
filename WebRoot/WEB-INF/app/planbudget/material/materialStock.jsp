...
<div class="container">
    ...
    <div class="wrapper">
        <div class="wrap_left">
            <h2 style="text-align: center;line-height: 35px;">材料库存</h2>
            <div class="left_form">
        ...
        <div class="wrap_right">
            <div class="query_module layui-form layui-row" style="position: relative">
                ...
                <div class="layui-col-xs2" style="margin-left: 15px;">
                    <input type="text" name="mtlStand" placeholder="材料规格" autocomplete="off" class="layui-input">
                </div>
                <div class="layui-col-xs2" style="margin-left: 15px;">
...
<script>
    ...
    layui.use(['form', 'laydate', 'table', 'element', 'soulTable', 'eleTree', 'xmSelect'], function () {
        ...
        //表格显示顺序
        var colShowObj = {
            warehouseName: {field: 'warehouseName', title: '仓库名称',  hide: false},
            projName:{field:'projName',title:'项目名称',sort:false,hide:false},
            mtlName: {field: 'mtlName', title: '材料名称', sort: false, hide: false},
            mtlStand: {field: 'mtlStand', title: '规格', sort: false, hide: false},
            mtlValuationUnit: {field: 'mtlValuationUnit', title: '单位', sort: false, hide: false},
            stockInQuantity: {field: 'stockInQuantity', title: '库存数量', sort: false, hide: false},
            taxPeice: {field: 'taxPeice', title: '含税单价', sort: false, hide: false},
            noTaxPeice: {field: 'noTaxPeice', title: '不含税单价', sort: false, hide: false},
            taxMoney: {field: 'taxMoney', title: '含税总价', sort: false, hide: false},
            noTaxMoney: {field: 'noTaxMoney', title: '不含税总价', sort: false, hide: false}
        }

        var TableUIObj = new TableUI('plb_mtl_stock');
        ...
        function tableShow(projId) {
            ...
            tableIns = table.render({
                elem: '#tableDemo',
                url: '/stockInAnnalysis/stockAnalysis',
                toolbar: '#toolbarDemo',
                cols: [cols],
                cellMinWidth:150,
        ...
        table.on('toolbar(tableDemo)',function(obj){
            ...
            switch (layEvent) {
                case "export":
                    window.location.href='/stockInAnnalysis/stockAnalysis?projId='+projectId+'&export=export'
                    break;
            }
        })
