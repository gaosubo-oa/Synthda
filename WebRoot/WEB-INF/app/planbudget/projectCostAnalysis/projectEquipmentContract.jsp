...
<div class="container">
    ...
    <div class="wrapper">
        <div class="wrap_left">
            <h2 style="text-align: center;line-height: 35px;">设备合同结算付款情况分析表</h2>
            <div class="left_form">
            ...
            <div class="tree_module">
                <div id="leftTree" class="eleTree" lay-filter="leftTree" style="top: 35px;"></div>
            </div>
        </div>
        <div class="wrap_right">
            ...
            <div style="position: relative;top: 10px">
                <div class="table_box" >
                    ...
                    <table id="tableObj" lay-filter="parse-table-demo" class="layui-table" lay-data="{width:100%}" >
                        <thead>
                        <tr>
                            <th lay-data="{field:'sum',minWidth:100,align:'center'}" rowspan="2"></th>
                            <th lay-data="{field:'wbs',minWidth:100,align:'center'}" rowspan="2">合同编号</th>
                            <th lay-data="{field:'cbs',minWidth:100,align:'center'}" rowspan="2">合同名称</th>
                            <th lay-data="{field:'cbs',minWidth:100,align:'center'}" rowspan="2">分包商</th>
                            <th lay-data="{field:'yvsuan',minWidth:100,align:'center'}" colspan="3">合同金额</th>
                            <th lay-data="{field:'cbs',minWidth:100,align:'center'}" rowspan="2">预付款</th>
                            <th lay-data="{field:'cbs',minWidth:100,align:'center',width:150}" rowspan="2">累计已结算金额</th>
                            <th lay-data="{field:'cbs',minWidth:100,align:'center',width:150}" rowspan="2">未核销预付款</th>
                            <th lay-data="{field:'cbs',minWidth:100,align:'center',width:150}" rowspan="2">累计已付款金额</th>
                            <th lay-data="{field:'cbs',minWidth:100,align:'center'}" rowspan="2">付款时间</th>
                            <th lay-data="{field:'cbs',minWidth:100,align:'center'}" rowspan="2">付款节点</th>
                            <th lay-data="{field:'cbs',minWidth:100,align:'center'}" rowspan="2">付款金额</th>
                        </tr>
                        <tr>
                            <th lay-data="{field:'province',minWidth:100}">初始值</th>
                            <th lay-data="{field:'city',minWidth:100}">变更值</th>
                            <th lay-data="{field:'zone',minWidth:100}">变更后值</th>
                        </tr>
                        </thead>
                    </table>
                </div>
...
<script>
    ...
    layui.use(['form', 'laydate', 'eleTree', 'xmSelect', 'treeTable', 'table'], function () {
        ...
        layTable.init('parse-table-demo', {
        });
        ...
        function tableInit(projId) {
            ...
            // 	},
            // 	cols:[[
            // 		{filed:'wbsOne',width:100,title:'WBS一级',sort:true,rowspan:2},
            // 		{filed:'wbsTwo',width:100,title:'WBS二级',sort:true,rowspan:2},
            // 		{filed:'wbsThree',width:100,title:'WBS三级',sort:true,rowspan:2},
            // 		{filed:'cbsOne',width:100,title:'CBS一级',sort:true,rowspan:2},
            // 		{filed:'cbsTwo',width:100,title:'CBS二级',sort:true,rowspan:2},
            // 		{filed:'cbsThree',width:100,title:'CBS三级',sort:true,rowspan:2},
            // 		{filed:'a',width:100,title:'a',sort:true,colspan:3},
            // 		{filed:'b',width:100,title:'b',sort:true},
            // 		{filed:'c',width:100,title:'c',sort:true}
            // 	]]
            // 	//height: 'full-80'
            // 	// parseData: function (res) { //res 即为原始返回的数据
            // 	// 	return {
