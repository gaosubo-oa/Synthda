...
<div class="container">
	...
	<div class="wrapper">
		<div class="wrap_left">
			<h2 style="text-align: center;line-height: 35px;">材料主要用量分析</h2>
			<div class="left_form">
			...
			<div style="position: relative;top: 10px">
				<div class="table_box" >
					...
					<table id="tableObj" lay-filter="parse-table-demo" class="layui-table" style="display: none">
						<thead>
						<tr>
							<th id="th1" lay-data="{field:'cbsUnit',minWidth:80,align:'center'}" >单位</th>
							<th lay-data="{field:'control',minWidth:100,align:'center'}" >控制方式</th>
							<th lay-data="{field:'administrationNumber',minWidth:150,align:'center'}" >管理目标数量</th>
							<th lay-data="{field:'administrationAmount ',minWidth:150,align:'center'}" >管理目标金额</th>
							<th lay-data="{field:'thisAmountMtlSum',minWidth:150,align:'center'}" >已提需用计划量</th>
							<th lay-data="{field:'mtlName',minWidth:100,align:'center'}" >物料名称</th>
							<th lay-data="{field:'mtlStandard',minWidth:150,align:'center'}" >规格</th>
<%--							<th lay-data="{field:'valuationUnit',minWidth:80,align:'center'}" >单位</th>--%>
							<th lay-data="{field:'thisAmountMtlSum',minWidth:150,align:'center'}">已提需求计划量</th>
							<th lay-data="{field:'purchaseQuantity',minWidth:150,align:'center'}">已提采购订单量</th>
							<th lay-data="{field:'stockInQuantity',minWidth:150,align:'center'}">累计入库量</th>
							<th lay-data="{field:'stockOutQuantity',minWidth:150,align:'center'}">累计出库量</th>
							<th lay-data="{field:'stockNum',minWidth:100,align:'center'}">库存量</th>
						</tr>
			...
			$.ajax({
				...
				success:function(res){
					...
					layTable.init('parse-table-demo', { //转化静态表格
						url:'/projectCostAnalysis/getCbsWbsByProj?projId='+projId+'&rbsTyep=mtl',
