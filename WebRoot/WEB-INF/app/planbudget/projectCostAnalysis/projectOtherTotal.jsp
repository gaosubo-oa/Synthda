...
<div class="container">
    ...
    <div class="wrapper">
        <div class="wrap_left">
            <h2 style="text-align: center;line-height: 35px;">其他费用总价分析</h2>
            <div class="left_form">
            ...
            <div style="position: relative;top: 10px">
                <div class="table_box" >
                    <table id="tableObj" lay-filter="parse-table-demo" class="layui-table" style="display: none">
                        ...
                        <tr>
                            <th lay-data="{field:'incomeTarAmount1',minWidth:100}">初始值</th>
                            <th lay-data="{field:'incomeTarAmount2',minWidth:100}">变更值</th>
                            <th lay-data="{field:'incomeTarAmount3',minWidth:100}">变更后值</th>
                            <th lay-data="{field:'optTarAmount1',minWidth:100}">初始值</th>
                            <th lay-data="{field:'optTarAmount2',minWidth:100}">变更后值</th>
                            <th lay-data="{field:'manageTarAmount1',minWidth:100}">初始值</th>
                            <th lay-data="{field:'manageTarAmount2',minWidth:100}">变更值</th>
                            <th lay-data="{field:'manageTarAmount3',minWidth:100}">变更后值</th>
                        </tr>
                        </thead>
                    </table>
                </div>
            ...
            $.ajax({
                ...
                success:function(res){
                    ...
                    layTable.init('parse-table-demo', { //转化静态表格
                        url:'/projectCostAnalysis/getCbsWbsByProj?projId='+projId+'&cbsType=07',
