...
<div class="container">
    ...
    <div class="wrapper">
        <div class="wrap_left">
            <h2 style="text-align: center;line-height: 35px;">分包合同结算付款情况分析报表</h2>
            <div class="left_form">
            ...
            $.ajax({
                ...
                success:function(res){
                    ...
                    layTable.init('parse-table-demo', { //转化静态表格
                        url:'/projectCostAnalysis/getCbsWbsByProj?projId='+projId+'&rbsTyep=subcontract',
