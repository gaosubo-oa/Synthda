...
<script type="text/javascript">
    ...
    layui.use(['table', 'form','laydate','soulTable'], function () {
        ...
        var TableUIObj = new TableUI('plb_superviseunit_customer');
        ...
        function tableShow() {
            ...
            tableList = table.render({
                elem: '#tableList',
                url: '/superviseUnit/getDataByCondition',
                page: true,
                height: 'full-80',
                toolbar: '#toolbarDemo',
        ...
        table.on('toolbar(tableList)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'del':
                    ...
                    var superviseunitCustomerId = ''
                    checkStatus.data.forEach(function (v, i) {
                        superviseunitCustomerId += v.superviseunitCustomerId + ','
                    })
                    layer.confirm('确定删除该条数据吗？', function (index) {
                        $.post('/superviseUnit/delSupplier', {superviseunitCustomerId: superviseunitCustomerId}, function (res) {
                            if (res.flag) {
        ...
        function newOrEdit(type, data) {
            ...
            if (type == '0') {
                title = '新建'
                url = '/superviseUnit/insertOrUpdate'
            } else if (type == '1') {
                title = '编辑'
                url = '/superviseUnit/insertOrUpdate'
            }
            layer.open({
                ...
                yes: function (index) {
                    ...
                    if (type == 1) {
                        obj.superviseunitCustomerId = data.superviseunitCustomerId
                    }
