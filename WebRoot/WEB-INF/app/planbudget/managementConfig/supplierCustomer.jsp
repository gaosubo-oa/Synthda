...
<script type="text/javascript">
    ...
    layui.use(['table', 'form','laydate','soulTable'], function () {
        ...
        var TableUIObj = new TableUI('plb_supplier_customer');
        ...
        function tableShow() {
            ...
            tableList = table.render({
                elem: '#tableList',
                url: '/supplier/getDataByCondition',
                page: true,
                height: 'full-80',
                toolbar: '#toolbarDemo',
        ...
        table.on('toolbar(tableList)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'del':
                    ...
                    var supplierCustomerId = ''
                    checkStatus.data.forEach(function (v, i) {
                        supplierCustomerId += v.supplierCustomerId + ','
                    })
                    layer.confirm('确定删除该条数据吗？', function (index) {
                        $.post('/supplier/delSupplier', {supplierCustomerId: supplierCustomerId}, function (res) {
                            if (res.flag) {
        ...
        function newOrEdit(type, data) {
            ...
            layer.open({
                ...
                yes: function (index) {
                    ...
                    if (type == 1) {
                        obj.supplierCustomerId = data.supplierCustomerId
                    }
