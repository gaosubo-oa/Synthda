...
<script type="text/javascript">
    ...
    layui.use(['table', 'form','laydate','soulTable'], function () {
        ...
        var TableUIObj = new TableUI('plb_buildunit_customer');
        ...
        function tableShow() {
            ...
            tableList = table.render({
                elem: '#tableList',
                url: '/buildunitCustomer/getDataByCondition',
                page: true,
                height: 'full-80',
                toolbar: '#toolbarDemo',
        ...
        table.on('toolbar(tableList)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'del':
                    ...
                    var buildunitCustomerId = ''
                    checkStatus.data.forEach(function (v, i) {
                        buildunitCustomerId += v.buildunitCustomerId + ','
                    })
                    layer.confirm('确定删除该条数据吗？', function (index) {
                        $.post('/buildunitCustomer/delBuildUnit', {buildunitIds: buildunitCustomerId}, function (res) {
                            if (res.flag) {
        ...
        function newOrEdit(type, data) {
            ...
            if (type == '0') {
                title = '新建'
                url = '/buildunitCustomer/insertOrUpdate'
            } else if (type == '1') {
                title = '编辑'
                url = '/buildunitCustomer/insertOrUpdate'
            }
            layer.open({
                ...
                yes: function (index) {
                    ...
                    if (type == 1) {
                        obj.buildunitCustomerId = data.buildunitCustomerId
                    }
