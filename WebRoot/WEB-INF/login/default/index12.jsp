...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/default/theme12/loginInterface.css"/>
    ...
    <div class="content">
        ...
        <div class="header clearfix" style="display: none;">
            ...
            <div class="banRight">
                ...
                <div class="posit" id="android">
							<span class="iconT">
								<img src="/img/default/theme12/Android.png" title='<fmt:message code="global.th.downloadTheAndroidClient" />'/>
							</span>
                ...
                <div class="posit" id="iphone">
							<span class="iconH">
								<img src="/img/default/theme12/Apple.png" title='<fmt:message code="global.th.downloadTheIPhoneClient" />'/>
							</span>
        ...
        <div class="mainCon">
            ...
            <div class="entry entryBg">
                <div class="entryTwo">
                    <div class="txt">
                        <img src="/img/default/theme12/icon_depart.png"/>
                    ...
                    <div class="txt">
                        ...
                        <div style="color:red;padding:4px 2px 2px 112px; position:absolute; display:none;font-size: 13px;" id="capital">大写锁定已开启</div>
                    </div>
                    <div style="height: 22px">
                        <div title="扫码登录" class="scanLogin" style="display: inline;margin-left: 240px;cursor: pointer" loginType="1">
                            <span autocomplete="off" style="color: #9b5d3d; display: inline-block;font-size: 10px;margin-top: 16px;"><fmt:message code="global.lang.scanLogin"/></span>
                        </div>
                        <div class="resetPsword" style="display: inline">
                            <span autocomplete="off" style="color: #9b5d3d; float:right; display: inline-block;font-size: 10px;margin-top: 15px;"><fmt:message code="global.lang.forgetPW"/></span>
                        </div>
                    </div>
                    <div id="SecGraphic" class="txt" style="margin-top: 22px;height: 30px;position: relative;">
                        <img class="img" src="/img/default/theme12/icon_graphic.png"/>
                        <span class="spanColor" style="color: #FFFFFF;margin-right: -6px;letter-spacing: 5px;display: inline-block;width: 65px;"><fmt:message code="graphic"/></span>
...
<div id="beianhao" style="position: fixed;bottom: 0;left: 0;width: 100%;height: 50px;mso-font-src: 14px;">
    ...
    <p style="text-align: center;">
        <label style="color: #a57255">网站备案号：</label>
        <span class="ptwo" style="margin: 0 auto;height: 19px;color: #a57255;"></span>
    </p>
</div>
<script type="text/javascript">
    ...
    $('.resetPsword').on('click', function () {
        window.location.href = '/resetPsword?type=5'
    })
    /*function createCode() {
        code = "";
        var codeLength = 4;
        ...
        $.get('/sys/getInterfaceParam', {params:"loginLiterals,fileNumber,loginValidation"},function (json) {
            if (json.flag) {
                ...
                if(json.obj.QRCODE_LOGIN_SET == '0' || json.obj.IS_USE_APP == 1){
                    ...
                    $('.scanLogin').css('display','inline-block')
                }
            }
        }, 'json')
        // 查询是否开启黑色主题
