...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/default/theme18/loginInterface.css?20220317"/>
...
<div class="form1">
    <div class="content">
        ...
        <div class="header clearfix" style="display: none;">
            <div class="logo">
                <img height="57" src="LogoImg" onerror="imgerror2(this,18)"/>
            </div>
            <div class="banRight">
<%--                <span class="banLang"><fmt:message code="language"/>：</span>--%>
                <select id="language" name="language" style="width: 90px;height: 23px;margin-right: 30px;border: none;border-radius: 15px;background: #eee;padding-left: 15px;">
                ...
                <div class="posit" id="android">
							<span class="iconT">
								<img src="/img/default/theme18/Android.png?20210113.1" title='<fmt:message code="global.th.downloadTheAndroidClient" />' style="width: 22px;"/>
							</span>
                ...
                <div class="posit" id="iphone">
							<span class="iconH">
								<img src="/img/default/theme18/Apple.png" title='<fmt:message code="global.th.downloadTheIPhoneClient" />' style="width: 22px"/>
							</span>
        ...
        <div class="mainCon">
            <div class="entry">
                ...
                <div class="entryBg">
                    <div class="mainLeft">
                        <img src="/img/default/theme18/loginpanel.png" style="width: 350px;height: 413px"/>
                    </div>
                    <div class="mainRight">
                        <div style="float: right">
                            <img src="/img/default/theme18/qrCode.png" title="扫码登录" class="scanLogin" style="cursor: pointer"/>
                        </div>
...
<%--                            <img src="/img/default/theme18/title.png" style="height: 25px;"/>--%>
                        ...
                        <div class="loginPart">
                            <div class="txt" style="margin-top: 30px">
                                <img class="img" src="/img/default/theme18/zuzhi.png" style="top: 16px"/>
                                <select id="departs" name="departs">
                                </select>
                                <img src="/img/default/theme17/xiala.png" style="position: absolute;width: 12px;right: 42px;top: 17px;"/>
                            </div>
                            <div class="txt">
                                <img class="img" src="/img/default/theme18/icon_user.png"/>
                                <input type="text" name="user" id="user" placeholder="<fmt:message code="global.lang.user" />"/>
                            </div>
                            <div class="txt">
                                <img class="img" src="/img/default/theme18/icon_password_1.png"/>
                            ...
                            <div class="resetPsword" style="position:relative;">
                                <span autocomplete="off" style="color: #0076fe;float: right;display: inline-block;font-size: 10px;top: -30px;position: absolute;right: 20px;"><fmt:message code="global.lang.forgetPW"/></span>
                            </div>
                            <div id="SecGraphic" class="txt" style="display: none;margin-top: 15px;height: 30px;position: relative;">
                                <div class="imgDiv">
                                    <img class="img" style="width: 20px;top: 20px" src="/img/default/theme18/icon_graphic.png"/>
                                </div>
                                ...
                                <input type="text" id="graphic" style="width: 150px;margin-top: 5px;margin-left: -35px;" placeholder="请输入图中验证码"/>
                                ...
                                <img src="" alt="" style="position: absolute;top: 13px;right: 23px;" onclick="$(this).attr('src','/GetCodeImgServlet?'+Math.random())" id="imgCode">
                            </div>
...
<div id="beianhao" style="position: fixed;bottom: 0;left: 0;width: 100%;height: 50px;mso-font-src: 14px">
    ...
    <p style="text-align: center;">
        <label style="color: #fff">网站备案号：</label>
...
<script type="text/javascript">
    ...
    //     var str = '<div id="qrcode"  style="margin-top: 45px;margin-left: 103px;"></div>\n' +
    //         '                        <div style="font-size: 12px;margin-top: 10px;text-align: center;">请使用客户端扫描二维码以登录</div>\n' +
    //         '                        <div style="font-size: 12px;margin-top: 10px;text-align: center;">点击下载客户端</div>'
    //     $('.scanPart').append(str)
    //     // 设置要生成二维码的链接
    //     new QRCode(document.getElementById("qrcode"), {
    //         // render:'table',
    //         text: '/Antiepidemic/antiepidemicH5',
    //         width: 150,
    //         height: 150
    //     });
    // }
    ...
    $(function () {
        ...
        //     $(this).css('background', 'url(/img/default/theme1/loginAfter.png) no-repeat');
        //
        // })
        // $('.loginBtn').on('click', function () {
        //     $(this).css('background', 'url(/img/default/theme1/loginClick.png) no-repeat');
        // })
        // $('.loginBtn').on('mouseout', function () {
        //     $(this).css('background', 'url(/img/default/theme1/loginback.png) no-repeat');
        // })
        //右侧图标点击扫码下载
        ...
        function departmentAll() {
            $.ajax({
                ...
                success: function (res) {
                    ...
                    //判断是否开启验证码
                    if (res.code == 1) {
                        $('.mainLeft img').css('height','459px')
                        $('.mainRight').css({'height':'459px','background-size':'400px'})
                        $('.loginBtn').css('margin-top','45px')
                        $('#imgCode').attr('src','/GetCodeImgServlet?'+Math.random())
                        $('#SecGraphic').show()
                        isa = 1
                    } else {
