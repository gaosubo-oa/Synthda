...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/default/theme6/loginInterface.css"/>
        ...
        <div class="header clearfix" style="display: none;">
            ...
            <div class="banRight">
                ...
                <div class="posit" id="android">
							<span class="iconT">
								<img src="/img/default/theme6/Android.png?20210113.1" title='<fmt:message code="global.th.downloadTheAndroidClient" />'/>
							</span>
                ...
                <div class="posit" id="iphone">
							<span class="iconH">
								<img src="/img/default/theme6/Apple.png" title='<fmt:message code="global.th.downloadTheIPhoneClient" />'/>
							</span>
            ...
            <div class="entry">
                ...
                <div class="entryBg">
                    ...
                    <div class="mainRight">
                        ...
                        <div class="txt">
                            <div class="imgDiv">
                                <img src="/img/default/theme6/icon_organination_2.png"/>
                            </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('.loginBtn').on('mouseover', function () {
            $(this).css('background', 'url(/img/default/theme6/loginAfter.png) no-repeat');
        })
        $('.loginBtn').on('click', function () {
            $(this).css('background', 'url(/img/default/theme6/loginClick.png) no-repeat');
        })
        $('.loginBtn').on('mouseout', function () {
            $(this).css('background', 'url(/img/default/theme6/loginback.png) no-repeat');
        })
        //右侧图标点击扫码下载
