...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/default/theme19/loginInterface.css?20220317"/>
...
<%--                <span class="banLang"><fmt:message code="language"/>：</span>--%>
                <select id="language" name="language" style="width: 100px;height: 23px;margin-right: 30px;border: none;border-radius: 15px;background: #f3f1f1;padding-left: 25px;">
                ...
                <div class="posit" id="android">
							<span class="iconT">
								<img src="/img/default/theme19/Android.jpg?20210113.1" title='<fmt:message code="global.th.downloadTheAndroidClient" />' style="width: 22px"/>
							</span>
                ...
                <div class="posit" id="iphone">
							<span class="iconH">
								<img src="/img/default/theme19/Apple.png" title='<fmt:message code="global.th.downloadTheIPhoneClient" />' style="width: 22px"/>
							</span>
        ...
        <div class="mainCon">
            <div class="entry">
                ...
                <div class="entryBg">
                    <div class="mainLeft">
                        <img src="/img/default/theme19/loginpanel.png" style="width: 350px;height: 430px"/>
                        <img src="/img/default/theme19/loginpanel4.png" style="position: absolute;top: 254px;left: 56px;width: 260px;"/>
                    </div>
                    <div class="mainMiddle"></div>
                    <div class="mainRight">
                        <div style="float: right">
                            <img src="/img/default/theme19/qrCode.png" title="扫码登录" class="scanLogin" style="cursor: pointer"/>
                        </div>
                        ...
                        <div class="loginPart" >
                            <div class="txt" style="margin-top: 30px">
                                ...
                                <img  src="/img/default/theme17/xiala.png" style="position: absolute;width: 12px;right: 37px;top: 18px;"/>
                            </div>
                            <div class="txt" >
                                <div class="imgDiv">
                                    <img class="img" src="/img/default/theme19/icon_user.png"/>
                                </div>
                                <input type="text" name="user" id="user" placeholder="<fmt:message code="global.lang.user" />"/>
                            </div>
                            <div class="txt">
                                <div class="imgDiv">
                                    <img class="img" src="/img/default/theme19/icon_password_1.png"/>
                                </div>
                            ...
                            <div class="resetPsword" style="position: relative">
                                <span autocomplete="off" style="color: #b8bed1;float: right;display: inline-block;font-size: 10px;top: -30px;position: absolute;right: 30px;"><fmt:message code="global.lang.forgetPW"/></span>
                            </div>
                            <div id="SecGraphic" class="txt" style="display: none;margin-top: 15px;height: 30px;position: relative;">
                                ...
                                <img src="" alt="" style="position: absolute;top: 14px;right: 25px;" onclick="$(this).attr('src','/GetCodeImgServlet?'+Math.random())" id="imgCode">
                            </div>
        ...
        function departmentAll() {
            $.ajax({
                ...
                success: function (res) {
                    ...
                    //判断是否开启验证码
                    if (res.code == 1) {
                        $('.mainLeft img').eq(0).css('height','465px')
                        $('.mainLeft img').eq(1).css('top','290px')
                        $('.mainRight').css({'height':'465px','background-size':'405px'})
                        $('#imgCode').attr('src','/GetCodeImgServlet?'+Math.random())
                        $('#SecGraphic').show()
                        isa = 1
                    } else {
