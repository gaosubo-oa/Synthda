...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/default/theme10/loginInterface.css"/>
...
<div class="form1">
    <div class="content">
        ...
        <div class="header clearfix" style="display: none;height: 0px;">
            <div class="logo">
            ...
            <div class="banRight">
                ...
                <div class="posit" id="android">
							<span class="iconT">
								<img src="/img/default/theme10/Android.png" title='<fmt:message code="global.th.downloadTheAndroidClient" />'/>
							</span>
                ...
                <div class="posit" id="iphone">
							<span class="iconH">
								<img src="/img/default/theme10/Apple.png" title='<fmt:message code="global.th.downloadTheIPhoneClient" />'/>
							</span>
        ...
        <div class="mainCon">
            <div class="title">
                ...
                <span class="subTitle" style=" display:none;text-align:center;color:red; font-size: 16pt; font-family: Microsoft yahei;font-weight: bold; -webkit-text-fill-color:red;">机密级★</span>
            </div>
            <div class="entry entryBg">
                <div style="position: absolute;top: 30px;right: 33px; display: none;" title="扫码登录" class="scanLogin" loginType="1">
                    <img src="/img/default/theme17/scan.png" style="width: 24px;cursor:pointer;"/>
                </div>
                <div class="entryTwo">
                    <div class="txt">
                        <img src="/img/default/theme10/icon_depart.png"/>
                        <span class="spanColor" style="
                        margin-right: -4px;color: #FFFFFF;
                        letter-spacing: 5px;display: inline-block;width: 60px;"><fmt:message
                    ...
                    <div class="txt">
                        ...
                        <div style="color:white;padding:6px 2px 2px 100px; position:absolute; display:none;font-size: 13px;" id="capital">大写锁定已开启</div>
                    </div>
                    <div class="resetPsword">
                        <span autocomplete="off" style="color: #f1ece6; float:right; display: inline-block;font-size: 10px;margin-top: 6px;"><fmt:message code="global.lang.forgetPW"/></span>
                    </div>
                    <div id="SecGraphic" class="txt" style="margin-top: 22px;height: 30px;position: relative;">
                        ...
                        <span class="spanColor"
                              style="margin-left: -5px;color: #FFFFFF;margin-right: -15px;letter-spacing: 5px;display: inline-block;width: 65px;"><fmt:message code="graphic"/></span>
                        ...
                        <img src="" alt=""   style="position: absolute;top: 5px;right: -8px;" onclick="$(this).attr('src','/GetCodeImgServlet?'+Math.random())" id="imgCode">
                    </div>
...
<script type="text/javascript">
    ...
    $('.resetPsword').on('click', function () {
        window.location.href = '/resetPsword?type=1'
    })
    ...
    $(function () {
        ...
        $('.loginBtn').on('mouseover', function () {
            $(this).css('background', 'url(/img/default/theme10/loginAfter.png) no-repeat');
        })
        $('.loginBtn').on('click', function () {
            $(this).css('background', 'url(/img/default/theme10/loginClick.png) no-repeat');
        })
        $('.loginBtn').on('mouseout', function () {
            $(this).css('background', 'url(/img/default/theme10/loginback.png) no-repeat');
        })
