...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/default/theme14/loginInterface.css?20200713.1"/>
    ...
    <div class="content">
        ...
        <div class="header clearfix" style="display: none;">
            ...
            <div class="banRight">
                ...
                <div class="posit" id="android">
							<span class="iconT">
								<img src="/img/default/theme14/Android.png" title='<fmt:message code="global.th.downloadTheAndroidClient" />'/>
							</span>
                ...
                <div class="posit" id="iphone">
							<span class="iconH">
								<img src="/img/default/theme14/Apple.png" title='<fmt:message code="global.th.downloadTheIPhoneClient" />'/>
							</span>
        ...
        <div class="mainCon">
            ...
            <div class="entry entryBg">
                <div style="position: absolute;top: 30px;right: 32px;" title="扫码登录" class="scanLogin" loginType="1">
                    <img src="/img/default/theme17/scan.png" style="width: 24px;cursor:pointer;"/>
                </div>
                <div class="entryTwo" style="top: 55px;">
                    <div class="txt">
                        <img src="/img/default/theme14/icon_depart.png" style="margin-right: 13px;"/>
                        <span class="spanColor" style="vertical-align:middle;margin-right: -4px;color: #FFFFFF;letter-spacing: 5px;display: inline-block;width: 60px;"><fmt:message code="global.lang.tissue"/></span>
                    ...
                    <div class="txt">
                        ...
                        <input type="password" autocomplete="off" style="margin-left:8px;" name="password" id="password" value=""/>
                        <div style="color:red;padding:6px 2px 2px 108px; position:absolute; display:none;font-size: 13px;" id="capital">大写锁定已开启</div>
                    </div>
                    <div class="resetPsword">
                        <span autocomplete="off" style="color: red; float:right; display: inline-block;font-size: 10px;margin-top: 6px;"><fmt:message code="global.lang.forgetPW"/></span>
                    </div>
...
<div id="beianhao" style="position: fixed;bottom: 20px;left: 0;width: 100%;height: 50px;mso-font-src: 14px">
...
<script type="text/javascript">
    ...
    $('.resetPsword').on('click', function () {
        window.location.href = '/resetPsword?type=3'
    })
    /*function createCode() {
        code = "";
        var codeLength = 4;
