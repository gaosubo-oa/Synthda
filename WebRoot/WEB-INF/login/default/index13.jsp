...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/default/theme13/loginInterface.css"/>
    ...
    <div class="content">
        ...
        <div class="mainCon">
            ...
            <div class="entry entryBg">
                ...
                <div class="entryTwo">
                    <div class="txt">
                        <img src="/img/default/theme13/icon_depart.png"/>
                        <span class="spanColor" style="margin-right: -11px;color: #FFFFFF;letter-spacing: 5px;display: inline-block;width: 60px;"><fmt:message code="global.lang.tissue"/></span>
                        <select id="departs" name="departs" style="margin-left: 1px;">
                    ...
                    <div class="txt">
                        ...
                        <div style="color:red;padding:4px 2px 2px 99px; position:absolute; display:none;font-size: 13px;" id="capital">大写锁定已开启</div>
                    </div>
