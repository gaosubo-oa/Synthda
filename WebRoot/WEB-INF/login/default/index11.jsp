        ...
        <div class="header clearfix" style="display: none;">
            ...
            <div class="banRight">
                ...
                <div class="posit" id="android">
							<span class="iconT">
								<img src="/img/default/theme11/Android.png" title='<fmt:message code="global.th.downloadTheAndroidClient" />'/>
							</span>
                ...
                <div class="posit" id="iphone">
							<span class="iconH">
								<img src="/img/default/theme11/Apple.png" title='<fmt:message code="global.th.downloadTheIPhoneClient" />'/>
							</span>
            ...
            <div class="entry entryBg">
                <div class="entryTwo">
                    ...
                    <div class="txt">
                        ...
                        <div style="color:white;padding:6px 2px 2px 20px; position:absolute; display:none;font-size: 13px;" id="capital">大写锁定已开启</div>
                    </div>
                    <div style="height: 20px">
                        <div title="扫码登录" class="scanLogin" style="display: inline;margin-left: 250px;cursor: pointer" loginType="2">
                            <span autocomplete="off" style="color: #f9f7f6; display: inline-block;font-size: 10px;margin-top: 7px;"><fmt:message code="global.lang.scanLogin"/></span>
                        </div>
                        <div class="resetPsword" style="display: inline">
                            <span autocomplete="off" style="color: #f9f7f6; float:right; display: inline-block;font-size: 10px;margin-top: 6px;"><fmt:message code="global.lang.forgetPW"/></span>
                        </div>
                    </div>
                    <div id="SecGraphic" class="txt" style="margin-top: 22px;height: 30px;position: relative;">
                        <img class="img" src="/img/default/theme11/icon_graphic.png" style="position: absolute;z-index: 2;top: 13px;width: 15px;left: 20px;"/>
                        ...
                        <img src="" alt="" style="position: absolute;top: 8px;right: -4px;" onclick="$(this).attr('src','/GetCodeImgServlet?'+Math.random())" id="imgCode">
                    </div>
                    <div class="loginBtn" style="margin: 18px 0px;">
                        <span style="">登&nbsp;&nbsp;&nbsp;录</span>
                    </div>
                </div>
            </div>
