...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/default/theme8/loginInterface.css"/>
        ...
        <div class="header clearfix" style="display: none;">
            ...
            <div class="banRight">
                ...
                <div class="posit" id="android">
							<span class="iconT">
								<img src="/img/default/theme8/Android.png?20210113.1" title='<fmt:message code="global.th.downloadTheAndroidClient" />'/>
							</span>
                ...
                <div class="posit" id="iphone">
							<span class="iconH">
								<img src="/img/default/theme8/Apple.png" title='<fmt:message code="global.th.downloadTheIPhoneClient" />'/>
							</span>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('.loginBtn').on('mouseover', function () {
            $(this).css('background', 'url(/img/default/theme8/loginAfter.png) no-repeat');
        })
        $('.loginBtn').on('click', function () {
            $(this).css('background', 'url(/img/default/theme8/loginClick.png) no-repeat');
        })
        $('.loginBtn').on('mouseout', function () {
            $(this).css('background', 'url(/img/default/theme8/loginback.png) no-repeat');
        })
        //右侧图标点击扫码下载
