...
<head>
    ...
    <!--[if IE 8]>
    <script type="text/javascript" src="/js/xoajq/xoajq.js"></script>
    <![endif]-->
    <script src="/js/jquery/jquery.cookie.js"></script>
    <script src="/js/base/base.js"></script>
    <script charset="utf-8" src="/js/login/scanLogin.js?20220320" deffer="deffer"></script>
        ...
        <div class="header clearfix">
            ...
            <div class="banRight">
                ...
                <div class="posit" id="android">
							<span class="iconT">
								<img src="/img/default/theme1/Android.png?20210113.1" title='<fmt:message code="global.th.downloadTheAndroidClient" />'/>
							</span>
                ...
                <div class="posit" id="iphone">
							<span class="iconH">
								<img src="/img/default/theme1/Apple.png" title='<fmt:message code="global.th.downloadTheIPhoneClient" />'/>
							</span>
                ...
                <div class="entryBg">
                    ...
                    <div class="mainRight">
                        ...
                        <div id="SecGraphic" class="txt" style="display: none;margin-top: 22px;height: 30px;position: relative;">
                            ...
                            <img src="" alt="" style="position: absolute;top: 6px;right: 1px;"
...
<div id="beianhao" style="position: fixed;bottom: 0;left: 0;width: 100%;height: 50px;mso-font-src: 14px">
    ...
    <p style="text-align: center;">
        <label style="color: white">网站备案号：</label>
