...
<form name="form1">
    <div class="content"
         style="background: url(/img/default/theme20/BJ.png) no-repeat;background-size: 100% 100%;">
        <div class="tips" style="width:100%;background: orange;color: #fff;display: none">
            提示:您正在使用IE8浏览器，可能造成页面不兼容，建议升级IE11或360、UC等浏览器.
        </div>
        <div class="header clearfix">
<%--            <div style="display: inline-block;"><img style="width: 500px" src="/img/default/theme20/top.png"></div>--%>
<%--            <div style="display: inline-block;position: relative;left: 610px;top: 20px"><img--%>
<%--                    src="/img/default/theme20/fly.png" style="width: 300px"></div>--%>
            <div class="banRight">
        ...
        <div class="mainCon" style="background: none">
            <div class="entry" style="height: 500px;width: 450px;margin-top: 0px; background: none;">
                <div class="entryTwo" style="width: 78%;margin-left: 11%;">
                    <div style="text-align: center;" class="logo">
                        <img src="LogoImg" style="width: 210px" onerror="imgerror2(this,17)"/>
                        <%--                        <span class="titleTxt"></span>--%>
                    </div>
                    <div/>
                    <div class="entryTwo"
                         style="width: 100%;background-image: url('/img/default/theme20/LoginBox.png');">
                        ...
                        <div class="loginPart" style="margin-top: 30px;">
                            <div class="txt">
                                <div class="image"><img class="img" src="/img/default/theme20/login2.png"/><img
                                        style="position: absolute;left: 110px;width: 1.5px;" class="img"
                                        src="/img/default/theme20/DividingLine.png"/></div>
                            ...
                            <div class="txt">
                                <div class="image"><img class="img" src="/img/default/theme20/password2.png"/><img
                                        style="position: absolute;left: 110px;width: 1.5px;" class="img"
                                        src="/img/default/theme20/DividingLine.png"/></div>
                                <input type="password" autocomplete="new-password" autocomplete="off" name="password"
                                       id="password" placeholder="请输入登录密码" value=""
                            ...
                            <div id="SecGraphic" class="txt" style="margin-top: 10px;height: 30px;position: relative;">
                                <img class="img" src="/img/default/theme20/yanzheng2.png"
                                     style="position: absolute;z-index: 2;top: 26px;width: 30px;left: 64px;height: 30px"/>
                                <img style="position: absolute;left: 110px;width: 1.5px;" class="img"
                                     src="/img/default/theme20/DividingLine.png"/>
                                ...
                                <img src="" alt=""
                                     style="position: absolute;top: 23px;right: 10px;height: 35px;width: 90px;"
                                     onclick="$(this).attr('src','/GetCodeImgServlet?'+Math.random())" id="imgCode">
                            </div>
                            <div class="loginBtn"
                                 style="background-color: #C10A00;margin: 60px 0 30px 50px; border-radius: 5px;">
                                <span style="">登&nbsp;&nbsp;&nbsp;&nbsp;录</span>
                            </div>
                            <div class="resetPsword">
                                <span autocomplete="off"
                                      style="color: #b0b0b0; float:right; display: inline-block;font-size: 10px;margin-bottom: 50px;margin-right: 27px;"><fmt:message
                                        code="global.lang.forgetPW"/></span>
                            </div>
                            <div>
                                <span id="scanBtn" autocomplete="off"
                                      style="color: #b0b0b0; float:right; display: inline-block;font-size: 10px;margin-right: 160px;"
...
<%--            <div style="display: inline-block;position: relative;top: 51%; left: -121%;"><img--%>
<%--                    style="width: 400px;height: 400px" src="/img/default/theme20/left.png"></div>--%>
<%--            <div style="display: inline-block;position: relative;top: 35%; left: 110%;">--%>
<%--                <img style="width: 500px" src="/img/default/theme20/right .png"></div>--%>
        </div>
        <div/>
</form>
