                ...
                if(data.result.obj != ''){
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if(gs == 'jsp'||gs == 'css'||gs == 'js'||gs == 'html'||gs == 'java'||gs == 'php' ){ //后缀为这些的禁止上传
                            ...
                            str += '<div class="dech" deUrl="' + deUrl+ '"><a href="/download?'+encodeURI(deUrl)+'" NAME="' + data[i].attachName + '*" style="text-decoration:none;margin-left:5px;"><img  src="/img/attachment_icon.png"/>' + data[i].attachName + '</a><img class="deImgs" style="margin-left:5px;cursor: pointer;" src="/img/file/icon_deletecha_03.png"/><a fileExtension="'+fileExtension+'" onclick="pdurls($(this))"   href="javascript:;"  style="padding-left: 5px"><img src="/img/attachmentIcon/icon_skim.png" style="padding: 0 5px;">'+yulan+'</a><a style="padding-left: 5px" href="/download?'+encodeURI(deUrl)+'" ><img src="/img/attachmentIcon/icon_down.png"  style="padding: 0 5px;">'+email_th_download+'</a><a fileExtension="'+fileExtension+'" onclick="transfer($(this))"  attrurl="' + deUrl.substring(0,deUrl.lastIndexOf("&"))  + '" href="javascript:;" style="padding-left: 5px"  ><img src="/img/attachmentIcon/tran.png"  style="padding: 0 5px;">'+email_th_transfer_and_save+'</a><input type="hidden" class="inHidden" value="' + data[i].aid + '@' + data[i].ym + '_' + data[i].attachId + ',"></div>';
                        }
                    }
