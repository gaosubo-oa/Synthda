...
typeof jQuery != "undefined" || LoadScript('../js/xoajq/xoajq1.11.1.js' + gz_postfix);
LoadScript('../js/jquery/jquery-ui.custom.min.js' + gz_postfix);
LoadScript('../js/jquery/jquery.cookie.js' + gz_postfix);
LoadScript('../js/jquery/jquery.dynatree.min.js' + gz_postfix);
...
{
   if(client == "0")
      return td_lang.inc.msg_86;//"�����"
   else if(client == "1")
      return td_lang.inc.msg_87;//"�ֻ������"
   else if(client == "2")
      return td_lang.inc.msg_88;//"OA����"
   else if(client == "5")
...
XML.prototype.getRoot = function()
{
   ...
   return this.xmlDOM.documentElement; //xml�ĵ���ڵ�
}

XML.prototype.createXMLDom = function() //����XMLDOM�������������������
{
