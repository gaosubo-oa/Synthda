...
$.getScript(oScript.src,function(){
    ...
    $("#export").click(function () {//导出
        ...
        window.location.href='/FlowRunFu/zhongTong?export=2&userIds='+exportData.userIds+'&beginDate='+exportData.beginDate+'&endDate='+exportData.endDate+'&deptIds='+exportData.deptIds;
    })
