                ...
                if(res.object== 'MINHANG_EDU'){
                    ...
                    layer.open({
                        ...
                        content:'<div style="margin-top: 10px;">' +
                            '<p>' +
                            '<label style="display: inline-block;width: 150px;font-family: 微软雅黑E\\8F6F\\96C5\\9ED1,Tahoma,Verdana!important;vertical-align: middle;height: 30px;line-height: 30px;text-align: right;">'+titleShouwen+' :</label>' +
