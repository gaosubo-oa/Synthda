...
function departmentAjax(callback){
    $.ajax({
        url:'../../department/getAlldept?specifyTable='+specifyTable,
        type:'get',
        dataType:'json',
...
$(function () {
    ...
    var pageObj=$.tablePage('#pagediv','100%',[
        ...
        me.init("/myNotice/getNotifyGroupFromDept?specifyTable="+specifyTable)
    })
    ...
    $('.btnarrs').click(function () {
        ...
        switch(Number(type)) {
            case 1:
                ...
                break;
            case 2:
                window.location.href= '/myNotice/outputNotify?fromDept='+$('[name="type"]').val()+'&beginTime='+$('[name="beginTime"]').val()+'&endTime='+$('[name="endTime"]').val()+'&step=1'+'&specifyTable='+specifyTable;
            break;
            case 3:
                pageObj.data.fromDept=$('[name="type"]').val();
            ...
            case 4:
                pageObj.data.fromDept=$('[name="type"]').val();
                pageObj.data.beginTime=getWeekStartDate();
