                    ...
                    if(m==me.configuration.length-1){
                        ...
                        if(me.operation!=undefined) {
                            for (var n = 0; n < me.operation.length; n++) {
                                var operationAndA;
                                if(me.operation[n].name == '流程图'){
                                    operationAndA=$('<span style="margin-right: 10px;display: inline-block;cursor: pointer;width: 60px;height: 24px;background: #1890FF;color: #fff;line-height: 24px;border-radius: 3px;text-align: center;margin-bottom: 5px" class="editAndDelete' + n + '"><img src=\'/img/workflow/work/add_work/liuchengtu.png \' style=\'vertical-align:middle;margin-top: -2px;width: 16px\'/>' + me.operation[n].name + '</span>')
                                }else if(me.operation[n].name == '结束'){
                                    operationAndA=$('<span style="margin-right: 10px;display: inline-block;cursor: pointer;width: 60px;height: 24px;background: #5F9EA0;color: #fff;line-height: 24px;border-radius: 3px;text-align: center;" class="editAndDelete' + n + '"><img src=\'/img/workflow/work/add_work/jieshu1.png \' style=\'vertical-align:middle;margin-top: -2px;width: 16px\'/>' + me.operation[n].name + '</span>')
                                }else if(me.operation[n].name == '催办'){
                                    operationAndA=$('<span style="margin-right: 10px;display: inline-block;cursor: pointer;width: 60px;height: 24px;background: #0CAE32;color: #fff;line-height: 24px;border-radius: 3px;text-align: center;" class="editAndDelete' + n + '"><img src=\'/img/workflow/work/add_work/cuiban1.png \' style=\'vertical-align:middle;margin-top: -2px;width: 16px\'/>' + me.operation[n].name + '</span>')
                                }else if(me.operation[n].name == '删除'){
                                    operationAndA=$('<span style="margin-right: 10px;display: inline-block;cursor: pointer;width: 60px;height: 24px;background: #EF4747;color: #fff;line-height: 24px;border-radius: 3px;text-align: center;" class="editAndDelete' + n + '"><img src=\'/img/workflow/work/add_work/del2.png \' style=\'vertical-align:middle;margin-top: -2px;width: 14px\'/>' + me.operation[n].name + '</span>')
                                }else if(me.operation[n].name == '收藏'){
                                    operationAndA=$('<span style="margin-right: 10px;display: inline-block;cursor: pointer;width: 60px;height: 24px;background: #F4AF4A;color: #fff;line-height: 24px;border-radius: 3px;text-align: center;" class="editAndDelete' + n + '"><img src=\'/img/workflow/work/add_work/shoucang1.png \' style=\'vertical-align:middle;margin-top: -2px;width: 16px\'/>' + me.operation[n].name + '</span>')
                                }else if(me.operation[n].name == '传阅'){
                                    operationAndA=$('<span style="margin-right: 10px;display: inline-block;cursor: pointer;width: 60px;height: 24px;background: rgb(24,144,255);color: #fff;line-height: 24px;border-radius: 3px;text-align: center;" class="editAndDelete' + n + '"><img src=\'/img/workflow/work/add_work/zhuanjiao1.png \' style=\'vertical-align:middle;margin-top: -2px;width: 16px\'/>' + me.operation[n].name + '</span>')
                                }else if(me.operation[n].name == '恢复执行'){
                                    operationAndA=$('<span style="margin-right: 10px;display: inline-block;cursor: pointer;width: 80px;height: 24px;background: #F4AF4A;color: #fff;line-height: 24px;border-radius: 3px;text-align: center;" class="editAndDelete' + n + '"><img src=\'/img/mywork/shuxinwork3.png\' style=\'vertical-align:middle;margin-top: -2px;width: 16px\'/>' + me.operation[n].name + '</span>')
                                }else if(me.operation[n].name == '编辑'){
                                    operationAndA=$('<span style="margin-right: 10px;display: inline-block;cursor: pointer;width: 60px;height: 24px;background: #0CAE32;color: #fff;line-height: 24px;border-radius: 3px;text-align: center;" class="editAndDelete' + n + '"><img src=\'/img/workflow/work/add_work/sign1.png \' style=\'vertical-align:middle;margin-top: -2px;width: 16px\'/>' + me.operation[n].name + '</span>')
                                }else{
                                    operationAndA=$('<span style="margin-right: 10px;display: inline-block;cursor: pointer" class="editAndDelete' + n + '">' + me.operation[n].name + '</span>')
                                }
                                $(operationAndA).attr('data-i',i)
                                if(me.operation[n].fn(arr[i]) != ''){
