    ...
    $.ajax({
        ...
        success:function(res){
            ...
            for(var i=0;i<data1.length;i++){
                ...
                str+='<tr class="loopData" uid="'+data1[i].uid+'"><td>'+data1[i].dep.deptName+'</td><td>'+data1[i].userPrivName+'</td><td><a href="javascript:;" class="userDetail">'+data1[i].userName+'</a></td><td>'+txt+'</td><td>'+data1[i].telNoDept+'</td><td>'+data1[i].mobilNo+'</td><td>'+data1[i].email+'</td></tr>'
            }
            element.after(str);
        }
    })
