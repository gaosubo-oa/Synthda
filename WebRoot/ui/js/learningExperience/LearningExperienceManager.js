...
//表格初始化
    var pageObj=$.tablePage('#pagediv','100%',[
        {
            ...
            selectFun:function (n,obj) {
                return '<input name="choice" type="checkbox" class="choose" data-id="'+obj.id+'" onclick="setAll()">'
            }
        },
        {
            width:'12%',
        ...
        me.init("/learningExperience/getLearningExperienceList",[
            ...
            var str='<tr>' +
                '<td style="width: 400px;padding-left: 5px"><input type="checkbox" name="all"  id="allcheck"><span>'+notice_th_allchose+'</span></td>' +
    ...
    $('#pagediv').on('click','.editAndDelete1',function(){
        ...
        console.log(id)
        if(typer!=undefined){
            parent.$('[name="notices"]').attr('src','/learningExperience/newLearningExperience?type=1&userId='+userId+'&id='+id)
        }else{
