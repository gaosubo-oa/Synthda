...
*
****************************************************/
function pagemodel(setlog) {
	try{
		var webObj=document.getElementById("WebOffice1");
		var words=webObj.GetDocumentObject();
		words.ActiveWindow.ActivePane.View.Zoom.PageFit=setlog;
	}catch(e){
	//	alert("�쳣\r\nError:"+e+"\r\nError Code:"+e.number+"\r\nError Des:"+e.description);
	}
}
...
function SetUserName() {
	try{
		...
		if(document.getElementById("UserName").value ==""){
 		...
 		webObj.SetCurrUserName(document.getElementById("UserName").value);
	}catch(e){
		alert("�쳣\r\nError:"+e+"\r\nError Code:"+e.number+"\r\nError Des:"+e.description);
	}
}
...
function addBookmark() {
		alert("���괦��������Ϊtest����ǩ");
			var webObj=document.getElementById("WebOffice1");
		  webObj.SetFieldValue("test", "������ǩtest", "::ADDMARK::");
		

}
function taohong(){
	var webObj=document.getElementById("WebOffice1");
	webObj.SetFieldValue("test", "���������Ϣ�������޹�˾", "");

}

function getFileValue(){
	  var webObj=document.getElementById("WebOffice1");
		var getValueInfo=webObj.GetFieldValue("test", "");
		alert("��ǩֵ��"+getValueInfo);
	}
/****************************************************
*
*					���ģ��
...
/****************************************************/
function linkRed() {
		window.open("markformItem.html","newwindow",'height=768, width=1024, top=0, left=0, toolbar=yes,resizable=yes, menubar=yes,location=yes, status=yes');
} 
/****************************************************
*
*					�ϴ��ĵ�
...
function SaveDoc(id) {
	try{
		...
		webObj.HttpAddPostString("name", id);
		webObj.HttpAddPostCurrFile("DocContent","");		// �ϴ��ļ�
		returnValue = webObj.HttpPost("http://127.0.0.1/savedoc.jsp");	// �ж��ϴ��Ƿ�ɹ�
...
function updateAllField(){
	...
	try{
		var webObj = document.getElementById("WebOffice1");
		//���ݸ�ʽ
		var pcFieldSettings = "STRDATA:A1;;����;6;;���������...;\nA2;XML_�ȼ�;�ȼ�;4;��ͨ||�Ӽ�||�ؼ�;\nXML_�ȼ�;;�ȼ�;4;��ͨ||�Ӽ�||�ؼ�;\nXML_�ܼ�;;�ܼ�;4;��ͨ||����||����||����;\nXML_�籨̧ͷ;;�籨̧ͷ;5;;������籨̧ͷ...\nXML_��λ;;��λ;6;;��������λ\nXML_�������;;�������;6;&Hou;�������������\nXML_�����;;�����;0;;\nPRG_CS;;������;0;;";


		//�ļ�·����ʽ
		//var pcFieldSettings = "STRDATA:A1;;����;4;;���������...";

		//var r = webObj.UpdateAllField(pcFieldSettings);
		var r = webObj.UpdateAllField("STRDATA:A1;;����;6;;���������...;");
	}catch(e){
		alert("�쳣\r\nError:"+e+"\r\nError Code:"+e.number+"\r\nError Des:"+e.description);
	}
...
function MarkProdect(){
	var objWeb=document.getElementById("WebOffice1");
	//������ǩ����ȡ��ǩλ����Ϣ
	var iIndex; 
	var MarkList="";
	var markCount=objWeb.GetBookMarkCount();
	for(iIndex=1;iIndex<=markCount;iIndex++){
		var vName = objWeb.GetBookMarkInfo(iIndex,0 ); //��ȡ��ǩ����
		var markStar=objWeb.GetBMPos(vName,0);//��ȡ��ǩ��ʼλ��
	  var markEnd=objWeb.GetBMPos(vName,1);//��ȡ��ǩ����λ��
	  if(MarkList==""){
	    MarkList=markStar+"-"+markEnd;
	  }else{
	   MarkList=MarkList+","+markStar+"-"+markEnd;
	  }
	}
	if(MarkList==""){
	  alert("word�ĵ���û����ǩ������������ǩ����");
	}else{
	  objWeb.LocalProtect(MarkList,"ProtectDoc","LOCK_INCLUDE");//������ǩ����ӱ����������ط������޸�
	}	
}

function  SelectDocProdect(){
	var objWeb=document.getElementById("WebOffice1");
	objWeb.LocalProtect("","ProtectDoc","LOCK_INCLUDE");//������ǩ����ӱ����������ط������޸�
	
	}
	
function UNProdect(){
	var objWeb=document.getElementById("WebOffice1");
	 objWeb.UpdateAllField("");
...
function cesInfo(){
	 ...
	 var webObj=document.getElementById("WebOffice1"); 		   
		   var s=webObj.SaveAsPDF("","D://11.pdf", 0);
		   alert("����·����D://11.pdf");
	}
...
function moveMarkDetil(){

	      var obj;
         obj = new Object(document.all.WebOffice1.GetDocumentObject());
          obj.Bookmarks("QZGZ_20141124171149").Select();
          obj.Application.Selection.MoveDown(5, 1);
