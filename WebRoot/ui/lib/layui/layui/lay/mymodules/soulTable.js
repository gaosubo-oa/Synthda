...
layui.define(['table', 'tableFilter', 'tableChild', 'tableMerge'], function (exports) {
  ...
  var mod = {
    render: function (myTable, fn) {
      ...
      if (curConfig.drag) {
        this.drag(myTable, curConfig.drag, fn);
      }
     ...
     * @param myTable
     */
    , drag: function (myTable, dragConfig, fn) {
        ...
        $tableHead.find('th').each(function () {
          ...
          $(this).find('span:first,.laytable-cell-checkbox')
            ...
            .on('mousedown', function (e) {
              ...
              // 阻止文本选中
              _DOC.on('bind',"selectstart", function () {
                return false;
              });
