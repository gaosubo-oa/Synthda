...
var t=$(_6);
var _8={};
var s=(t.attr("data-options")||'').trim();
if(s){
...
_34.off(".draggable").on("mousemove.draggable",{target:this},function(e){
if(_12){
return;
}
...
}).on("mouseleave.draggable",{target:this},function(e){
$(this).css("cursor","");
}).on("mousedown.draggable",{target:this},function(e){
if(_36(e)==false){
return;
}
$(this).css("cursor","");
...
$(document).on("mousedown.draggable",e.data,_1d);
$(document).on("mousemove.draggable",e.data,_23);
$(document).on("mouseup.draggable",e.data,_27);
});
function _36(e){
...
$(this).on("mousemove.resizable",{target:this},function(e){
if(_54){
return;
}
var dir=_63(e);
...
}).on("mouseleave.resizable",{target:this},function(e){
$(e.data.target).css("cursor","");
}).on("mousedown.resizable",{target:this},function(e){
var dir=_63(e);
if(dir==""){
return;
}
...
$(document).on("mousedown.resizable",_65,_5e);
$(document).on("mousemove.resizable",_65,_5f);
$(document).on("mouseup.resizable",_65,_60);
...
t.off(".linkbutton").on("focus.linkbutton",function(){
if(!_6f.disabled){
...
t.on("click.linkbutton",function(){
if(_6f.selected){
...
var t=$(_7d);
return $.extend({},$.parser.parseOptions(_7d,["id","iconCls","iconAlign","group",{plain:"boolean",toggle:"boolean",selected:"boolean"}]),{disabled:(t.attr("disabled")?true:undefined),text:(t.html()).trim(),iconCls:(t.attr("icon")||t.attr("iconCls"))});
};
...
a.wrap("<td></td>");
a.linkbutton({iconCls:btn.iconCls,plain:true}).off(".pagination").on("click.pagination",function(){
...
bb.num.off(".pagination").on("keydown.pagination",function(e){
if(e.keyCode==13){
...
$(_b6).off().on("mouseover",function(e){
var tt=$(e.target);
...
$(_1ad).off(".tooltip").on(opts.showEvent+".tooltip",function(e){
_1b4(_1ad,e);
...
$(_1c1).off(".tooltip").removeClass("tooltip-f");
...
t.on("click",eval(opts.tools[i].handler));
}
}
}
}
if(opts.collapsible){
$("<a class=\"panel-tool-collapse\" href=\"javascript:void(0)\"></a>").appendTo(tool).on("click",function(){
...
if(opts.minimizable){
$("<a class=\"panel-tool-min\" href=\"javascript:void(0)\"></a>").appendTo(tool).on("click",function(){
_1fb(_1d8);
return false;
});
}
if(opts.maximizable){
$("<a class=\"panel-tool-max\" href=\"javascript:void(0)\"></a>").appendTo(tool).on("click",function(){
...
if(opts.closable){
$("<a class=\"panel-tool-close\" href=\"javascript:void(0)\"></a>").appendTo(tool).on("click",function(){
_1db(_1d8);
return false;
});
}
...
$("<a></a>").attr("href","javascript:void(0)").text(_262).css("margin-left",10).on("click",eval(_261[_262])).appendTo(tb).linkbutton();
}
}
...
$(".tabs-scroller-left",_2d7).off(".tabs").on("click.tabs",function(){
$(_2d6).tabs("scrollBy",-opts.scrollIncrement);
});
$(".tabs-scroller-right",_2d7).off(".tabs").on("click.tabs",function(){
$(_2d6).tabs("scrollBy",opts.scrollIncrement);
});
};
...
opts.tab.off(".tabs").on("click.tabs",{p:pp},function(e){
if($(this).hasClass("tabs-disabled")){
return;
}
_2e1(_2da,_2dd(_2da,e.data.p));
}).on("contextmenu.tabs",{p:pp},function(e){
if($(this).hasClass("tabs-disabled")){
return;
}
...
_2e9.on("click.tabs",{p:pp},function(e){
...
if(opts.tools[i].handler){
t.on("click",{handler:opts.tools[i].handler},function(e){
...
$(this).off(".layout").on("mouseleave.layout",{region:_344},function(e){
if(_320==true){
return;
}
...
var t=$(_392);
var item={target:_392,id:t.attr("id"),text:(t.children("div.menu-text").html()).trim(),disabled:t.hasClass("menu-item-disabled"),href:t.attr("href"),name:t.attr("name"),onclick:_392.onclick};
...
btn.off(".menubutton");
btn.on("click.menubutton",function(){
_39c();
return false;
});
var _39d=null;
btn.on("mouseenter.menubutton",function(){
_39d=setTimeout(function(){
_39c();
},opts.duration);
return false;
}).on("mouseleave.menubutton",function(){
if(_39d){
clearTimeout(_39d);
}
});
...
if(_3a5){
btn.linkbutton("disable");
_3a6.off(".splitbutton");
}else{
btn.linkbutton("enable");
_3a6.off(".splitbutton");
_3a6.on("click.splitbutton",function(){
_3a7();
return false;
});
var _3a8=null;
_3a6.on("mouseenter.splitbutton",function(){
_3a8=setTimeout(function(){
_3a7();
},opts.duration);
return false;
}).on("mouseleave.splitbutton",function(){
if(_3a8){
clearTimeout(_3a8);
}
});
...
_3bd.off(".searchbox").on("blur.searchbox",function(e){
opts.value=$(this).val();
if(opts.value==""){
...
}).on("focus.searchbox",function(e){
if($(this).val()!=opts.value){
$(this).val(opts.value);
}
$(this).removeClass("searchbox-prompt");
}).on("keydown.searchbox",function(e){
if(e.keyCode==13){
e.preventDefault();
...
_3be.off(".searchbox").on("click.searchbox",function(){
var name=$.fn.prop?_3bd.prop("name"):_3bd.attr("name");
opts.searcher.call(_3bb,opts.value,name);
}).on("mouseenter.searchbox",function(){
$(this).addClass("searchbox-button-hover");
}).on("mouseleave.searchbox",function(){
...
box.off(".validatebox").on("focus.validatebox",function(){
...
_3d1(_3cf);
}).on("mouseenter.validatebox",function(){
if(box.hasClass("validatebox-invalid")){
_3d2(_3cf);
}
}).on("mouseleave.validatebox",function(){
if(!_3d0.validating){
_3d1(_3cf);
}
});
...
var form=$(_402);
form.off(".form").on("submit.form",function(){
setTimeout(function(){
_3ef(_402,_403);
},0);
return false;
...
if(parseFloat(s)!=s){
if(opts.prefix){
s=(s.replace(new RegExp("\\"+(opts.prefix).trim(),"g"),"")).trim();
}
if(opts.suffix){
s=(s.replace(new RegExp("\\"+(opts.suffix).trim(),"g"),"")).trim();
}
if(opts.groupSeparator){
s=(s.replace(new RegExp("\\"+opts.groupSeparator,"g"),"")).trim();
}
if(opts.decimalSeparator){
s=(s.replace(new RegExp("\\"+opts.decimalSeparator,"g"),".")).trim();
}
s=s.replace(/\s/g,"");
}
...
_456.find(".spinner-arrow-up,.spinner-arrow-down").off(".spinner");
if(!opts.disabled){
_456.find(".spinner-arrow-up").on("mouseenter.spinner",function(){
$(this).addClass("spinner-arrow-hover");
}).on("mouseleave.spinner",function(){
...
_456.find(".spinner-arrow-down").on("mouseenter.spinner",function(){
$(this).addClass("spinner-arrow-hover");
}).on("mouseleave.spinner",function(){
$(this).removeClass("spinner-arrow-hover");
}).on("click.spinner",function(){
...
$(_46d).spinner(opts);
$(_46d).off(".timespinner");
$(_46d).on("click.timespinner",function(){
var _46e=0;
...
_4c3.panel("panel").addClass("datagrid").on("_resize",function(e,_4c4){
...
_4df.find("input[type=checkbox]").off(".datagrid").on("click.datagrid",function(e){
...
_4e0.closest("td").off(".datagrid").on("mouseenter.datagrid",function(){
if(_4dd.resizing){
return;
}
$(this).addClass("datagrid-header-over");
}).on("mouseleave.datagrid",function(){
$(this).removeClass("datagrid-header-over");
}).on("contextmenu.datagrid",function(e){
var _4e1=$(this).attr("field");
opts.onHeaderContextMenu.call(_4dc,e,_4e1);
});
_4e0.off(".datagrid").on("click.datagrid",function(e){
...
}).on("dblclick.datagrid",function(e){
var p1=$(this).offset().left+5;
var p2=$(this).offset().left+$(this)._outerWidth()-5;
...
dc.body1.add(dc.body2).off().on("mouseover",function(e){
if(_4dd.resizing){
return;
}
...
cell.children("table").on("click dblclick contextmenu",function(e){
e.stopPropagation();
});
...
$(this).find("span.datagrid-row-expander").on("click",{groupIndex:_6af},function(e){
...
dc.body1.add(dc.body2).on("mouseover",function(e){
var tt=$(e.target);
var tr=tt.closest("tr.datagrid-row");
if(!tr.length){
return;
...
_7a1.on("mousedown.combo",function(e){
...
$(_803).combo("panel").off().on("mouseover",function(e){
...
_86b.spinner.timespinner({showSeconds:opts.showSeconds,separator:opts.timeSeparator}).off(".datetimebox").on("mousedown.datetimebox",function(e){
e.stopPropagation();
});
