...
(function(factory) {
    ...
    $.fn.arrangeable = function(options) {
        ...
        // 自定义拖拽结束调用方法
        var afterDragEnd = null;
        if (options["afterDragEnd"] && (typeof options["afterDragEnd"] === "function")) {
            afterDragEnd = options["afterDragEnd"];
        }
        ...
        function dragMoveHandler(e) {
            ...
            $('body').attr('dragDistanceYss',dragDistanceY)
                // console.log(222);
            if (dragging) {
                e.stopPropagation();
                var scrollH=0;
        ...
        function dragEndHandler(e) {
            ...
            if (dragging) {
                ...
                if (afterDragEnd && (typeof afterDragEnd === "function")) {
                    afterDragEnd(dragElement);
                }
