...
public class EmailBodyplus implements Serializable {
     ...
     * 一对多关联email
     */
    private List<EmailPlus> emailList;
     ...
     * 收件人信息状态
     */
    public List<EmailPlus> toUserEmailInfo;
    /**
     * 抄送人信息状态
     */
    public List<EmailPlus> copyUserEmailInfo;
    /**
     * 秘送人信息状态
     */
    public List<EmailPlus> sercUserEmailInfo;
    ...
    public List<EmailPlus> getSercUserEmailInfo() {
        return sercUserEmailInfo;
    }

    public void setSercUserEmailInfo(List<EmailPlus> sercUserEmailInfo) {
        this.sercUserEmailInfo = sercUserEmailInfo;
    }

    public List<EmailPlus> getToUserEmailInfo() {
        return toUserEmailInfo;
    }

    public void setToUserEmailInfo(List<EmailPlus> toUserEmailInfo) {
        this.toUserEmailInfo = toUserEmailInfo;
    }

    public List<EmailPlus> getCopyUserEmailInfo() {
        return copyUserEmailInfo;
    }

    public void setCopyUserEmailInfo(List<EmailPlus> copyUserEmailInfo) {
     ...
     * @return
     */
    public List<EmailPlus> getEmailList() {
        return emailList;
    }
     ...
     * @param emailList
     */
    public void setEmailList(List<EmailPlus> emailList) {
    ...
    public EmailBodyplus() {
    }

    public EmailBodyplus(String fromId, Date sendTime, String subject, String content, String toId2) {
        this.fromId = fromId;
