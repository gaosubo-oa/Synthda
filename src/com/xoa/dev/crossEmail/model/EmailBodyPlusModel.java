...
public class EmailBodyPlusModel implements Serializable {
    private static final long serialVersionUID = 1144367351278409800L;
    /**
     * 大概时间
	 */
    ...
    private String toId2Name;
    private String copyToIdName;
    private String secretToIdName;

    public String getToId2Name() {
        return toId2Name;
    }

    public void setToId2Name(String toId2Name) {
        this.toId2Name = toId2Name;
    }

    public String getCopyToIdName() {
        return copyToIdName;
    }

    public void setCopyToIdName(String copyToIdName) {
        this.copyToIdName = copyToIdName;
    }

    public String getSecretToIdName() {
        return secretToIdName;
    }

    public void setSecretToIdName(String secretToIdName) {
        this.secretToIdName = secretToIdName;
    }
     ...
     * 一对多关联email
     */
    private List<EmailPlusModel> emailList;
     ...
     * 收件人信息状态
     */
    public List<EmailPlusModel> toUserEmailInfo;
    /**
     * 抄送人信息状态
     */
    public List<EmailPlusModel> copyUserEmailInfo;
    /**
     * 秘送人信息状态
     */
    public List<EmailPlusModel> sercUserEmailInfo;
    ...
    public List<EmailPlusModel> getSercUserEmailInfo() {
        return sercUserEmailInfo;
    }

    public void setSercUserEmailInfo(List<EmailPlusModel> sercUserEmailInfo) {
        this.sercUserEmailInfo = sercUserEmailInfo;
    }

    public List<EmailPlusModel> getToUserEmailInfo() {
        return toUserEmailInfo;
    }

    public void setToUserEmailInfo(List<EmailPlusModel> toUserEmailInfo) {
        this.toUserEmailInfo = toUserEmailInfo;
    }

    public List<EmailPlusModel> getCopyUserEmailInfo() {
        return copyUserEmailInfo;
    }

    public void setCopyUserEmailInfo(List<EmailPlusModel> copyUserEmailInfo) {
     ...
     * @return
     */
    public List<EmailPlusModel> getEmailList() {
        return emailList;
    }
     ...
     * @param emailList
     */
    public void setEmailList(List<EmailPlusModel> emailList) {
    ...
    public EmailBodyPlusModel() {
    }

    public EmailBodyPlusModel(String fromId, Date sendTime, String subject, String content, String toId2) {
        this.fromId = fromId;
