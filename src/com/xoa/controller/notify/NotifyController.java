...
public class NotifyController {
	...
	@Autowired
	private NotifyOpinionService notifyOpinionService;
	...
	public String noticeManagementPt(HttpServletRequest request) {
		...
		return "app/notice/allNoticePt/noticeManagementPt";
	}
	//通知管理
	...
	public String notiManagement(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/allNoticePt/notiManagement";
	}
	//新建通知
	...
	public String newNotification(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/allNoticePt/newNotification";
	}
	//通知查询
	...
	public String notificationInquiry(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/allNoticePt/notificationInquiry";
	}
	//通知统计
	...
	public String statisticalPt(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/allNoticePt/statisticalPt";
	}
	//通知审批
	...
	public String noticeApprovePt(HttpServletRequest request) {
		...
		return "app/notice/allNoticePt/noticeApprovePt";
	}
...
//	}
	...
	public String unreadPt(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/allNoticePt/unreadPt";
	}
	...
	public String InformTheViewPt(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/allNoticePt/InformTheViewPt";
	}
	...
	public String queryAllPt(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/allNoticePt/queryAllPt";
	}
...
//	普陀教育公告通知管理
	...
	public String noticeManagement_PuTuo(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/noticeManagement_PutTuo/noticeManagement_PuTuo";
	}
	...
	public String management_PuTuo(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/noticeManagement_PutTuo/management_PuTuo";
	}
	...
	public String newAndEdit_PuTuo(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/noticeManagement_PutTuo/newAndEdit_PuTuo";
	}
	...
	public String theQuery_PuTuo(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/noticeManagement_PutTuo/theQuery_PuTuo";
	}
	...
	public String statistical_PuTuo(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/noticeManagement_PutTuo/statistical_PuTuo";
	}
...
//普陀教育复制公告通知
	...
	public String unread_PuTuo(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/allNotifications_PuTuo/unread_PuTuo";
	}
	...
	public String InformTheView_PuTuo(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/allNotifications_PuTuo/InformTheView_PuTuo";
	}
	...
	public String queryAll_PuTuo(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/allNotifications_PuTuo/queryAll_PuTuo";
	}
	...
	public String leadtions(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/lead/leadtions";
	}
	//	领导精神未读
	...
	public String leadread(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/lead/leadread";
	}
    //领导精神通知
	...
	public String leadView(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/lead/leadView";
	}
	//领导精神查询
	...
	public String leadAll(HttpServletRequest request) {
		...
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/lead/leadAll";
	}
		...
		if(smsId!=null){
			...
			if(RemidFlag!=0){
				...
				if (locale.equals("zh_CN")) {
					...
					appLog.setRemark("Remarks");
				} else if (locale.equals("zh_TW")) {
					appLog.setRemark("備註");
				}
				notifyService.saveApplog4Notify(appLog);
			}else{
				AppLog appLog=new AppLog();
				Cookie redisSessionId = CookiesUtil.getCookieByName(request,"redisSessionId");
				Users sessionUser = SessionUtils.getSessionInfo(request.getSession(),Users.class,new Users(),redisSessionId);
	...
	//和上面的接口返回的页面一样，修改请求路径，用于区分退回的回执
	@RequestMapping("/detailOpinion")
	public String detailOpinion(HttpServletRequest request,String notifyId) {
		Cookie redisSessionCookie = CookiesUtil.getCookieByName(request, "redisSessionId");
		String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
		ContextHolder.setConsumerType("xoa" + loginDateSouse);
		String locale = (String) request.getSession().getAttribute("LOCALE_SESSION_ATTRIBUTE_NAME");
	...
	public String finddetailOpinion(HttpServletRequest request) {
        ...
        String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
        ContextHolder.setConsumerType("xoa" + loginDateSouse);
		return "app/notice/opinion/opinionNotify";
	}
...
//普陀公告通知审批
	...
	public String appprove_PuTuo(HttpServletRequest request) {
		...
		return "app/notice/appprove_PuTuo";
	}
	/**
	 *
	 * 创建作者:   张丽军
	...
	public ToJson<Notify> notifyManage(
			...
			@RequestParam("useFlag") Boolean useFlag,HttpServletRequest request,String queryField) throws ParseException {
		String locale = (String) request.getSession().getAttribute("LOCALE_SESSION_ATTRIBUTE_NAME");
		...
		maps.put("notifyTime", System.currentTimeMillis()/1000);
		...
		/* notifyService.queryDeleteByStaleDated();*/
		try {
			switch (read){
				case "0":
					...
					break;
				case "1":
					ToJson<Notify> tojson2 = notifyService.readNotify(maps, page, pageSize, useFlag,
							name,sqlType);
					...
					break;
				case "2":
					ToJson<Notify> toJson3 =notifyService.unreadNotify(maps, page, pageSize, useFlag,
							name,sqlType);
					if(toJson3.getObj()!=null&&toJson3.getObj().size()>0){//存在未读
						...
						ToJson<Notify>  list =notifyService.selectNotifyManage(maps, page, pageSize, useFlag,name,sqlType);
						list.setCode("read");
						list.setFlag(0);
						list.setMsg(ok);
						tojson=list;
				...
				default:
					...
					if (list.getObj().size() > 0) {
						...
						list.setFlag(1);
						list.setMsg(I18nUtils.getMessage("doc.th.NoData"));
						tojson=list;
					}
					break;
			}
	...
	public ToJson<Notify> notifyManagePlus(
			@RequestParam(value = "format", required = false) String format,
			@RequestParam(value = "typeId", required = false) String typeId,
			@RequestParam(value = "top", required = false) String top,
			@RequestParam(value = "publish", required = false) String publish,
		...
		try {
			switch (read){
				case "0":
					...
					break;
				case "1":
					ToJson<Notify> tojson2 = notifyService.readNotifyPlus(maps, page, pageSize, useFlag, name,sqlType);
					if (tojson2.getObj().size() > 0) {
						tojson2.setFlag(0);
						tojson2.setMsg(ok);
						tojson=tojson2;
	...
	ToJson<Notify> notifyList(@RequestParam(value = "format", required = false) String format,
        ...
        String loginDateSouse = SessionUtils.getSessionInfo(request.getSession(), "loginDateSouse", String.class, redisSessionCookie);
        ContextHolder.setConsumerType("xoa" + loginDateSouse);
        String publishs=request.getParameter("publishs");
		Map<String, Object> maps = new HashMap<String, Object>();
		maps.put("format", format);
		...
		if(!StringUtils.checkNull(publish)){
			...
			maps.put("publish",list1);
		}else {
			if(!StringUtils.checkNull(publishs)){
				String[] split=publishs.split(",");
				List<String> list1=Arrays.asList(split);
				maps.put("publish", list1);
			}
		}
		...
		/*notifyService.queryDeleteByStaleDated();*/
		try{
			ToJson<Notify>  notifyToJson = notifyService.selectNotify(maps, page, pageSize, useFlag, users);
			if("1".equals(exportId)){
				returnReslt=notifyToJson;
			}else if("2".equals(exportId)){
				try {
					List<Notify> list=notifyToJson.getObj();
					HSSFWorkbook workbook1 = ExcelUtil.makeExcelHead("公告信息导出", 9);
					String[] secondTitles = {"发布人", "类型", "标题", "发布时间", "生效日期", "终止日期", "状态", "附件名称", "内容"};
					if (locale.equals("en_US")) {
						workbook1 = ExcelUtil.makeExcelHead("Export of announcement information", 9);
						secondTitles = new String[]{"Publisher", "Type", "Title", "Posted time", "Effective date", "Termination date", "Status", "Attachment name", "Content"};
					} else if (locale.equals("zh_TW")) {
						workbook1 = ExcelUtil.makeExcelHead("公告資訊導出", 9);
						secondTitles = new String[]{"發布人", "類型", "標題", "發布時間", "生效日期", "終止日期", "狀態", "附件名稱", "內容"};
					}
					...
					if (locale.equals("en_US")) {
						filename = "Export of announcement information.xls";
					} else if (locale.equals("zh_TW")) {
						filename = "公告資訊導出.xls";
					}
	...
	public @ResponseBody
	ToJson<Notify> selectNotifyOverTime(
							  @RequestParam(value = "fromId", required = false) String fromId,
							  @RequestParam(value = "toId", required = false) String toId,
							  @RequestParam("page") Integer page,
							  @RequestParam("pageSize") Integer pageSize,
		...
		try{
			ToJson<Notify>  notifyToJson = notifyService.selectNotifyOverTime(maps, page, pageSize, useFlag,name.getUserPriv(), name.getUserId());
	...
	public @ResponseBody ToJson<Notify> getOneById(@RequestParam("notifyId") Integer notifyId,
...
//			}
		...
		try {
			Notify notify=notifyService.queryById(maps, 1, 20, false, name,sqlType,changId);
			NotifyOpinionWithBLOBs notifyOpinionWithBLOBs = notifyOpinionService.selectByNotiId(notify.getNotifyId(),user.getUserId(),sqlType);
	...
	public ToJson updateNotify(Notify notify, HttpServletRequest request,
							   ...
							   @RequestParam(value = "approve", required = false,defaultValue = "0")String approve){
		...
		try {
			...
			notifyService.updateNotify(notify,remind,tuisong,request,approve);
			toJson.setFlag(0);
			toJson.setMsg("ok");
			return toJson;
		} catch (Exception e) {
	...
	public ToJson newUpdateNotify(Notify notify, HttpServletRequest request,
								  @RequestParam("notifyId") Integer notifyId,String sendTimes,
								  @RequestParam(name = "lastEditTimes", required = false) String lastEditTimes,
								  @RequestParam(value = "beginDates", required = false) String beginDates,
								  @RequestParam(value = "endDates", required = false)  String endDates,
		...
		ToJson toJson =new ToJson();
		try {
			notifyService.upNewdateNotify(notify,remind,tuisong,request,approve);
			...
			if (locale.equals("zh_CN")) {
				...
				syslog.setRemark("[" + user.getDeptName() + "]" + user.getUserName() + ",USER_ID=" + user.getUserId()+",Submit");
			} else if (locale.equals("zh_TW")) {
				syslog.setRemark("[" + user.getDeptName() + "]" + user.getUserName() + ",USER_ID=" + user.getUserId()+",提交");
			}
	...
	public @ResponseBody
	ToJson<Notify> addNotify(Notify notify,String sendTimes,HttpServletRequest request, String beginDates, String endDates,
							 @RequestParam(value = "remind", required = false,defaultValue ="0") String remind,
							 @RequestParam(value = "approveRemind", required = false,defaultValue ="0") String approveRemind) {
		String tuisong=request.getParameter("tuisong");
		ToJson<Notify> toJson = new ToJson<Notify>(0,"");
		String locale = (String) request.getSession().getAttribute("LOCALE_SESSION_ATTRIBUTE_NAME");
		Cookie redisSessionId = CookiesUtil.getCookieByName(request,"redisSessionId");
		...
		if(StringUtils.checkNull(notify.getSubject())){
			if (locale.equals("zh_CN")) {
				...
				notify.setSubject("[No Subject]");
			} else if (locale.equals("zh_TW")) {
				notify.setSubject("[無主題]");
			}
		}
		try {
			notify.setOpinUsers("");
			int b=	notifyService.addNotify(notify,remind,tuisong,request,approveRemind);
			if(b>0){
				toJson.setFlag(0);
				toJson.setMsg("success");
			}else{
		...
		try{
			...
			if(!"1".equals(request.getAttribute("approvalStatus"))) {
				...
				if(!Objects.isNull(isShowSecret) && "1".equals(isShowSecret.getParaValue())){
					...
					if(!Objects.isNull(notify) && !Objects.isNull(notify.getNotifyId())) {
						securityContentApprovalService.insert("notify", notifyId.toString(), I18nUtils.getMessage("notice.title.notify"), notify.getSubject(), "/notice/detail?notifyId=" + notifyId, "2", notify.getContentSecrecy(), request);
						toJson.setMsg(I18nUtils.getMessage("notice.th.noticeDeleteByIdsPrompt"));
						toJson.setCode("100066");
						return toJson;
					}
				}
			}
	...
	public @ResponseBody ToJson<Notify> deleteByIds(HttpServletRequest request,@RequestParam("notifyIds[]") String[] notifyIds){
		Cookie redisSessionCookie = CookiesUtil.getCookieByName(request, "redisSessionId");
		Users user = SessionUtils.getSessionInfo(request.getSession(), Users.class, new Users(),redisSessionCookie);
		String locale = (String) request.getSession().getAttribute("LOCALE_SESSION_ATTRIBUTE_NAME");
		I18nUtils.setLocale(locale);
		...
		if(!"1".equals(request.getAttribute("approvalStatus"))) {
			...
			SysPara isShowSecret = sysParaMapper.querySysPara("IS_SHOW_SECRET");
			if(!Objects.isNull(isShowSecret) && "1".equals(isShowSecret.getParaValue())){
				ToJson<Notify> toJson = new ToJson<Notify>();
				for (String notifyId : notifyIds) {
					...
					if (!Objects.isNull(notify)) {
						securityContentApprovalService.insert("notify", notifyId, I18nUtils.getMessage("notice.title.notify"), notify.getSubject(), "/notice/detail?notifyId=" + notifyId, "2", notify.getContentSecrecy(), request);
						toJson.setCode("100066");
						toJson.setMsg(I18nUtils.getMessage("notice.th.noticeDeleteByIdsPrompt"));
					}
				}
		...
		syslog.setUserId(user.getUserId());
		syslog.setType(15); //sys_code
		syslog.setRemark("[" + user.getDeptName() + "]" + user.getUserName() + ",USER_ID=" + user.getUserId()+"," + I18nUtils.getMessage("meet.th.BatchDelete"));
		sysLogService.saveLog(syslog,request);

		return  notifyService.deleteByids(notifyIds);

	}
	@RequestMapping( "/updateByIds")
	public @ResponseBody ToJson<Notify> updateByIds(HttpServletRequest request, @RequestParam("notifyIds[]") String[] notifyIds,String top){
		String locale = (String) request.getSession().getAttribute("LOCALE_SESSION_ATTRIBUTE_NAME");
		I18nUtils.setLocale(locale);
		return  notifyService.updateByids(notifyIds,top);
	}

	@RequestMapping( "/querySituation")
	public @ResponseBody ToJson<Notify> querySituation(String notifyId,HttpServletRequest request){

		return  notifyService.ConsultTheSituationNotify(notifyId,request);
	}
	...
	public ToJson<Department> getNotifyGroupFromDept(HttpServletRequest request, Notify notify){
		return notifyService.getNotifyGroupFromDept(request, notify);
	}
	...
	public ToJson<Notify> getNotifyByFromDept(Notify notify){
		return notifyService.getNotifyByFromDept(notify);
	}
	...
	public ToJson<Notify> getNotifyByFromIdAndDept(HttpServletRequest request, Notify notify){
		return notifyService.getNotifyByFromIdAndDept(request, notify);
	}
	...
	public ToJson<Notify> getNotifyByNotifyId(Integer notifyId){
		return notifyService.getNotifyByNotifyId(notifyId);
	}
	/**
	 * 创建作者:   牛江丽
	...
	public  ToJson<Notify> outputNotify(int step,Notify notify, HttpServletRequest request, HttpServletResponse response){
		return notifyService.outputNotify(step,notify,request,response);
	}
	...
	public BaseWrapper selectByType(){
		return notifyService.selectByType();
	}
	...
	public ToJson updateTopstatus(Notify notify,HttpServletRequest request){
		return notifyService.updateTopstatus(notify,request);
	}
	...
	public ToJson<Notify> updateDate(HttpServletRequest request){
		return notifyService.updateDate(request);
	}
	...
	public ToJson addOpinion(HttpServletRequest request, NotifyOpinionWithBLOBs notifyOpinion){
		Cookie redisSessionId = CookiesUtil.getCookieByName(request, "redisSessionId");
		Users user = SessionUtils.getSessionInfo(request.getSession(), Users.class, new Users(), redisSessionId);
		notifyOpinion.setUserId(user.getUserId());
		String locale = (String) request.getSession().getAttribute("LOCALE_SESSION_ATTRIBUTE_NAME");
		I18nUtils.setLocale(locale);
		return notifyOpinionService.addOpinion(notifyOpinion);
	}
	...
	public ToJson updateOpin(HttpServletRequest request, NotifyOpinionWithBLOBs notifyOpinion){
		ToJson toJson = new ToJson(1,"err");
		Cookie redisSessionId = CookiesUtil.getCookieByName(request, "redisSessionId");
		Users user = SessionUtils.getSessionInfo(request.getSession(), Users.class, new Users(), redisSessionId);
		notifyOpinion.setUserId(user.getUserId());
		int i = notifyOpinionService.updateOpinion(notifyOpinion);
		if(i>0){
			toJson.setMsg("true");
			toJson.setFlag(0);
		}
	...
	public ToJson returnOpinion(HttpServletRequest request, int notifyId ,String userId,String returnComments){
		ToJson toJson = new ToJson(1,"err");
		int i = notifyOpinionService.returnOpinion(request,notifyId,userId,returnComments);
		if(i>0){
			toJson.setMsg("true");
			toJson.setFlag(0);
		}
	...
	public ToJson urgeOpin(HttpServletRequest request, int notifyId,String userIds){
		...
		toJson = notifyOpinionService.urgeOpin(request,notifyId,userIds);
		return toJson;
	}
	...
	public ToJson outputNotifyOpin(HttpServletRequest request,HttpServletResponse response , int  notifyId){
		return notifyOpinionService.outputNotifyOpins(request,response,notifyId);
	}
	...
	public ToJson downLoadZipAttachment(HttpServletRequest request,HttpServletResponse response , int  notifyId) throws UnsupportedEncodingException {
		return notifyOpinionService.downLoadZipAttachment(request,response,notifyId);
	}
	...
	public ToJson<NotifyOpinionWithBLOBs> finddetailOpin(HttpServletRequest request,HttpServletResponse response, @RequestParam("notyId") Integer notyId,boolean isOut){
		ToJson toJson = new ToJson(1,"err");
		Object locale = request.getSession().getAttribute("LOCALE_SESSION_ATTRIBUTE_NAME");
		try {
			...
			Map map = new HashMap();
			List<NotifyOpinionWithBLOBs> notiIdList = notifyOpinionService.selectByNotiIdList(request,notyId);
			int yfk = 0;
			...
			if(isOut){
				...
				if (locale.equals("zh_CN")) {
					...
					secondTitlesone.add("Status");
					secondTitlesone.add("Publisher");
					secondTitlesone.add("Task release time");
					secondTitlesone.add("Reporter");
					secondTitlesone.add("Filling department");
				} else if (locale.equals("zh_TW")) {
					secondTitlesone.add("狀態");
					secondTitlesone.add("發布人");
					secondTitlesone.add("發布任務時間");
					secondTitlesone.add("填報人");
					secondTitlesone.add("填報部門");
				}
				...
				if (locale.equals("zh_CN")) {
					...
					secondTitlesone.add("Filling time");
					secondTitlesone.add("Modification time");
					secondTitlesone.add("Attachment Name");
				} else if (locale.equals("zh_TW")) {
					secondTitlesone.add("填報時間");
					secondTitlesone.add("修改時間");
					secondTitlesone.add("附件名稱");
				}
				...
				if (locale.equals("en_US")) {
					workbook1 = ExcelUtil.makeExcelHead("Export of Announcement Receipt Information", 10 );
				} else if (locale.equals("zh_TW")) {
					workbook1 = ExcelUtil.makeExcelHead("公告回執資訊導出", 10 );
				}
				...
				if (locale.equals("en_US")) {
					filename = "Export of Announcement Acknowledgement Information.xls";
				} else if (locale.equals("zh_TW")) {
					filename = "公告回執資訊導出.xls";
				}
    ...
    public ToJson findNotifyandMeeting(HttpServletRequest request) {
        ...
        try {
            ...
            maps.put("notifyTime", data);
            maps.put("userType", userExtMapper.selUserExtByUserId(users.getUserId()).getEmploymentType());
            List<Notify> obj = notifyService.unreadNotifyPlus(maps, 1, 20, true,
                    users.getUserId(), sqlType).getObj();
            if (obj.size() > 0) {
				for (Notify notify : obj
				) {
            ...
            for (MeetingWithBLOBs meetingWithBLOBs1 : meetingList) {
                ...
                if ((3 == meetingWithBLOBs1.getStatus()) || (2 == meetingWithBLOBs1.getStatus() && currentTime >= startDate && currentTime <= endDate) || (2 == meetingWithBLOBs1.getStatus())) {
					...
					if (locale.equals("zh_CN")) {
						...
						notifyAndMeeting.setSubject("[Meeting] " + meetingWithBLOBs1.getSubject());
					} else if (locale.equals("zh_TW")) {
						notifyAndMeeting.setSubject("[會議] " + meetingWithBLOBs1.getSubject());
					}
	...
	public ToJson newUpdateNotify(Notify notify, HttpServletRequest request, String sendTimes, String beginDates, String endDates){
		ToJson toJson =new ToJson();
		Cookie redisSessionCookie = CookiesUtil.getCookieByName(request, "redisSessionId");
		Users user = SessionUtils.getSessionInfo(request.getSession(), Users.class, new Users(),redisSessionCookie);
		String locale = (String) request.getSession().getAttribute("LOCALE_SESSION_ATTRIBUTE_NAME");
		try {
			...
			notifyMapper.updateNotifys(notify);
			...
			if (locale.equals("zh_CN")) {
				...
				syslog.setRemark("[" + user.getDeptName() + "]" + user.getUserName() + ",USER_ID=" + user.getUserId()+",modify");
			} else if (locale.equals("zh_TW")) {
				syslog.setRemark("[" + user.getDeptName() + "]" + user.getUserName() + ",USER_ID=" + user.getUserId()+",修改");
			}
			sysLogService.saveLog(syslog,request);
	...
	public ToJson selectById(Integer notifyId, HttpServletRequest request){
		ToJson toJson =new ToJson();
		try {
	...
	public ToJson readNotify(HttpServletRequest request) {
		return notifyService.readNotify(request);
	}
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "/notifyUnAll", produces = { "application/json;charset=UTF-8" })
	public ToJson notifyUnAll(@RequestParam("notifyId") Integer notifyId, HttpServletRequest request){
		return notifyService.notifyUnAll(notifyId, request);
	}
}
