...
public interface NotifyService {
	 ...
	 * @return     List<Notify>
	 */
	public ToJson<Notify> selectNotifyManage(Map<String, Object> maps,Integer page,Integer pageSize,boolean useFlag,String name,String sqlType) throws Exception;
	/**
	 *
	 * 创建作者:   张丽军
	...
	ToJson<Notify> updateDate(HttpServletRequest request);

	ToJson<Notify> selectNotifyOverTime(Map<String, Object> maps, Integer page, Integer pageSize, Boolean useFlag, Integer userPriv, String userId);
	 ...
	 * @return
	 */
    ToJson notifyUnAll(Integer notifyId, HttpServletRequest request);
}
