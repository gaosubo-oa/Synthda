...
public interface UsersService {
     ...
     * @return void 无
     */
    public ToJson<Users> edit(Users users);
...
//	@DynDatasource
    ...
    Boolean verificationPassword(String userName, String password);
    ...
    /**
     * 创建作者: 刘建
     * 创建日期: 2020-08-03 14:18
     * 方法介绍: 根据deptId获取该部门下的所有用户信息（角色排序号大于自己）
     * @param deptId
     * @return java.util.List<com.xoa.model.users.Users>
     */
    List<Users> getUsersNoByDeptId(Integer userPrivNo,Integer deptId);
    /**
     * 创建作者:   张龙飞
     ...
     * @return
     */
    ToJson editUsersDetId(Integer deptId, String uids, Integer nowDeptId,HttpServletRequest request);
     ...
     * @参数说明: 无
     **/
    ToJson<Users> getNewUsers(String deptNo);
     ...
     * @return
     */
    Users getUserByUid(int uid, String sqlType);
     ...
     */
    ToJson<Users> queryExportUsers(HttpServletRequest request, HttpServletResponse response, Users user, String sortType, String isExport, String notLogin, Integer page, Integer pageSize, Boolean useFlag, String deptNo, Integer type);
     ...
     * @return
     */
    String fundUserIdByUserName(String userNames);
    ...
    ToJson<Users> getDate(HttpServletRequest request);

    public ToJson<Users> getOnlineByuser();

    String getAllDeptIdsByUserId(String s, String s1);

    List<Users> getAllPrivOther(Map<String, Object> maps, Integer page,
                                Integer pageSize, boolean useFlag);

    public ToJson getUserAndDept(Users user, HttpServletRequest request);
    ...
    ToJson<Users> editUserImg(HttpServletRequest request, Users users, UserExt userExt);

    ToJson<Users> bindUserInfo(HttpServletRequest request, Integer uid, String cardNumber);

    ToJson<Users> imputBindUserInfo(HttpServletRequest request, HttpServletResponse response, MultipartFile file);

    /**
     * 根据userIds 串  查询用户名串(代替eduUser_service  中的方法)
     *
     * @param userIds
     * @return
     */
    ...
    /**
     * 根据Uids 串  查询用户名串(代替eduUser_service  中的方法)
     *
     * @param Uids
     * @return
     */
    String getUserNamesByUids(String Uids);

    public String getUserAvatar(String userIds);

    ToJson<Users> selectByMobilNo(HttpServletRequest request, String mobilNo);

    ToJson<Users> selectByIdAndMobilNo(HttpServletRequest request, String idNumber, String mobilNo);

    //修改快捷菜单id串
    public void updateshortcut(Users users, HttpServletRequest request);

    ToJson<Users> updateKanBan(String myStatus,HttpServletRequest request);

    ToJson<Users> selectKanBan(HttpServletRequest request);

    public void updatePassword(Users user);

    List<Users> getUsersByOrgDeptId(Integer orgDeptId);
     ...
     * 修改控制面板状态
     */
    AjaxJson userExtMenuPanel(HttpServletRequest request, String menuPanel,String emailPanel);

    /** 批量修改密码 */
    ToJson batchUpdatePasswordByUidArray(HttpServletRequest request, String[] uidArray, String password);
    ToJson getBrithDay(HttpServletRequest request,String userId);

    List<Users> getUsersByUserIds(String uids);

    List<Users> getUserByUserNames(String userNames);
     ...
     **/
    ToJson getUserStructure(Integer deptId);
     ...
     * 返回值说明: com.xoa.util.ToJson
     **/
    ToJson regularElection(String userIds);

    ToJson queryEditByNameAuth(HttpServletRequest request,Users user);
