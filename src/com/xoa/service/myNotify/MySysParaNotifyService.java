 ...
 */
@Service
public interface MySysParaNotifyService {
    /**
    ...
    ToJson<Object> getNotifyCode(String specifyTable);

    //获取自定义模块类型
   /* ToJson<Object> getMyNotifyTypeList(HttpServletRequest request, String specifyTable);*/
}