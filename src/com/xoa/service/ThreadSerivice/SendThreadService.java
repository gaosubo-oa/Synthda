...
public class SendThreadService {
    ...
    public void sendSms(final StringBuffer mobileString, final StringBuffer contextString, final String protocol, final String host, final String port,
                        ...
                        final String code, final String mobile, final String time_content, final String sign, final String signValue, final String signPosition,
            ...
            public void run() {
                try {
                    send.doPost(mobileString, contextString, protocol, host, port,
                            ...
                            code, mobile, time_content, sign, signValue, signPosition,
