...
public class EmailUtils {
    ...
    /**
     * 创建作者:   张勇
     * 创建日期:   2017/6/14 17:33
     * 方法介绍:   无参构造函数,初始化一个MimeMessage对象
     * 参数说明:
     * @return
     */
    public EmailUtils() {
...
//            System.out.println("无法获得发送者信息.");
     ...
     * 创建作者:   张勇
     * 创建日期:   2017/6/14 17:34
     * 方法介绍:   获得邮件的收件人，抄送，和密送的地址和姓名，根据所传递的参数的不同
...
//        System.out.println("发送日期 可读类型: " + strSentDate);
     ...
     * 创建作者:   张勇
     * 创建日期:   2017/6/14 17:35
     * 方法介绍:   解析邮件，把得到的邮件内容保存到一个StringBuffer对象中，解析邮件
...
//        System.out.println("邮件内容的类型:　" + contentType);
    ...
    /**
     * 创建作者:   张勇
     * 创建日期:   2017/6/14 19:41
     * 方法介绍:   判断此邮件是否需要回执，如果需要回执返回"true",否则返回"false"
     * 参数说明:
     * @return
     */
...
//            System.out.println("该邮件不需要回复");
     ...
     * 创建作者:   张勇
     * 创建日期:   2017/6/14 19:41
     * 方法介绍:   判断此邮件是否已读，如果未读返回false,反之返回true
     * 参数说明:
     * @return
     */
