...
public class MTPacks  implements java.io.Serializable {
    ...
    private MediaItems[] medias;

    private MessageData[] msgs;
     ...
     * @param medias
     */
    public void setMedias(MediaItems[] medias) {
        this.medias = medias;
    }
     ...
     * @param msgs
     */
    public void setMsgs(MessageData[] msgs) {
        this.msgs = msgs;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getMedias() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getMedias(), i);
                if (obj != null &&
        ...
        if (getMsgs() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getMsgs(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
