...
public class Users implements Serializable {
    ...
    /**
     * 手机类型（1表示华为，2表示小米，3表示OPPO，4表示vivo，5表示魅族，0表示其他）
     */
    ...
    /**
     * 限定使用极简界面（不显示门户、组织及主题切换功能），0否 1是
     */
   ...
   //血型 关联人事
    ...
    //是否是涉密系统管理员（超级管理员、系统安全保密员、系统安全审计员、系统安全管理员、系统运维管理员，0否1是）
    private Integer secrecyAdm;
    ...
    // 闵行项目中的该用户所属于的所有orgId 格式为1001,1002,
    private String mhOrg;
    private String mhOrgName;
    ...
    public String getMhOrgName() {
        return mhOrgName;
    }

    public void setMhOrgName(String mhOrgName) {
        this.mhOrgName = mhOrgName;
    }

    public String getMhOrg() {
        return mhOrg;
    }

    public void setMhOrg(String mhOrg) {
        this.mhOrg = mhOrg;
    }
...
//      `ACCESS_TOKEN` varchar(200) DEFAULT NULL COMMENT '华为token',
//            `TOKEN_EXPIRED_TIME` varchar(200) DEFAULT NULL COMMENT '有效期',
    /**
     * 长部门名称
     */
    private String longDepName;
    ...
    public String getUseingKey() {
        return useingKey==null?"0":useingKey;
    }
    ...
    public String getUsingFinger() {
        return usingFinger==null?"0":usingFinger;
    }
    ...
    public String getSecureKeySn() {
        return secureKeySn==null?"":secureKeySn;
    }
    ...
    public String getUserPrivName() {
        return userPrivName == null ?"":userPrivName.trim();
    }
    ...
    public String getAvatar() {
        ...
        // 注释的代码 转移到下面的setAvatarDefault()方法中了
            return avatar;
    }
    ...
    public String getCallSound() {
        return callSound==null?"":callSound;
    }
    ...
    public String getAttendStatus() {
        return attendStatus==null?"0":attendStatus;
    }
    ...
    public String getMobilNoHidden() {
        return mobilNoHidden==null?"1":mobilNoHidden;
    }
 ...
 /*   public String getMytableLeft() {
    ...
    public String getMytableLeft() {
        return mytableLeft==null?"ALL":mytableLeft;
    }
    ...
    public String getMytableRight() {
        return mytableRight==null?"ALL":mytableRight;
    }
    ...
    public String getNotSearch() {
        return notSearch==null?"0":notSearch;
    }
    ...
    public String getWeatherCity() {
        return weatherCity==null?"0":weatherCity;
    }
    ...
    public String getMenuExpand() {
        return menuExpand==null?"":menuExpand;
    }
    ...
    public String getLimitLogin() {
        return limitLogin==null?"":limitLogin;
    }
    ...
    public Integer getNotMobileLogin() {
        return notMobileLogin==null?0:notMobileLogin;
    }
    ...
    public String getManageModuleType() {
        return manageModuleType==null?"":manageModuleType;
    }
    ...
    public Integer getUserPrivType() {
        return userPrivType==null?1:Integer.valueOf(userPrivType);
    }
    ...
    public String getUserManageOrgs() {
        return userManageOrgs==null?"":userManageOrgs;
    }
    ...
    public String getLongDepName() {
        return longDepName;
    }

    public void setLongDepName(String longDepName) {
        this.longDepName = longDepName;
    }
    ...
    public void setSimpleInterface(String simpleInterface) {
    ...
    public Integer getLeaveDept() {
        return leaveDept;
    }

    public void setLeaveDept(Integer leaveDept) {
    ...
    public Integer getBranchDeptId() {
        return branchDeptId;
    }

    public void setBranchDeptId(Integer branchDeptId) {
        this.branchDeptId = branchDeptId;
    }

    public String getBranchDeptName() {
        return branchDeptName;
    }

    public void setBranchDeptName(String branchDeptName) {
        this.branchDeptName = branchDeptName;
    }
    ...
    public Integer getSecrecyAdm() {
        return secrecyAdm;
    }

    public void setSecrecyAdm(Integer secrecyAdm) {
        this.secrecyAdm = secrecyAdm;
    }
}
