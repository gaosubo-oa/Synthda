...
public class MyNotify {
   ...
   //用户对象
	...
	// 回执信息
	private List<MyNotifyOpinionWithBLOBs> notifyOpinions;

	private Integer modelType;

	public List<MyNotifyOpinionWithBLOBs> getNotifyOpinions() {
		return notifyOpinions;
	}

	public void setNotifyOpinions(List<MyNotifyOpinionWithBLOBs> notifyOpinions) {
	...
	public MyNotify(String format, String fromId, Date sendTime, String subject, String content, String toId, String publish) {
		this.format = format;
		this.fromId = fromId;
		this.sendTime = sendTime;
